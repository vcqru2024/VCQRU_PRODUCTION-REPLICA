<%@ Page Title="" EnableEventValidation="true" Language="C#" MasterPageFile="~/Admin/NewAdminMaster.master" AutoEventWireup="false" CodeFile="AutoCashTransferUploadBankFile.aspx.cs" Inherits="Admin_AutoCashTransferUploadBankFile" %>
       ...
       <div class="col-md-12">
        ...
        <div class="col-sm-12">
            <h3 class="header blue lighter smaller">
                <img src="../images/demo.png" />Upload Bank's Statement File 
            </h3>
        </div>
        <%--<div class="col-sm-2">
    ...
    <div class="col-md-12">
        ...
        <div class="col-lg-12" style="margin-top: 5px;">
            ...
            <div class="col-lg-2">
                ...
                <asp:DropDownList ID="ddlReleased" runat="server" class="input-sm">

                    <asp:ListItem Selected="True">Not Released</asp:ListItem>
            ...
            <div class="col-xs-12">
                ...
                <div class="table-responsive">
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="GridView1" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" CssClass="table table-bordered table-hover table-condenced">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <br />
                                         <asp:Button  ID="lnkbtnupload" EnableViewState="false" OnClick="lnkbtnupload_Click" Text="Upload" CommandArgument='<%# Container.DataItemIndex %>' CommandName="Upload" runat="server"></asp:Button>
                                        <br />

                                       <asp:Label ID="lbluploadfilepath" runat="server"></asp:Label>                 
                                    </ItemTemplate>
