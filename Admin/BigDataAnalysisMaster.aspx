<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    Title="Data Master" CodeFile="BigDataAnalysisMaster.aspx.cs" Inherits="Admin_BigDataAnalysisMaster" %>
        ...
        <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" OnClick="imgNew_Click" ImageUrl="~/Content/images/add_new.png"
                                    runat="server" ToolTip="Add New Data" />
                            </td>
                        </tr>
                    </table>
                </h2>
                    ...
                    <asp:Panel ID="DefaultButtonPanel" DefaultButton="ImgSearch" runat="server">
                        <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                            <tr>
                                ...
                                <td width="20%">
                                    <asp:TextBox ID="txtDataQuantity" runat="server" CssClass="textbox_pop"  OnKeyPress="return isNumberKey(this, event);" placeholder="Data Quantity"></asp:TextBox>
                                </td>
                                <td align="right" width="15%">
                                    <strong>Price :</strong>
                                </td>
                                <td width="20%">
                                    <asp:TextBox ID="txtPrice" runat="server" CssClass="textbox_pop"  OnKeyPress="return isNumberKey(this, event);" placeholder="Data Price"></asp:TextBox>
                                </td>
                                <td align="justify">
                                    <div class="merg_btn">
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdAwards" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    DataKeyNames="IsDelete1,IsActive1" EmptyDataText="Record Not Found" EmptyDataRowStyle-HorizontalAlign="Center"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Quantity">
                            <ItemTemplate>
                                <asp:Label ID="lblname" runat="server" Text='<%# Bind("DataQty") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Price">
                            <ItemTemplate>
                                <asp:Label ID="lblsize" runat="server" Text='<%# Bind("Price") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <%
                                    try
                                    {
                                        dflag = Convert.ToInt32(GrdAwards.DataKeys[index].Values["IsDelete1"].ToString());
                                        aflag = Convert.ToInt32(GrdAwards.DataKeys[index].Values["IsActive1"].ToString());
                                    }
                                    catch { }

                                    if (dflag == 0)
                                    { %>
                                        <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("BigDataAnalysisDataid") %>'
                                    ...
                                    <asp:ImageButton ID="imgawrdactive" runat="server" ImageUrl="~/Content/images/check_act.png"
                                        CausesValidation="false" ToolTip="Click to De-Activate" CommandArgument='<%# Bind("BigDataAnalysisDataid") %>'
                                    ...
                                    <asp:ImageButton ID="imgawrddeactive" runat="server" ImageUrl="~/Content/images/check_gr.png"
                                        CausesValidation="false" ToolTip="Click to Activate" CommandArgument='<%# Bind("BigDataAnalysisDataid") %>'
                                        CommandName="IsActive" Height="12px" Width="12px" />&nbsp;
                                    <%}                                     
                                    %> 
                                    <asp:ImageButton ID="imgshowlbl" runat="server" ImageUrl="~/Content/images/delete.png"
                                    CausesValidation="false" ToolTip="Click to Delete" CommandArgument='<%# Bind("BigDataAnalysisDataid") %>'
                                            ...
                                            <tr>
                                                <td align="right" style="width: 36%;">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red"
                                                        ValidationGroup="LCR" ControlToValidate="txtQuantity1"></asp:RequiredFieldValidator>
                                                    <%--<cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" TargetControlID="txtQuantity1"
                                                        runat="server" FilterMode="InvalidChars" InvalidChars="`~!@#$%^&*(){}[]_+|\=-,/'/';<>?:1234567890">
                                                    </cc1:FilteredTextBoxExtender>--%>
                                                    <strong><span class="star_red">*</span>Quantity :&nbsp;</strong>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtQuantity1" CssClass="textbox_pop" onchange="checklabel(this.value);" MaxLength="20"
                                                        runat="server"   OnKeyPress="return isNumberKey(this, event);"></asp:TextBox>                                                        
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 36%;">
                                            ...
                                            <tr>
                                                <td align="right" style="width: 36%;">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red"
                                                        ValidationGroup="LCR" ControlToValidate="txtDataPrice1"></asp:RequiredFieldValidator>
                                                    <strong><span class="star_red">*</span>Price (Rs) :&nbsp;</strong>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtDataPrice1" CssClass="textbox_pop" runat="server" Width="60px"
                                                        MaxLength="6" OnKeyPress="return isNumberKey(this, event);" ></asp:TextBox> <%--onchange="mathRoundForTaxes(this.id);"--%>
                                                </td>
                                            </tr>                                                                                        
                                        </table>
                                    </fieldset>
