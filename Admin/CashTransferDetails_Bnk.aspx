<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/NewAdminMaster.master" AutoEventWireup="true" CodeFile="CashTransferDetails_Bnk.aspx.cs" Inherits="Admin_CashTransferDetails_Bnk" %>
    ...
    <script type="text/javascript">
        function Export() {
            ...
            $("#ctl00_ContentPlaceHolder1_GridView1").table2excel({
                ...
                exclude: ".noExl",
                name: "Worksheet Name",
                filename: "ClaimedTransactionDetailsBankwise",
                fileext: ".xls", // file extension
                preserveColors: true
            });
        };
        ...
        function FailureExport() {
            ...
            $("#ctl00_ContentPlaceHolder1_GridView2").table2excel({
                ...
                exclude: ".noExl",
                name: "Worksheet Name",
                filename: "FailureTransactionDetailsBankwise",
                fileext: ".xls", // file extension
                preserveColors: true
            });
        };
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="col-sm-12">
            <h3 class="header blue lighter smaller">
                <img src="../images/demo.png" />Claimed Bank Account Details
            </h3>
        </div>
    ...
    <div class="col-lg-1">
        ...
        <div class="col-lg-12" style="margin-top: 5px;">
             ...
             <div class="col-lg-4">
                    ...
                    Hint : Sheet name should be as "BankPaymentStatus.xlsx". <br /> (<a href="../images/Transactions/BankPaymentStatus.xlsx">Click here to download</a>)
              </div>
        ...
        <div class="row" id="SearchDataDiv" runat="server">
                        ...
                        <asp:GridView ID="GridView1" AllowPaging="false" AllowSorting="true" AutoGenerateColumns="false" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDataBound="GridView1_RowDataBound" CssClass="table table-bordered table-hover table-condenced">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Account No.">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEmail" runat="server" Text='<%# Bind("Account_No") %>'></asp:Label>
                                    </ItemTemplate>


                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Account HolderNm">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEmail" runat="server" Text='<%# Bind("Account_HolderNm") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Bank Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEmail" runat="server" Text='<%# Bind("Bank_Name") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="IFSC Code">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEmail" runat="server" Text='<%# Bind("IFSC_Code") %>'></asp:Label>
                                    </ItemTemplate>
         ...
         <div class="row" id="FailureDiv" runat="server" visible="false">
            <div class="col-xs-12">
                <div class="table-header">
                    <div style="float: left;">
                        <img src="../Content/images/regis_pro.png" /> Failure Transaction Account Details
                    </div>
                    <div style="float: left; background-color: red; font-size: 15px; font-weight: bold; height: 25px; margin: 5px 5px 0px; text-align: center; min-width: 30px; width: auto; line-height: 22px;">
