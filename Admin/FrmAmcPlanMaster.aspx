<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Title="Plan Master"
    CodeFile="FrmAmcPlanMaster.aspx.cs" Inherits="FrmAmcPlanMaster" %>
                ...
                <asp:Panel ID="DefaultButtonPanel" DefaultButton="ImgSearch" runat="server">
                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                        <tr>
                            ...
                            <td width="25%">
                                <asp:TextBox ID="txtsearchlblname" runat="server" CssClass="textbox_pop" placeholder="Plan Name"></asp:TextBox>
                            </td>
                            <td align="justify">
                                <div class="merg_btn">
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action" >
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("Plan_ID") %>'
                                ...
                                <asp:ImageButton ID="imgshowlbl123" runat="server" ImageUrl="~/Content/images/showhide2.png"
                                    ToolTip='<%# Bind("TooTipMsg") %>' CommandArgument='<%# Bind("Plan_ID") %>' CommandName="ShowHideLabel"
                                ...
                                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Content/images/lence.png" ToolTip="View Update Price Details"
                                    CommandArgument='<%# Bind("Plan_ID") %>' CommandName="ViewLabelDetails" />&nbsp;
                                <%index++; %>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                                ...
                                                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                                                    ...
                                                    <tr>
                                                        <td align="right" style="width: 36%;">
                                                            ...
                                                            <strong><span class="star_red">*</span>Plan Time :&nbsp;</strong>
                                                        </td>
                                                        <td>
                                    ...
                                    <asp:GridView ID="GrdViewLabelDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblprisedet12" Style="padding-left: 10px;" CssClass="txt_rupees rupees" runat="server" Text='<%# Bind("Plan_Amount") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="tr_haed" Font-Size="12px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" Width="50%" />
                                            </asp:TemplateField>
