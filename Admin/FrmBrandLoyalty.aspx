<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="FrmBrandLoyalty.aspx.cs" Inherits="FrmBrandLoyalty" Title="Brand Loyalty" %>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".accordion2 p").eq(29).addClass("active");
        $(".accordion2 div.open").eq(29).show();
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" ToolTip="Add New Brand Loyalty Product" OnClick="imgNew_Click"
                                    ImageUrl="~/Content/images/add_new.png" CausesValidation="false" runat="server" style="display:none;" />
                            </td>
                        </tr>
                    </table>
                </h2>
                ...
                <asp:Panel ID="DefaultButton" runat="server" DefaultButton="ImgSearch">
                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                        <tr>
                            ...
                            <td align="justify" width="22%" style="display:none;">
            ...
            <div id="allhidden">
                ...
                <asp:Label ID="lblproiddel" runat="server"></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Point To Cash">
                            <ItemTemplate>
                                <asp:Label ID="lbliScASHcONVERT" runat="server" 
                                    Text='<%# Bind("IsCashConvert") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />
                        ...
                        <asp:TemplateField HeaderText="Action" Visible="false">
                            ...
                            <%
                                ...
                                <asp:ImageButton ID="ImgIsActiveDelete" runat="server"  CausesValidation="false"  CommandArgument='<%#Bind("Pro_ID") %>'
                                    CommandName="IsActive" ImageUrl="~/Content/images/check_act.png" ToolTip="Add / Update Loyalty" OnClientClick="return confirm('Are you sure to In-Active.')" />
                                    <%} else { %>
                                    <asp:ImageButton ID="ImgIsActiveDeletes" runat="server"  CausesValidation="false" CommandArgument='<%#Bind("Pro_ID") %>'
                                    CommandName="IsActive" ImageUrl="~/Content/images/check_gr.png" ToolTip="Add / Update Loyalty" OnClientClick="return confirm('Are you sure to Active.')" />
                                    <%} %> 
                                <%
                                ...
                                &nbsp;<asp:ImageButton ID="imgBtnSecDelete" runat="server" 
                                    CommandArgument='<%#Bind("Pro_ID") %>' CommandName="DeleteRow"
                                    ImageUrl="~/Content/images/delete.png" ToolTip="Delete" OnClientClick="return confirm('Are you sure to delete.')" />
                                <% } %>  
                                <%index++;%>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed bord_left" HorizontalAlign="Center" />
                                                    ...
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                </asp:DropDownList>&nbsp;<a href="RegisteredProduct.aspx?Parm=New" title="Add New Brand Loyalty Product" ><img alt="" src="../Content/images/add_new.png" style="height:17px; width:17px;" /></a>                                                                
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red"
                                                                    ValidationGroup="LOY" InitialValue="--Select--" ControlToValidate="ddlProduct">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                                                    ValidationGroup="LOY" ControlToValidate="txtloyaltypoints">
                                                                </asp:RequiredFieldValidator>&nbsp;<asp:CheckBox runat="server" ValidationGroup="LOY"
                                                                    ID="chkconvert" Text="     Convert to Cash" />
                                                            </td>
                                                        </tr>
                                                        <tr>
