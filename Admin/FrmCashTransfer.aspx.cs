...
public partial class FrmCashTransfer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["User_Type"] == null)
            Response.Redirect("Login.aspx?Page=FrmCashTransfer.aspx");
        else
        {
    ...
    private void fillGrid()
    {
        ...
        if (ddlPro_ID.SelectedIndex > 0)
            obj.Pro_ID = ddlPro_ID.SelectedValue;
        else
            obj.Pro_ID = "";
        DataSet ds = Loyalty_Programm.FillGrVwCashTransfer(obj);
    ...
    {
        DataSet ds = new DataSet(); //function9420.FillActiveComp();
        ds = Business9420.function9420.FillAllComp();
