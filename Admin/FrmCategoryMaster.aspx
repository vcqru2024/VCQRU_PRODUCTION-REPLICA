<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    Title="Category Master" CodeFile="FrmCategoryMaster.aspx.cs" Inherits="FrmCategoryMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".accordion2 p").eq(54).addClass("active");
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" OnClick="imgNew_Click" ImageUrl="~/Content/images/add_new.png"
                                    runat="server" ToolTip="Add New Category" />
                            </td>
                        </tr>
                    </table>
                </h2>
                ...
                <asp:Panel ID="DefaultButtonPanel" DefaultButton="ImgSearch" runat="server">
                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                        <tr>
                            ...
                            <td width="25%">
                                <asp:TextBox ID="txtsearchlblname" runat="server" CssClass="textbox_pop" placeholder="Category Name"></asp:TextBox>
                            </td>
                            <td align="justify">
                                <div class="merg_btn">
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdCategory" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    OnRowCommand="GrdCategory_RowCommand" BorderColor="transparent" OnPageIndexChanging="GrdCategory_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("Category_ID") %>'
                                    CommandName="EditCategory" ToolTip="Edit Plan" />&nbsp;
                                <%
                                    try
                                    {
                                        lflag = Convert.ToInt32(GrdCategory.DataKeys[index].Values["Flag"].ToString());
                                    }
                                    catch { }
                                    if (lflag == 1)
                                    {  %>
                                <asp:ImageButton ID="imgshowlbl123" runat="server" ImageUrl="~/Content/images/showhide2.png"
                                    ToolTip='<%# Bind("TooTipMsg") %>' CommandArgument='<%# Bind("Category_ID") %>'
                                    CommandName="ShowHideCategory" Height="16px" Width="16px" />&nbsp;
                                <%}
                                    else
                                    {%>
                                ...
                                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Content/images/lence.png" ToolTip="View Update Price Details"
                                    CommandArgument='<%# Bind("Category_ID") %>' CommandName="ViewLabelDetails" Visible="false" />&nbsp;
                                <%index++; %>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                        ...
                                        <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                                            ...
                                            <tr>
                                                <td align="right" style="width: 36%;">
                                                    ...
                                                    <strong><span class="star_red">*</span>Category Name :&nbsp;</strong>
                                                </td>
                                                <td>
