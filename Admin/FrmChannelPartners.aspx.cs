...
public partial class FrmChannelPartners : System.Web.UI.Page
{    
    ...
    private void FillGrdMain()
    {
        ...
        Reg.chkstr = "";
        Reg.Name = txtPartnerName.Text.Trim().Replace("'","''");
        if ((txtDateFrom.Text != "") && (txtDateTo.Text != ""))
            Reg.chkstr = " AND CONVERT(VARCHAR,Entry_Date,111) >= '" + Convert.ToDateTime(txtDateFrom.Text).ToString("yyyy/MM/dd") + "' AND CONVERT(VARCHAR,Entry_Date,111) <= '" + Convert.ToDateTime(txtDateTo.Text).ToString("yyyy/MM/dd") + "' ";
        if ((txtDateFrom.Text != "") && (txtDateTo.Text == ""))
            Reg.chkstr = " AND CONVERT(VARCHAR,Entry_Date,111) >= '" + Convert.ToDateTime(txtDateFrom.Text).ToString("yyyy/MM/dd") + "' ";
        if ((txtDateFrom.Text == "") && (txtDateTo.Text != ""))
            Reg.chkstr = " AND CONVERT(VARCHAR,Entry_Date,111) <= '" + Convert.ToDateTime(txtDateTo.Text).ToString("yyyy/MM/dd") + "' ";        
        DataSet ds = function9420.FillGrdVwPartner(Reg);
