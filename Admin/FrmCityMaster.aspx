<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    Title="City Master" CodeFile="FrmCityMaster.aspx.cs" Inherits="FrmCityMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".accordion2 p").eq(53).addClass("active");
    ...
    <script language="javascript" type="text/javascript">
        function checkplan(vl) {
            PageMethods.checkNewCity(vl, onCompletePlan)
        }
        function onCompletePlan(Result) {
            if (Result == true) {
                document.getElementById("<%=lblLabelChk.ClientID %>").innerHTML = "City Name Already exist.";
        ...
        <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" OnClick="imgNew_Click" ImageUrl="~/Content/images/add_new.png"
                                    runat="server" ToolTip="Add New City" />
                            </td>
                        </tr>
                    </table>
                </h2>
            ...
            <fieldset class="field_profile">
                ...
                <asp:Panel ID="DefaultButtonPanel" DefaultButton="ImgSearch" runat="server">
                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                        <tr>
                            <td width="25%">
                                <asp:TextBox ID="txtsearchlblname" runat="server" CssClass="reg_txt" placeholder="City Name"></asp:TextBox>
                            </td>
                            <td width="25%">
                                <asp:DropDownList ID="DropDownList1" CssClass="textbox_pop" runat="server" />
                            </td>
                            <td align="justify">
                                <div class="merg_btn">
            ...
            <div class="grid_container">
                ...
                <div style="overflow: auto; height: 975px;">
                    <asp:GridView ID="GrdVwCity" runat="server" AutoGenerateColumns="False" CssClass="grid"
                        ...
                        OnRowCommand="GrdVwCity_RowCommand" BorderColor="transparent" OnPageIndexChanging="GrdVwCity_PageIndexChanging"
                        AllowPaging="True" PageSize="15">
                        <Columns>
                            <asp:TemplateField HeaderText="S.No.">
                                <ItemTemplate>
                                    <%--<%=++str %>--%>
                                    <asp:Label ID="lblstatesno" runat="server" Text='<%# Bind("sno") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText=" City Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblname" runat="server" Text='<%# Bind("CityName") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("CITY_ID") %>'
                                        CommandName="EditCity" ToolTip="Edit" />&nbsp;
                                    <%
                                        try
                                        {
                                            lflag = Convert.ToInt32(GrdVwCity.DataKeys[index].Values["Flag"].ToString());
                                        }
                                        catch { }
                                        if (lflag == 1)
                                        {  %>
                                    <asp:ImageButton ID="imgshowlbl123" runat="server" ImageUrl="~/Content/images/showhide2.png"
                                        ToolTip='<%# Bind("TooTipMsg") %>' CommandArgument='<%# Bind("CITY_ID") %>' CommandName="ShowHideLabel"
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="PanelRegCity" runat="server" Width="25%">
                                                    ...
                                                    <tr>
                                                        <td align="right" style="width: 36%;">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red"
                                                                InitialValue="--Select--" ValidationGroup="CREG" ControlToValidate="ddlstate"></asp:RequiredFieldValidator>
                                                            <strong><span class="star_red">*</span>State Name :&nbsp;</strong>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlstate" CssClass="textbox_pop" runat="server" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" style="width: 36%;">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                                                ValidationGroup="CREG" ControlToValidate="txtcityname"></asp:RequiredFieldValidator>
                                            ...
                                            <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                                                <tr>
                                                    <td align="right" colspan="2" style="padding-right: 5px;">
                                                        ...
                                                        <asp:Button ID="btnSave" OnClick="btnSave_Click" ValidationGroup="CREG" CssClass="button_all"
                ...
                <cc1:ModalPopupExtender ID="ModalPopupRegCity" runat="server" PopupControlID="PanelRegCity"
                    BackgroundCssClass="NewmodalBackground" TargetControlID="lblRegCity" CancelControlID="btnClosePop">
