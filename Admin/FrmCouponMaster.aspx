<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    Title="Coupon Master" CodeFile="FrmCouponMaster.aspx.cs" Inherits="FrmCouponMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".accordion2 p").eq(20).addClass("active");
                ...
                <h2 class="add_Courior">
                    <table width="99%">
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" ToolTip="Add New Coupon" OnClick="imgNew_Click" ImageUrl="~/Content/images/add_new.png"
            ...
            <asp:Panel ID="DemoPanel" runat="server">
                <div class="grid_container">
                    ...
                    <asp:GridView ID="GrdVw" runat="server" AutoGenerateColumns="False" CssClass="grid"
                        DataKeyNames="IsActive,UsedCodes" EmptyDataText="Record Not Found" EmptyDataRowStyle-HorizontalAlign="Center"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Coupon Provider Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblCourierEmail" runat="server" Text='<%# Bind("CouponProviderName") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Total Coupon">
                                <ItemTemplate>
                                    <asp:Label ID="lblTotalCodes" runat="server" Text='<%# Bind("TotalCodes") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" CssClass="grd_pad" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Alloted Coupon">
                                <ItemTemplate>
                                    <asp:Label ID="lblUsedCodes" runat="server" Text='<%# Bind("UsedCodes") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" CssClass="grd_pad" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Available Coupon">
                                <ItemTemplate>
                                    <asp:Label ID="lblUnUsedCodes" runat="server" Text='<%# Bind("UnUsedCodes") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" CssClass="grd_pad" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <%try
                                      {
                                          ...
                                          UsedCodes = Convert.ToInt64(GrdVw.DataKeys[index].Values["UsedCodes"]);
                                      }
                                      catch { }
                                      if (UsedCodes == 0)
                                      {
                                    ...
                                    <asp:ImageButton ID="ImgbtnEditCourier" runat="server" ImageUrl="~/Content/images/edit.png"
                                        CommandName="EditRow" CommandArgument='<%# Bind("Coupon_ID") %>' ToolTip="Edit Coupon"
                                    ...
                                    <asp:ImageButton ID="ImgbtnAct" runat="server" ImageUrl="~/Content/images/check_act.png"
                                        CommandName="ActivateRow" CommandArgument='<%# Bind("Coupon_ID") %>' ToolTip="De-Activate Coupon"
                                        CausesValidation="false" />
                                    <%}
                                        else
                                        { %>
                                    <asp:ImageButton ID="ImgbtnActN" runat="server" ImageUrl="~/Content/images/check_gr.png"
                                        CommandName="ActivateRow" CommandArgument='<%# Bind("Coupon_ID") %>' ToolTip="Acivate Coupon"
                                        CausesValidation="false" />
                                    <%} %>
                                    <asp:ImageButton ID="ImgbtnDel" runat="server" ImageUrl="~/Content/images/delete.png"
                                        CommandName="DeleteRow" CommandArgument='<%# Bind("Coupon_ID") %>' ToolTip="Delete Coupon"
                                        CausesValidation="false" />
                                    <%index++; %>
                                </ItemTemplate>
                                <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                        ...
                        <asp:Panel ID="Panel1" runat="server">
                            <div class="regis_popup">
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red"
                                                    ValidationGroup="PR1" ControlToValidate="ddlCouponProvider" InitialValue="--Select--">
                                                </asp:RequiredFieldValidator>
                                                <strong><span class="astrics">*</span>Coupon Provider :</strong>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlCouponProvider" runat="server" CssClass="drp"  >
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtName" runat="server" CssClass="textbox_pop" Text="" MaxLength="20"
                                        ...
                                        <tr>
                                            <td align="right" width="35%">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                                    ValidationGroup="PR1" ControlToValidate="FileUpload1">
                                                </asp:RequiredFieldValidator>
                                                <strong><span class="astrics">*</span>Coupon Excel File :</strong>
                                            </td>
                                            <td>
                                ...
                                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                                    <tr>
                                        <td align="left">
                                        <span style="color:Red; padding-left:5px; float:left;">Coupon Name should be in 20 char.</span>
                                        </td>
                                        <td align="right">                                        
