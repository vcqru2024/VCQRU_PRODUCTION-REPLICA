<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Title="Coupon Quantity Management"
    CodeFile="FrmCouponsQuantityMgt.aspx.cs" Inherits="FrmCouponsQuantityMgt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".accordion2 div.open").eq(19).show();
                                ...
                                <fieldset id="Fieldset2" runat="server" class="Newfield Newfield_width2">
                                    ...
                                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlCouponProvider" runat="server" CssClass="drp" ></asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
