<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Title="Amc Discount Master"
    CodeFile="FrmDiscountMaster.aspx.cs" Inherits="FrmDiscountMaster" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1" runat="server"
                DisplayAfter="0">
                <ProgressTemplate>
                    <div align="center" style="position: absolute; left: 0; height: 1500px; width: 100%;
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" OnClick="imgNew_Click" ImageUrl="~/Content/images/add_new.png"
                                    runat="server" ToolTip="Add New AMC Discount" />
                            </td>
                        </tr>
                    </table>
                </h2>
            ...
            <fieldset class="field_profile">
                ...
                <asp:Panel ID="DefaultButtonPanel" DefaultButton="ImgSearch" runat="server">
                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                        <tr>                           
                            <td width="25%">
                                <asp:TextBox ID="txtsearchlblname" runat="server" CssClass="reg_txt" placeholder="Plan Name"></asp:TextBox>
                            </td>
                            <td align="justify">
                                <div class="merg_btn">
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText=" Plan Name">
                            <ItemTemplate>
                                <asp:Label ID="lblname" runat="server" Text='<%# Bind("Plan_Name") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Discount">
                            <ItemTemplate>
                                <asp:Label ID="lbldiscount" CssClass="txt_rupees percentage" Width="38px" style="padding: 0px 6px 0px 0px;"
                        ...
                        <asp:TemplateField HeaderText="Date From">
                            <ItemTemplate>
                                <asp:Label ID="lbldtfrom" runat="server" Text='<%# Bind("Date_From","{0:dd-MMM-yyyy}") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="Date To">
                            <ItemTemplate>
                                <asp:Label ID="lbldtto" runat="server" Text='<%# Bind("Date_To","{0:dd-MMM-yyyy}") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("TransID") %>'
                                    CommandName="EditLabel" ToolTip="Edit Plan Discount" />&nbsp;
                                <%
                                    try
                                    {
                                ...
                                <asp:ImageButton ID="imgshowlbl123" runat="server" ImageUrl="~/Content/images/showhide2.png"
                                    ToolTip='<%# Bind("TooTipMsg") %>' CommandArgument='<%# Bind("TransID") %>' CommandName="ShowHideLabel"
                                ...
                                <asp:ImageButton ID="imgshowlbl" runat="server" ImageUrl="~/Content/images/showhide1.png"
                                    ...
                                    Height="16px" Width="16px" />
                                <%} %>
                                <%--<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Content/images/lence.png" ToolTip="View Label Price Details"
                                    CommandArgument='<%# Bind("TransID") %>' CommandName="ViewLabelDetails" />&nbsp;--%>
                                <%index++; %>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                ...
                <asp:Label ID="Lbltranstype" runat="server" Text="" Visible="false"></asp:Label>
                <!-- ******************* Popup Start *********************-->
                                    ...
                                    <asp:Panel ID="PnlCreateLavel" runat="server">
                                        <div class="regis_popup">
                                            ...
                                            <fieldset id="ftg" runat="server" class="Newfield Newfield_width2">
                                                <legend>Discount Plan Info</legend>
                                                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                                                    ...
                                                    <tr>
                                                        <td align="right" style="width: 36%;">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red"
                                                                InitialValue="--Select--" ValidationGroup="LCR" ControlToValidate="ddlplan"></asp:RequiredFieldValidator>
                                                            <strong><span class="star_red">*</span>Plan Name :&nbsp;</strong>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlplan" CssClass="textbox_pop" runat="server" AutoPostBack="true"
                                                                OnSelectedIndexChanged="ddlplan_SelectedIndexChanged" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" style="width: 36%;">
                                                            <strong><span class="star_red">*</span>Plan Amount :&nbsp;</strong>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblplanAmount" runat="server" Width="120px" MaxLength="10" Style="padding-left: 10px;"
                                                                CssClass="txt_rupees rupees"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" style="width: 36%;">
                                                            ...
                                                            <strong><span class="star_red">*</span>Discount(In Percent) :&nbsp;</strong>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtlabelprise" runat="server" Width="50px" MaxLength="5" OnKeyPress="return isNumberKey(this, event);"
                                                                placeholder=".....%" onchange="mathRoundForTaxes(this.id);"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" style="width: 36%;">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                                                ValidationGroup="LCR" ControlToValidate="txtdatefrom"></asp:RequiredFieldValidator>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ForeColor="Red"
                                                                ValidationGroup="LCR" ControlToValidate="txtdateto"></asp:RequiredFieldValidator>
                                                            <strong><span class="star_red">*</span>Date :&nbsp;</strong>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtdatefrom" runat="server" Width="120px" CssClass="textbox_pop"   onkeydown = "return checkShortcut();"
                                                                placeholder="Date From"></asp:TextBox>&nbsp;
                                                            <asp:TextBox ID="txtdateto" runat="server" Width="120px" CssClass="textbox_pop" placeholder="Date To"   onkeydown = "return checkShortcut();"></asp:TextBox>
                                ...
                                <div class="regis_popup" style="overflow: auto; height: 350px;">
                                    <asp:GridView ID="GrdViewLabelDetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Plan Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblprisedet12" runat="server" Text='<%# Bind("Plan_Name") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="tr_haed" Font-Size="12px" HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" Width="50%" />
                                            </asp:TemplateField>
