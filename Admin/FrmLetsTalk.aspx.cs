...
public partial class FrmLetsTalk : System.Web.UI.Page
{
    public int str = 0, strr = 0,lflag =0; public int index = 0;
    protected void Page_Load(object sender, EventArgs e)
    {        
        if (Session["User_Type"] == null)
            Response.Redirect("Login.aspx?Page=FrmLetsTalk.aspx");
        else
        {
    ...
    {        
        ...
        Reg.Name = txtsearchname.Text.Trim().Replace("'", "''");
        DataSet ds = function9420.GetLetsTalkSearch(Reg);        
