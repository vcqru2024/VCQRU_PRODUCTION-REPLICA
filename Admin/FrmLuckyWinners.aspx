<%@ Page Title="Lucky Winners Details" Language="C#" MasterPageFile="~/Admin/MasterPage.master"
    AutoEventWireup="true" CodeFile="FrmLuckyWinners.aspx.cs" Inherits="FrmLuckyWinners" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/UserControl/UC_LuckyWinners.ascx" TagPrefix="uc1" TagName="UC_LuckyWinners" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <uc1:UC_LuckyWinners runat="server" ID="UC_LuckyWinners" />
    <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                            <tr>
                                ...
                                <td align="justify" width="15%">
                                    <asp:DropDownList ID="ddlSendSMS" runat="server" CssClass="reg_txt"  AutoPostBack="true"
                                        OnSelectedIndexChanged="ddlproduct_SelectedIndexChanged" >
                                ...
                                <td width="15%">
                                    <asp:DropDownList ID="ddlDelivery" runat="server" CssClass="reg_txt"  AutoPostBack="true"
                                        OnSelectedIndexChanged="ddlproduct_SelectedIndexChanged" >
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdVw" runat="server" AutoGenerateColumns="False" CssClass="grid" DataKeyNames="Service_ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Prize">
                            <ItemTemplate>
                                <asp:Label ID="lblnetwork" runat="server" Text='<%# Convert.ToString(Eval("Service_ID")) == "SRV1003" ? "Yes" : Eval("Prize") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
