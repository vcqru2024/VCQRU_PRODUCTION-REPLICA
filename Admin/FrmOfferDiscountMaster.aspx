<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Title="Offer Discount Master"
    CodeFile="FrmOfferDiscountMaster.aspx.cs" Inherits="FrmOfferDiscountMaster" %>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" OnClick="imgNew_Click" ImageUrl="~/Content/images/add_new.png"
                                    runat="server" ToolTip="Add New Offer Discount" />
                            </td>
                        </tr>
                    </table>
                </h2>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("TransID") %>'
                                    CommandName="EditLabel" ToolTip="Edit Offer Discount" />&nbsp;
                                <%
                                    try
                                    {
                                    ...
                                    <asp:Panel ID="PnlCreateLavel" runat="server">
                                        <div class="regis_popup">
                                            ...
                                            <fieldset id="ftg" runat="server" class="Newfield Newfield_width2">
                                                <legend>Discount Offer Info</legend>
                                                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
