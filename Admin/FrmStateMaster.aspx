<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    Title="State Master" CodeFile="FrmStateMaster.aspx.cs" Inherits="FrmStateMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".accordion2 p").eq(52).addClass("active");
    ...
    <script language="javascript" type="text/javascript">
        ...
        function onCompletePlan(Result) {
            if (Result == true) {
                document.getElementById("<%=lblLabelChk.ClientID %>").innerHTML = "State Name Already exist.";
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgNew" OnClick="imgNew_Click" ImageUrl="~/Content/images/add_new.png"
                                    runat="server" ToolTip="Add New State" />
                            </td>
                        </tr>
                    </table>
                </h2>
            ...
            <fieldset class="field_profile">
                ...
                <asp:Panel ID="DefaultButtonPanel" DefaultButton="ImgSearch" runat="server">
                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                        <tr>
                            <td width="25%">
                                <asp:TextBox ID="txtsearchlblname" runat="server" CssClass="reg_txt" placeholder="State Name"></asp:TextBox>
                            </td>
                            <td align="justify">
                                <div class="merg_btn">
                    ...
                    <asp:GridView ID="GrdVwCity" runat="server" AutoGenerateColumns="False" CssClass="grid"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText=" City Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblname" runat="server" Text='<%# Bind("StateName") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("STATE_ID") %>'
                                    ...
                                    <asp:ImageButton ID="imgshowlbl123" runat="server" ImageUrl="~/Content/images/showhide2.png"
                                        ToolTip='<%# Bind("TooTipMsg") %>' CommandArgument='<%# Bind("STATE_ID") %>' CommandName="ShowHideLabel"
