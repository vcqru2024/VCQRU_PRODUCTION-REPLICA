<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="GiftDetails.aspx.cs" Inherits="Admin_GiftDetails" %>

<%@ Register Src="~/UserControl/UC_AwardDetails.ascx" TagPrefix="uc1" TagName="UC_CashDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:UC_CashDetails runat="server" ID="UC_CashDetails" />
