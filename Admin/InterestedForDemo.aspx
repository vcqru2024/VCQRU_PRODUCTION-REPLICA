<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="InterestedForDemo.aspx.cs" Inherits="InterestedForDemo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".accordion2 p").eq(39).addClass("active");
        ...
        <ContentTemplate>
            ...
            <fieldset class="field_profile">
                ...
                <asp:Panel ID="DefaultButton" runat="server" DefaultButton="ImgSearch">
                    <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                        <tr>
                            <td align="right">
                            <asp:TextBox ID="txtcompname" runat="server" Text="" placeholder="Company Name ..."
                                    CssClass="reg_txt"></asp:TextBox>
                            </td>
                            <td align="right">
                            <asp:TextBox ID="txtClientname" runat="server" Text="" placeholder="Contact Person ..."
                                    CssClass="reg_txt"></asp:TextBox>
                            </td>
                            <td width="18%">
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdVwTestimonial" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    DataKeyNames="Contact_Flag,Status1" EmptyDataText="Record Not Found" EmptyDataRowStyle-HorizontalAlign="Center"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="S.No">
                         ...
                         <asp:TemplateField HeaderText="Date">
                            <ItemTemplate>
                                <asp:Label ID="lblEntryDate" runat="server" Text='<%#Bind("Reg_Date","{0:dd-MMM-yyyy hh:mm:ss tt}") %>' />
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Name">
                            <ItemTemplate>
                                <asp:Label ID="lblclientname" runat="server" Text='<%#Bind("Contact_Person") %>' ></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" />
                            <ItemStyle HorizontalAlign="Left" CssClass="grd_pad" Width="10%" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Email ID">
                            <ItemTemplate>
                                <asp:Label ID="lblTestimonialllp" runat="server" Text='<%#Bind("Mobile_No") %>'
                                    ToolTip='<%#Bind("Mobile_No") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" />
                        ...
                        <asp:TemplateField HeaderText="Email ID">
                            <ItemTemplate>
                                <asp:Label ID="lblTestimonialllp" runat="server" Text='<%#Bind("Comp_Email") %>'
                                    ToolTip='<%#Bind("Comp_Email") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" />
                            <ItemStyle HorizontalAlign="Left" CssClass="grd_pad" Width="15%" />
                        </asp:TemplateField>                                                                    
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                            <asp:Label ID="opst" Text='<%#Bind("Status") %>' runat="server" ForeColor="#0C6FC5"></asp:Label>
                                <%--<asp:LinkButton ID="LinkButton3" runat="server" Text='<%#Bind("Status") %>'  CommandName="ChangeStatus"
                                    CommandArgument='<%# Bind("Row_ID") %>'  OnClientClick="return confirm('Are You Sure ?')"></asp:LinkButton>--%>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" />
                        ...
                        <%--<asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                            <%try { Flag = Convert.ToInt32(GrdVwTestimonial.DataKeys[index]["Contact_Flag"].ToString()); }
                              catch { }%>                               
                                <asp:ImageButton ToolTip="Edit" ID="ImageButton1" runat="server" CausesValidation="false" 
                                    ImageUrl="~/Content/images/Button/019.png" CommandArgument='<%# Bind("Row_ID") %>'
                                    CommandName="EditRow" />&nbsp;
                                    <%if (Flag == 1)
                                      { %>                                                                    
                                <asp:ImageButton ToolTip="De-Activate" ID="imgbtnedit" runat="server" CausesValidation="false" OnClientClick="return confirm('Are You Sure ?')"
                                    ImageUrl="~/Content/images/check_act.png" CommandArgument='<%# Bind("Row_ID") %>'
                                    CommandName="Confirm" />&nbsp;
                                     <%}
                                      else
                                      { %>
                                    ...
                                    ImageUrl="~/Content/images/check_gr_red.png"  CommandArgument='<%# Bind("Row_ID") %>'
                                    CommandName="Confirm" />&nbsp;
                                    <%} %>
                                <asp:ImageButton ID="ImageButton1Clo" runat="server" CommandArgument='<%# Bind("Row_ID") %>'
