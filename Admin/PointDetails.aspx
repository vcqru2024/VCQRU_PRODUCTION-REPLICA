<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="PointDetails.aspx.cs" Inherits="Consumer_PointDetails" Title="Points Transaction" %>
        ...
        <ContentTemplate>
                        ...
                        <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                            <tr>
                                ...
                                <td align="center" width="23%">
                                    <%--<strong>Product Name :</strong>--%><asp:DropDownList ID="ddlProduct" runat="server" AutoPostBack="true"
                                ...
                                <td width="15%">
                                    <asp:DropDownList ID="ddlEarntype" runat="server" CssClass="textbox_pop">
                ...
                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                    <tr>
                        <td width="5%" align="right">
                            <span class="WebRupee" style="font-size: 12px; font-weight: bold;">&#x20B9;</span><%--&#8377;--%>
                        </td>
                        <td width="25%">
                            These points can be converted to cash
                        </td>
                        <td width="20%">
                        </td>
                        <td width="10%">
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    DataKeyNames="Type,IsCashConvert" EmptyDataText="Record Not Found" EmptyDataRowStyle-HorizontalAlign="Center"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText=" Company Name">
                            <ItemTemplate>
                                <asp:Label ID="lblname" runat="server" Text='<%# Bind("CompName") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                        ...
                        <asp:TemplateField HeaderText="Product Name">
                            <ItemTemplate>
                                <asp:Label ID="lblsize" runat="server" Text='<%# Bind("ProductName") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="15%" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText=" Earn">
                            <ItemTemplate>
                                ...
                                <%} %>
                                <asp:Label ID="lblearntype" runat="server" Text='<%# Bind("Points") %>'></asp:Label>
                                <%}
                                  else
                                  { %>
