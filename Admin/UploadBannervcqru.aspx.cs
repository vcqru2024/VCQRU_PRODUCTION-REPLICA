...
public partial class Admin_UploadBannervcqru : System.Web.UI.Page
{
    ...
    protected void add_blog_Click1(object sender, EventArgs e)
    {
        ...
        //con.Open();
        blgimg.SaveAs(Server.MapPath("~/assets/images/kd") + Path.GetFileName(blgimg.FileName));
        string imgpath = "assets/images/kd" + Path.GetFileName(blgimg.FileName);
        ...
        SQL_DB.ExecuteNonQuery("INSERT INTO Tbl_bannerVcqru (ImagePath,compid)values('" + imgpath + "','VCQRU')");
