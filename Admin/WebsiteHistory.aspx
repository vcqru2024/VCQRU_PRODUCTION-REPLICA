<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="WebsiteHistory.aspx.cs" Inherits="Admin_WebsiteHistory" %>

<%@ Register Src="~/UserControl/UC_WebsiteHitHistory.ascx" TagPrefix="uc1" TagName="UC_WebsiteHitHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:UC_WebsiteHitHistory runat="server" ID="UC_WebsiteHitHistory" />
