<%@ Page Title="Product Enquiry Details" Language="C#" MasterPageFile="~/Admin/MasterPage.master"
    AutoEventWireup="true" CodeFile="frmProductEnquiry.aspx.cs" Inherits="frmProductEnquiry" %>
                ...
                <asp:GridView ID="GrdEnquiry" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Network">
                            <ItemTemplate>
                                <asp:Label ID="lblnetwork" runat="server" Text='<%# Bind("Network") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
