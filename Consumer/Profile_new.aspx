...
<head runat="server">
 ...
 <body>
                   ...
                   <div class="navbar-container container-fluid">
                       <ul class="nav-left">
                         <%--   <li>
                           ...
                           <li class="active" >
								<a href="profile.aspx?jnj8877">Profile</a>
  ...
  referrerpolicy="no-referrer"/>
                                  <span><asp:Label ID="lblusertop" runat="server" /></span>
                              ...
                              <ul class="show-notification profile-notification">
                                   ...
                                   <li>
                                                                             <i class="ti-layout-sidebar-left"></i>  <asp:Button runat="server" BorderStyle="None" BackColor="Transparent" Text="Logout" OnClick="Logout" />
 ...
 <div class="profile-overlap profile-overlap-edit" id="profile-over">
     ...
     <asp:Button runat="server" ID="btnprf" style="display:none" />
						...
						<h2><asp:Label ID="lblUser_name" runat="server" /></h2>
						<span class="text-white"><asp:Label ID="lblUser_designation" runat="server" /></span>
                             <span><asp:Label ID="lblMMUser" runat="server" Style="display:none;"></asp:Label></span>
						</div>
						</div>
						<div>
						</div>
...
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#upload_document" role="tab" id="upload_nav" runat="server"><i class="fa fa-home"></i>Upload Document</a>
<div class="slide"></div>
</li>
...
<h5 class="card-header-text"><i class="ti-user mr-2"></i> Upload Document</h5>
...
<label class="col-sm-12 col-form-label custom_label">Upload Your Aadhar Front</label>
...
<label class="col-sm-12 col-form-label custom_label">Upload Your Aadhar Back</label>
  ...
  <div class="row">
    <div class="form-group col-md-6">
<label class="col-sm-12 col-form-label custom_label">upload Cancelled Cheque/Passbook.</label>
...
<div class="col-sm-8">
<%--<input type="text" class="form-control" value="Faridabad" placeholder="Enter Your City">
    <asp:TextBox ID="txtCity" runat="server" class="form-control" Text="" MaxLength="50"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" Display="Dynamic" runat="server" ForeColor="Red"
