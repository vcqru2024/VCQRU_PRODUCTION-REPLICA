...
public partial class Consumer_Transactions : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Comp_id"] == null)
            Response.Redirect("../Login.aspx?page=transaction");
    ...
    {
        string PayoutSelectiontesla = string.Empty;
        DataTable dttesla = new DataTable();
        dttesla = SQL_DB.ExecuteDataTable("select top 1 * from m_consumer where M_Consumerid=" + Session["M_ConsumeriD"].ToString());
        if (dttesla.Rows.Count > 0)
        {
            PayoutSelectiontesla = dttesla.Rows[0]["teslapayoutmode"].ToString();
            if (PayoutSelectiontesla == "Bank" && Session["Comp_id"].ToString() == "Comp-1722")
            {
                return;
            }
        }
        ...
        else
        {
...

            {
...

                {
                    ...
                    if (dtcp.Rows[0]["Comp_ID"].ToString() == "Comp-1726" || dtcp.Rows[0]["Comp_ID"].ToString() == "Comp-1538" || dtcp.Rows[0]["Comp_ID"].ToString() == "Comp-1548" || dtcp.Rows[0]["Comp_ID"].ToString() == "Comp-1709" || dtcp.Rows[0]["Comp_ID"].ToString() == "Comp-1673" || dtcp.Rows[0]["Comp_ID"].ToString() == "Comp-1702" || dtcp.Rows[0]["Comp_ID"].ToString() == "Comp-1722")
                    { // shercotti -1726
                    ...
                    if (dtcondition.Rows.Count > 0)
                    {
                        ...
                        tp = totalpoint - redeempoint - claimapply- Cashredeem;
                ...
                {
                    if (dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1727" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1726" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1538" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1466" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1548" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1709" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1708" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1673" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1702" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1483" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1278" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1285" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1375" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1434" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1550" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1350" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1466" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1722")
                    {
                        paytm.Visible = false;

                        if (dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1727" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1466" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1548" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1709" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1708" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1483" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1285" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1375" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1434" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1550" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1350" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1466")
                        {
                        ...
                        else if (dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1726" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1538" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1673" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1702" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1722")
                        {
                        ...
                        #region UPI Claim process
                        else if (dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1726" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1538" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1548" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1673" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1702")
                        {
                            for (int i = 0; i < table.Rows.Count; i++)
                            {
                                if (tp <= 0)
                        ...
                        #region Tesla
                        else if ((dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1722"))
                        {
                            for (int i = 0; i < table.Rows.Count; i++)
                            {
                                if (Convert.ToInt32(table.Rows[i]["Gift_value"].ToString()) > tp)
                    ...
                    else if (dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1726" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1538" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1466" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1548" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1709" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1673" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1702" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1722")
                    {
                        for (int i = 0; i < table.Rows.Count; i++)
                        {
    ...
    protected void btnpointClaim_UPI_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string UPIKYCTESTLA = string.Empty;  // Tesla
            DataTable dt = new DataTable();
            dt = SQL_DB.ExecuteDataTable("select top 1 * from m_consumer where M_Consumerid=" + Session["M_ConsumeriD"].ToString());

            // add for lubigen tej
            if (dt.Rows.Count > 0)
            {
                UPIKYCTESTLA = dt.Rows[0]["UPIKYCSTATUS"].ToString();
                if (Session["Comp_id"].ToString() == "Comp-1722" && (UPIKYCTESTLA == "0" || UPIKYCTESTLA==null || UPIKYCTESTLA=="")) // Tesla
                {
                    ClientScript.RegisterStartupScript(typeof(Page), "alertMessage", "<script type='text/javascript'>alert('You are not eligible to claim due to KYC pending. Please contact the administrator.');window.location.replace('');</script>");
                    return;
                }
                if (Session["Comp_id"].ToString() == "Comp-1722" && UPIKYCTESTLA == "2") // Tesla
                {
                    ClientScript.RegisterStartupScript(typeof(Page), "alertMessage", "<script type='text/javascript'>alert('You are not eligible to claim due to your KYC is rejected. Please contact the administrator.');window.location.replace('');</script>");
                    return;
                }
                if (txtUpiId != "")
                {
           ...
           // string str = String.Format("http://localhost:53992/api/ApiSubmitClaim");
