...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	...
	  "@type": "Organization",												
	  "name": "VCQRU",												
	  "alternateName": "We Secure You",												
	  "url": "https://www.vcqru.com/",												
	  "logo": "https://www.vcqru.com/NewContent/img-home/logo.png",												
	  "contactPoint": [{												
	    "@type": "ContactPoint",												
	    "telephone": "+91 124 5181074",												
	    "contactType": "customer service",									 			
	    "areaServed": "IN",												
	    "availableLanguage": ["en","Hindi","Bengali","Malayalam","Marathi","Oriya","Panjabi","Telugu","Tamil"]												
	  },{												
	    "@type": "ContactPoint",												
	"    ""telephone"": ""
            +91-124 5181074"","												
	...
	  }],												
	  "sameAs": [												
	    "https://www.facebook.com/vcqru/",												
	    "https://twitter.com/Vcqru_Official",												
	    "https://www.youtube.com/channel/UCmQmBBnF3pHfM2czRYZhYAQ",												
	    "https://www.linkedin.com/company/vcqru-wesecureyou"												
	  ]												
	}												
	</script>
    <script type="application/ld+json">		
	...
	@context : "https://schema.org",		
	@type : "WebSite",		
	name : "VCQRU - We Secure You",		
	url : "https://www.vcqru.com"		
	}		
	</script>
    <title>Globally Trusted Anti-counterfeit and Loyalty Solution Provider | VCQRU</title>
    <meta name="title" content="Globally Trusted Anti-counterfeit and Loyalty Solution Provider | VCQRU" />
   <meta name="description" content="VCQRU is a leading Anti-counterfeit and Loyalty Solution Provider company in India. Our expertise lies in customize solutions including anti-counterfeit, loyalty program, smart packaging, security labels, e-warranty solutions and comprehensive digital marketing with website development services." />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <section class="header-slider">
        <div id="carouselExampleAutoplaying" class="carousel slide carousel-fade" data-bs-ride="carousel"
           ...
           <%--     <div class="carousel-item " data-bs-interval="5000">
                    <p><a href="https://www.vcqru.com/event/ihff-event.aspx"> <img src="../NewContent/front-assets/img/IHFF_revised.jpg" class="d-block w-100" alt="Banner"></a></p>
       
     </div>--%>
               <%-- <div class="carousel-item " data-bs-interval="5000">
                    <img src="../NewContent/front-assets/img/PackPlus-2024-Banner.jpg" class="d-block w-100" alt="Banner">
                    
                </div>--%>
                <div class="carousel-item active" data-bs-interval="5000">
                    <p> <a href="https://www.vcqru.com/anti-counterfeiting-solutions.aspx"><img src="../NewContent/front-assets/img/banner1_revised1.jpg" class="d-block w-100" alt="Banner"></a></p>
                    
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <p><a href="https://www.vcqru.com/anti-counterfeiting-solutions.aspx"><img src="../NewContent/front-assets/img/Banner_2AntiCounterfeit..jpg" class="d-block w-100" alt="Banner"></a></p>
                   
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    <p><a href="https://www.vcqru.com/anti-counterfeiting-solutions.aspx"> <img src="../NewContent/front-assets/img/Banner_3AntiCounterfeit.jpg" class="d-block w-100" alt="Banner"></a></p>
                  
                </div>
                 <div class="carousel-item" data-bs-interval="5000">
                    <p><a href="https://www.vcqru.com/customer-loyalty-program.aspx"> <img src="../NewContent/front-assets/img/Banner_4BuildLoyalty.jpg" class="d-block w-100" alt="Banner"></a></p>
                  
                </div>
                   <div class="carousel-item" data-bs-interval="5000">
                    <p><a href="https://www.vcqru.com/customer-loyalty-program.aspx"> <img src="../NewContent/front-assets/img/Banner_5BuildLoyalty.jpg" class="d-block w-100" alt="Banner"></a></p>
                  
                </div>
                 <div class="carousel-item" data-bs-interval="5000">
                    <p><a href="https://www.vcqru.com/customer-loyalty-program.aspx"> <img src="../NewContent/front-assets/img/Banner_6BuildLoyalty.jpg" class="d-block w-100" alt="Banner"></a></p>
                  
                </div>
                 <div class="carousel-item" data-bs-interval="5000">
                    <p><a href="https://www.vcqru.com/product.aspx"> <img src="../NewContent/front-assets/img/Banner_7AllProducts.jpg" class="d-block w-100" alt="Banner"></a></p>
                        ...
                        <div class="col count-left-border">
                            <div class="counter-col">
                                <ul>
                                    ...
                                    <li>
                                        <h5 id="counter2"></h5>
                                        <p>Customer Benefited By Loyalty Program</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col count-left-border">
                            <div class="counter-col">
                                <ul>
                                    ...
                                    <li>
                                        <h5 id="counter3"></h5>
                                        <p>E-Warranty Registration By Customers</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <script>
        ...
        let counter1 = setInterval(updateCounter1, 200); // Counter 1 increments every 500ms
        let counter2 = setInterval(updateCounter2, 200); // Counter 2 increments every 700ms
        let counter3 = setInterval(updateCounter3, 200); // Counter 3 increments every 900ms
        let counter4 = setInterval(updateCounter4, 200); // Counter 4 increments every 1100ms
    </script>
</asp:Content>
