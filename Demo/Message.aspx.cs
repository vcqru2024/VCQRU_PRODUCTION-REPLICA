...
public partial class Messageshow : System.Web.UI.Page
{
    ...
    private void CheckUserDetail()
    {
        ...
        if (dsPass.Tables[0].Rows.Count > 0)        {
            ...
            {
                if (!File.Exists(path))
                    Session["MyNewMessage"] = "Your account is in-active, please <a href='UpDateCompanyProfile.aspx' style='color:blue;'> update your profile </a> & <a href='frmUploadDocuments.aspx' style='color:blue;'> upload required documents</a>. If already done , please wait for activation from ADMIN.";
