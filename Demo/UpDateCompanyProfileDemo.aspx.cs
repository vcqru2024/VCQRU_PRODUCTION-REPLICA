...
public partial class UpDateCompanyProfileDemo : System.Web.UI.Page
{
...
//        ModalPopupExtenderNewDesign.Show();
    ...
    protected void btnSaveDemo_Click(object sender, EventArgs e)
    {
        ...
        LblMsgUpdate.Text = "<b>Dear " + obj.Contact_Person + "</b><br/> Thanks for registration with us. Please check your email for <br/> to verify your account. <br/> <br/> <b> Thank you,</b> <br/> Team: VCQRU <br/>  " + ProjectSession.sales_accomplishtrades + " ";
