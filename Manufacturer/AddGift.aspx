<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="AddGift.aspx.cs" Inherits="Manufacturer_AddGift" %>
                   ...
                   <%-- <h6> Product Info</h6>--%>
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                            <span class="req">*</span><label>Gift Name</label>
                             <asp:TextBox ID="txtName" runat="server" CssClass="form-control form-control-sm" Text="" MaxLength="20"
                        ...
                        <div class="form-group col-lg-4"><asp:Button ID="btnSubmit" OnClick="btnSubmit_Click" ValidationGroup="PR1"
                         ...
                         <div class="form-group col-lg-2">  <asp:Button ID="btnReset"
                                                    OnClick="btnReset_Click" CausesValidation="false" CssClass="btn btn-primary float-right mb-0"
