...
public partial class Manufacturer_AddPU : System.Web.UI.Page
{
    ...
    public void EditMode()
    {
        ...
        DataTable dt = SQL_DB.ExecuteDataTable("Select * from ProductionUnit where ProductionUnitID =" + Giftid_Prop);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("FrmProductionUnit.aspx?edit=s");
    }
    ...
    {
        Response.Redirect("FrmProductionUnit.aspx");
