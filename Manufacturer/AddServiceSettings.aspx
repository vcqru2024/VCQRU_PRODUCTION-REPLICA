...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="form-group col-lg-3" runat="server" id="serieslabel">
                        ...
                        <div class="form-row" id="divispoints" runat="server" >
                         ...
                         <div class="form-row" id="InstantPayoutMode" runat="server" visible="false">
                            <div class="form-group col-lg-3">
                                <span class="req">*</span><label>Select Payout Mode Type</label>
                                  </div>
                             <div class="form-group col-lg-6">
                                <asp:DropDownList ID="dllpayoutmode" runat="server" class="form-control form-control-sm">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">NEFT</asp:ListItem>
                                    <asp:ListItem Value="2">IMPS</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ErrorMessage="*" ForeColor="Red"
                                    runat="server" ControlToValidate="dllpayoutmode"
                                    ValidationGroup="Set" InitialValue="0"></asp:RequiredFieldValidator>
                            </div>

                             <div class="form-group col-lg-2">
                                  <asp:Button ID="btnpayoutmode" runat="server" Text="Update" ValidationGroup="Set" class="btn btn-primary float-left mt-10" OnClick="btnpayoutmode_Click" />
                        ...
                        <!-- #endregion -->
                             ...
                             <div class="form-row" id="UPILimitsetting" runat="server" visible="false" >
                              <div class="form-group col-lg-3">
                                     <span class="req">*</span><label>UPI Payment Limit(Per Day)</label>
                                  </div>
                                   <div class="form-group col-lg-3">
                                   <asp:TextBox ID="txtdailylimit" class="form-control form-control-sm"  runat="server"
                                                onkeyDown="return checkTextAreaMaxLength(this,event,'5');"></asp:TextBox>
                                         <%--  <span id="lbliscash"></span>--%>
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ForeColor="Red" ValidationGroup="Set" ErrorMessage="*"
                                                ControlToValidate="txtdailylimit">
                                            </asp:RequiredFieldValidator>
                                       </div>
                                        <div class="form-group col-lg-2"> &nbsp;&nbsp;&nbsp;&nbsp;
                                       <asp:CheckBox Text="&nbsp;&nbsp;Claim Required ?" ValidationGroup="Set"
                                                    runat="server" ID="ChkClaimRequired"   class="form-check-input"/>
                                  </div>

                               <div class="form-group col-lg-2"> &nbsp;&nbsp;&nbsp;&nbsp;
                                       <asp:CheckBox Text="Approval Required ?" ValidationGroup="Set"
                                                    runat="server" ID="ChkApprovalRequired"   class="form-check-input"/>
                                  </div>

                                  <div class="form-group col-lg-2">
                                  <asp:Button ID="btnlimitset" runat="server" Text="Set" ValidationGroup="Set" class="btn btn-primary float-left mt-10" OnClick="btnlimitset_Click" />
