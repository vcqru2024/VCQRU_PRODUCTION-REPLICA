...
public partial class Manufacturer_AddServiceSubscription : System.Web.UI.Page
{
    ...
    private void FillDropdown()
    {
       ...
       // ddlsearchPro.SelectedIndex = 0;
        DataSet  ds = SQL_DB.ExecuteDataSet("SELECT Service_ID, ServiceName, IsShowPrice, EntryDate, Image, IsActive, IsDelete FROM M_Service WHERE IsActive = 0 AND IsDelete = 0");
