<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true"
    CodeFile="AddSoftCodeToProductDetails.aspx.cs" Inherits="Manufacturer_AddSoftCodeToProductDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        function CheckBatch_NoVal(vl) {
            ...
            if (document.getElementById('<%=HDF.ClientID %>').value == "") {
                        ...
                        document.getElementById("<%=btnSave.ClientID %>").className = "btn btn-primary";
                        return;
                    }
                    else {
    ...
    <script type="text/javascript">
        function showSuccessMessage() {
            alert('Assign soft code successfully!');
            window.location.href = 'ProductDetailsAssignCode.aspx#menu2';
   ...
   <script type="text/javascript">
    ...
    <style>
        .dashboard-top-cards h5 {
            margin-bottom: 0px;
        }

        .dashboard-top-cards ul li img {
            height: 2rem;
        }

        .dashboard-top-cards ul li p {
            margin-bottom: 0;
            font-weight: 500;
            line-height: 1.5;
        }

        .dashboard-top-cards ul {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        ...
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Generate codes
                            </h4>
                        </header>
                        ...
                        <div class="card-body card-body-nopadding">
                            ...
                            <div class="dashboard-top-cards">
                                <div
                                    class="row row-cols-xxl-5 row-cols-xl-5 row-cols-lg-5 row-cols-md-2 row-cols-1 g-4">

                                    <div class="col mb-3 d-flex">
                                        <ul class="dashboard-card-data">
                                            <li>
                                                <p id="ptotalcode" runat="server">
                                                    Total Generated Codes
                                                </p>
                                                <h5 style="color: #dc024d;">
                                    ...
                                    <div class="col mb-3 d-flex" runat="server" id="divavlaiblecode" visible="false">
                                        <ul class="dashboard-card-data">
                                            <li>
                                                <p id="pavlaiblecode" runat="server">
                                                    Available Codes
                                                </p>
                                                <h5 style="color: #ff9903;">
                                                    <asp:Label ID="LabelAvailableCode" runat="server"></asp:Label>
                                                </h5>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col mb-3 d-flex">
                                        <ul class="dashboard-card-data">
                                            <li>
                                                ...
                                                <h5 style="color: #e92425;">
                                                    <asp:Label ID="LabelScrabCode" runat="server"></asp:Label>
                                                </h5>
                                            </li>
                                            <li>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-3" style="display: none">
                                    <span class="req">*</span><label>Assign From Product Name</label>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                        InitialValue="--Select--" ForeColor="Red" ValidationGroup="PRO"
                                        ControlToValidate="ddlProduct" ErrorMessage="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group col-lg-3" style="display: none">
                                    <span class="req">*</span>
                                    <label>No. Of Available Codes</label>
                                    <asp:TextBox ID="LblAvlCodes" MaxLength="20" Enabled="false" ForeColor="Red"
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorNew3" runat="server"
                                        ForeColor="Red" ErrorMessage="*" ValidationGroup="PRO"
                                        ControlToValidate="LblAvlCodes"></asp:RequiredFieldValidator>

                                </div>

                                <div class="form-group col-lg-3">
                                    <span class="req">*</span><label>Select Product</label>
                                    <asp:DropDownList ID="ddlProduct2" runat="server"
                                        CssClass="form-control form-control-sm">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                        InitialValue="--Select--" ForeColor="Red" ValidationGroup="PRO" ToolTip="Please Select Product"
                                        ControlToValidate="ddlProduct2" ErrorMessage="Please Select Product">
                                    </asp:RequiredFieldValidator>
                                </div>

                                <div class="form-group col-lg-3">
                                    <span class="req">*</span>
                                    <label>Assign Codes</label>
                                    <asp:TextBox ID="LblAssignCodes" MaxLength="10"
                                        CssClass="form-control form-control-sm"  runat="server"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                                        ForeColor="Red" ErrorMessage="Please enter no of code"
                                        ControlToValidate="LblAssignCodes"></asp:RequiredFieldValidator>

                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                        ControlToValidate="LblAssignCodes"
                                        ErrorMessage="Please enter only numeric values."
                                        ForeColor="Red"
                                        ValidationExpression="^\d+$"
                                        ValidationGroup="PRO"></asp:RegularExpressionValidator>


                                </div>

                                <div class="form-group col-lg-3" id="divbatch" runat="server" visible="false">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                        ForeColor="Red" Enabled="false" ValidationGroup="PRO"
                                        ControlToValidate="txtBatchNo" ErrorMessage="*">
                                    </asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group col-lg-3" id="divmrp" runat="server" visible="false">
                                    <span class="req">*</span>
                                    <label>MRP</label>
                                    <asp:TextBox ID="txtMRP" CssClass="form-control form-control-sm"
                                        runat="server" MaxLength="7"
                                        OnKeyPress="return isNumberKey(this, event);"
                                        onchange="mathRoundForTaxes(this.id);"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                        ForeColor="Red" ErrorMessage="*" Enabled="false" ValidationGroup="PRO"
                                        ControlToValidate="txtMRP"></asp:RequiredFieldValidator>

                                </div>
                                <div class="form-group col-lg-3" id="divmanpdate" runat="server">
                                    <span class="req">*</span><label>Mfd_Date</label>
                                    <asp:TextBox ID="txtMfd_Date" MaxLength="50"
                                        CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                        ForeColor="Red" ErrorMessage="*" Enabled="false" ValidationGroup="PRO"
                                        ControlToValidate="txtMfd_Date"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group col-lg-3" id="divexpdate" runat="server">
                                    <span class="req"></span>
                                    <label>Exp_Date</label>
                                    <asp:TextBox ID="txtExp_Date" MaxLength="50"
                                        onchange="checkproduct(this.value);"
                                        CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                    <asp:CompareValidator ID="CompareValidator2" runat="server"
                                        ValidationGroup="PRO" ControlToCompare="txtMfd_Date"
                                        ControlToValidate="txtExp_Date" ForeColor="Red" Type="Date"
                                        Operator="GreaterThan"
                                        ErrorMessage="Exp Date is greater than Mfd Date.">
                                    </asp:CompareValidator>

                                </div>
                                <div class="form-group col-lg-6" style="display: none;"></div>
                                <div class="form-group col-lg-6" style="display: none;">
                                    <span class="req">*</span><label>Your Batch Size</label>
                                    [<asp:Label ID="lblbatchsize" runat="server" ForeColor="Red"
                                        Font-Size="11px" Font-Bold="true"></asp:Label>]

                                </div>
                                <div class="form-group col-lg-6 text-end mt-4">
                                    <asp:Label ID="lblproid" runat="server" Visible="false"></asp:Label>
                                    <asp:Label ID="lblnoofcodes" runat="server" Visible="false"></asp:Label>
                                    <asp:Button ID="btnSave" OnClick="btnSave_Click" ValidationGroup="PRO"
                                        class="btn btn-primary" runat="server" Text="Save" />
                                    <asp:Button ID="btnReset" OnClick="btnReset_Click"
                                        class="btn btn-primary" runat="server" Text="Cancel" />
                                </div>
                            ...
                            <div class="form-row" style="display: none;">
                                <div class="form-group col-lg-3">
                                    ...
                                    <asp:TextBox runat="server" onkeypress="return isNumberKey(this, event);"
                                        MaxLength="2" ID="txtWarr" CssClass="form-control form-control-sm" />
                                </div>
                            </div>
                            <div class="form-row" style="display: none;">
                                <div class="form-group col-lg-6">
                                    ...
                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                                                ForeColor="Red" ValidationGroup="PRO" ControlToValidate="txtNoOfCodes">
                                                </asp:RequiredFieldValidator>--%>
                                    <strong><span class="astrics">*</span> No. Of Codes :</strong>
                                    <asp:HiddenField ID="hdneditrowid" runat="server" />

                                    <asp:TextBox ID="txtNoOfCodes" MaxLength="6" Width="91%"
                                        onchange="CheckAvilableCodes(this.value);" CssClass="textbox_pop"
                                        runat="server" ReadOnly="true"></asp:TextBox>

                                    <asp:CompareValidator ID="CompareValidator1" runat="server"
                                        ValidationGroup="PRO" ForeColor="Red" ControlToCompare="txtMfd_Date"
                                        ControlToValidate="txtExp_Date" Operator="GreaterThanEqual"
                                        Type="Date" Text="Exp date must be Greater..">
                                    </asp:CompareValidator>

                                    <asp:CheckBox ID="chkComments" runat="server" AutoPostBack="true"
                                        Text="  Use Old" OnCheckedChanged="chkComments_CheckedChanged" />
                                    <strong><span class="astrics">&nbsp;</span> Comment :</strong>

                                    <asp:TextBox ID="txtComment" MaxLength="100" TextMode="MultiLine"
                                        Width="95%" Height="30px" CssClass="textbox_pop"
                        ...
                        <div style="display: none;">
                            <asp:GridView ID="GrdProductPrintLablelDet" runat="server"
                                ...
                                <Columns>
                                    <%--<asp:TemplateField HeaderText="Product Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLablProNm" runat="server"
                                    ...
                                    <asp:TemplateField HeaderText="Series Initial">
                                        <ItemTemplate>
                                            <asp:Label ID="lvlpronm" runat="server"
                                                Text='<%# Bind("Pro_ID") %>'></asp:Label><b>-</b>
                                            <asp:Label ID="lblLabelNm" runat="server"
                                                Text='<%# Bind("Series_Initial") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="20%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Series From">
                                        <ItemTemplate>
                                            <asp:Label ID="lblseriesfrom" runat="server"
                                                Text='<%# Bind("Series_From") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" Width="20%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Series To">
                                        <ItemTemplate>
                                            <asp:Label ID="lblseriesto" runat="server"
                                                Text='<%# Bind("Series_To") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />
                                    ...
                                    <asp:TemplateField HeaderText="Qty.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCountQty" runat="server"
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="Imgeditprodetails" runat="server"
                                            ...
                                            <table width="98%" cellpadding="0" cellspacing="2">
                                                ...
                                                <tr>
                                                    <td align="right">
                                                        ...
                                                        <strong><span id="mfd" runat="server" class="astrics">*</span>
                                                            :</strong>
                                                    </td>
                                                    <td></td>
                                                    <td align="right">
                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                                                            runat="server" ForeColor="Red" ValidationGroup="PRO"
                                                ...
                                                <tr>
                                                    <td align="right">
                                                        <strong><span id="Span1" runat="server" class="astrics">*</span>
                                                            Your Batch Size :</strong>
                                                    </td>
                                                    <td colspan="3">&nbsp;
                                                    </td>
                                                </tr>
                                            ...
                                            <table width="98%" cellpadding="0" cellspacing="2">
                                                ...
                                                <tr>
                                                    <td colspan="2" align="left">
                                                        <asp:CheckBox ID="chkHindi" Enabled="false" runat="server"
                                                            AutoPostBack="true" Text="  Use Old"
                                                            OnCheckedChanged="chkHindi_CheckedChanged" />
                                                    </td>
                                                    <td colspan="2" align="left">
                                                        <asp:CheckBox ID="chkEnglish" Enabled="false" Text="   Use Old"
                                                            runat="server" OnCheckedChanged="chkHindi_CheckedChanged"
                                                            AutoPostBack="true" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" style="width: 8%">
                                                        <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator522"
                                                            runat="server" ForeColor="Red" ValidationGroup="PRO"
                                                    ...
                                                    <td style="width: 40%">
                                                        <asp:FileUpload ID="flSound" Enabled="false"
                                                            onchange="fileTypeCheckeng(this.value);" runat="server"
                                                            Style="width: 88%;" />
                                                        <a id="SFileE" runat="server" target="_blank"
                                                            title="Hindi File play" style="cursor: pointer;">
                                                            <img alt="" src="Content/images/play.png" /></a>
                                                    </td>
                                                    <td align="right" style="width: 10%">
                                                        <%-- <asp:RequiredFieldValidator
                                                            ID="RequiredFieldValidator6English" runat="server"
                                                    ...
                                                    <td>
                                                        ...
                                                        <a id="SFileH" runat="server" target="_blank"
                                                            title="English File play" style="cursor: pointer;">
                                                            <img alt="" src="Content/images/play.png" /></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <td>
                                        <fieldset id="Fieldset1" runat="server" class="Newfield Newfield_width2"
                                            ...
                                            <table width="100%" style="text-align: center;">
                                                <tr style="background-color: #E6E6E6;">
                                                    <td align="center" style="width: 35%;">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6"
                                                            runat="server" ForeColor="Red" ValidationGroup="APL"
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtSeries_Initial1" Width="50px" runat="server"
                                                            CssClass="textbox_pop" ReadOnly="true"
                                                            onchange="ChkInitial(this.value,this.id);" MaxLength="10"
                                                            Text=""></asp:TextBox><b>-</b>
                                                        <asp:TextBox ID="txtSeries_Initial" Width="50px" runat="server"
                                                            CssClass="textbox_pop"
                                                            onchange="InitialSeries(this.value,this.id);" MaxLength="4"
                                                            OnKeyPress="return isNumberKey(this, event);" Text="">
                                                        </asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtSeriesFrom" Width="50px" runat="server"
                                                            CssClass="textbox_pop"
                                                            onchange="FormatVal(this.value,this.id);" MaxLength="4"
                                                            OnKeyPress="return isNumberKey(this, event);" Text="">
                                                        </asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtSeriesTo" Width="50px" runat="server"
                                                            CssClass="textbox_pop" MaxLength="4"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="LblCountQty" CssClass="textbox_pop"
                                                            runat="server" Width="100px" Text="" Enabled="false"
                                                            Style="text-align: center;"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:ImageButton ID="btnAddPro"
                                                            ImageUrl="~/Content/images/add_new.png" runat="server"
                                                            ValidationGroup="APL" OnClick="btnAddPro_Click" />&nbsp;
                                                        <asp:ImageButton ID="btnResetPro"
                                                            ImageUrl="~/Content/images/reset.png" runat="server"
                                                            CausesValidation="false" OnClick="btnResetPro_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" align="center">
                                                        <asp:Label ID="lblProDetailsMsg" runat="server" Text=""
                                                            ForeColor="Red"></asp:Label>
                                                        <asp:Label ID="lblUpFlTblId" runat="server" Text=""
                                                            Visible="false"></asp:Label>
                                                        <asp:Label ID="lblC" runat="server" Text="" Visible="false">
                                                        </asp:Label>
                                ...
                                <tr style="display: none;">
                                    <td colspan="2">
                                        <asp:Label ID="lblnoteSound"
                                            Style="font-family: Arial; font-size: 12px; color: red;" runat="server"
                                            Text="Note:- Audio file to be uploaded on the website should be in the prescribed format as below">
                                        </asp:Label>
                                        <br />
                                        <asp:Label ID="lblfiletype"
                                            Style="font-family: Arial; font-size: 12px; color: red;" runat="server"
                                            Text="File Type ---- .wav"></asp:Label>
                                        <br />
                                        <asp:Label ID="lblfileformat"
                                            Style="font-family: Arial; font-size: 12px; color: red;" runat="server"
                                            Text="Format ---- 8KHz, 16bit mono"></asp:Label>
                                        <br />
                                        <asp:Label ID="lblBitRate"
                                            Style="font-family: Arial; font-size: 12px; color: red;" runat="server"
                                            Text="Bit Rate ---- 128 kbps"></asp:Label>
                                        <br />
                                        <asp:Label ID="lblrecord"
                                            Style="font-family: Arial; font-size: 12px; color: Blue;" runat="server"
                                            Text="For record the audio file, Please click the link "></asp:Label>&nbsp;
    ...
    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtendertxtnoofCodes" runat="server" FilterMode="ValidChars"
        ValidChars="1234567890" TargetControlID="txtNoOfCodes">
    </cc1:FilteredTextBoxExtender>
    ...
    <%-- <cc1:MaskedEditExtender ID="MaskedEditExtendttoder2" runat="server"
                            TargetControlID="txtDateTo" MaskType="Date" Mask="99/99/9999">
                            </cc1:MaskedEditExtender>--%>
    <!--PopUp Close-->
                ...
                <div class="service_head_p">
                    <p>
                        <span class="left">
                            ...
                            class="astrics"><strong></strong></span></span>
                    </p>
                </div>
