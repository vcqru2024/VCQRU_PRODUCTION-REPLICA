<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="BannerVcqru.aspx.cs" Inherits="Manufacturer_BannerVcqru" %>
               ...
               <div class="col-lg-12">
                <div class="card card-admin form-wizard profile box_card">
                    ...
                    <div  class="card-body card-body-nopadding"> <div id="newmsg" runat="server"> <p><br />
                        <a href="UploadBannersVcqru.aspx" class="btn btn-primary">Add Banner</a></p>
                    </div>
                    <h6> Banner Info</h6>
                        <div class="col-lg-12">
                         <div class="row">
