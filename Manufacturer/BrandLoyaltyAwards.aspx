<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true"
    Title="Awards Master" CodeFile="BrandLoyaltyAwards.aspx.cs" Inherits="BrandLoyaltyAwards" %>
         ...
         <div class="container-fluid xyz">
            ...
            <asp:UpdateProgress ID="UpdateProgress1"  runat="server"
                ...
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Awards Master</h4>
                    ...
                    <div class="card-body card-body-nopadding">
                        ...
                        <div class="card-admin form-wizard medias">
                                        ...
                                        <asp:ListItem Value="1001">All Rows</asp:ListItem>
                                            ...
                                            <asp:GridView ID="GrdAwards" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered"
