<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="CashDetails.aspx.cs" Inherits="Admin_Default" %>

<%@ Register Src="~/UserControl/UC_CashDetailsVendor.ascx" TagPrefix="uc1" TagName="UC_CashDetailsVendor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:UC_CashDetailsVendor runat="server" ID="UC_CashDetailsVendor" />
