...
public partial class Manufacturer_CashWalletReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["CompanyId"] == null)
            Response.Redirect("index.html?Page=CashwalletHistory.aspx");
        else
        {
    ...
    private void FillGrdLoyaltyAwards(string email)
    {
        ...
        DataSet ds = Warranty.CashWalletReport(email);
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        try
        {
            DataSet ds = Warranty.GetClaimDetailVendorWallet_downloadMidas(Session["CompanyId"].ToString());
