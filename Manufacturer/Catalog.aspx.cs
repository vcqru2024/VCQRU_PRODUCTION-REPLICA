...
public partial class Manufacturer_Catalog : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from Tbl_Catalog where compid='" + Session["CompanyId"].ToString() + "' order by ID desc", con);
    ...
    protected void rewards_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
            ...
            SqlCommand cmd_display = new SqlCommand("select * from Tbl_Catalog where ID='" + delserid + "' order by ID desc", con);
            ...
            con.Close();
            con.Open();
            SqlCommand cmd = new SqlCommand("DELETE FROM Tbl_Catalog WHERE ID='" + delserid + "'", con);
            cmd.ExecuteNonQuery();
