...
public partial class Manufacturer_CodeWisePayoutReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
           ...
           // string fromdate = System.DateTime.Now.ToString("yyyy-MM-dd") + " 00:00:00.000";
            ...
            Bindgrid(fromdate, todate, MobileNo, stt, upiid);
        }
    }
    ...
    public void Bindgrid(string datefrom, string dateto, string MobileNo, string stt, string upiid)
    {
        try
        {
            SqlConnection con = new SqlConnection(SQL_DB.ConnectionString);
            con.Open();
            SqlCommand cmd = new SqlCommand("USP_GetCodeWisePayout", con);
    ...
    protected void btn_download_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                wb.Worksheets.Add(dt, "MobileWiseCodeCheckReport");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=MobileWiseCodeCheckReport.xlsx");
