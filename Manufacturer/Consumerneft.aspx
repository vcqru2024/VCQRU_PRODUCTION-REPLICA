<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="Consumerneft.aspx.cs" Inherits="Manufacturer_Consumerneft" %>
                                                ...
                                                <asp:Repeater runat="server" ID="rptData">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td><%# Eval("Account Number") %></td>
                                                            <td><%# Eval("Bank Name") %></td>
                                                            <td><%# Eval("IFSC Code") %></td>
                                                            <td><%# Eval("Amount Earned") %></td>
                                                            <td><%# Eval("Redeem Amount") %></td>
