<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" Title="Courier Master"
    CodeFile="FrmAwardsCourierMaster.aspx.cs" Inherits="FrmAwardsCourierMaster" %>
         ...
         <div class="container-fluid xyz">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Courier Master<asp:HiddenField ID="hdncmphdn" runat="server" /></h4>
                            </header>
                ...
                <div class="card-body card-body-nopadding">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                           <%-- <label>Dealer Name</label>--%>
                            <asp:TextBox ID="txtSearchName" runat="server" CssClass="form-control form-control-sm" placeholder="Courier Name"></asp:TextBox>
                            
                        </div>
                        <div class="form-group col-lg-6">
                          <asp:ImageButton ID="BtnSearchCourier" runat="server" CssClass="btn btn-primary" ImageUrl="~/Content/images/search_rec.png"
                                    OnClick="BtnSearchCourier_Click" ToolTip="Search" />
                                <asp:ImageButton ID="BtnSearchCourierRefesh" runat="server" CssClass="btn btn-success refreses_field" ImageUrl="~/Content/images/reset.png"
                                    OnClick="BtnSearchCourierRefesh_Click" ToolTip="Refresh" />
                        </div>
                    </div>
                      <div class="form-row" style="float: right;">
                           <div class="form-group col-lg-12">
                                   <asp:Button ID="imgNew" ToolTip="Add Courier" OnClick="imgNew_Click1"
                                            CausesValidation="false" runat="server" Text="Add Courier" class="btn btn-primary float-right mb-0" />
                           </div>
                      </div>
                    ...
                    <asp:GridView ID="GrdCourier" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered" DataKeyNames="Flag"
                        EmptyDataText="Record Not Found"  BorderColor="transparent" OnRowCommand="GrdCourier_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImgbtnEditCourier" runat="server" ImageUrl="~/Content/images/edit.png"
                                        CommandName="CourierEdit" CommandArgument='<%# Bind("CourierPkid") %>' ToolTip="Edit Courier"
                                    ...
                                    <asp:ImageButton ID="ImgbtnDeleteCourier" runat="server" ImageUrl="~/Content/images/delete.png"
                                        CommandName="CourierDelete" CommandArgument='<%# Bind("CourierPkid") %>' ToolTip="Delete Courier"
