...
public partial class FrmCouponRequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["User_Type"] == null)
            Response.Redirect("../Info/Login.aspx?Page=FrmCouponRequest.aspx");
        else
        {
    ...
    protected void GrdVw_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("AddCoupons.aspx?id=" + e.CommandArgument.ToString());
        ...
        else if (e.CommandName.ToString() == "ActivateRow")
        {
            ...
            //LabelAlertheader.Text = "Alert";
            //LabelAlertText.Text = "Are you sure to <span style='color:blue;' > " + FindStatus(Reg.IsActive) + " </span> <span style='color:blue;' >" + Reg.CouponName + "</span>  Coupon Request permanently?";
            //ModalPopupExtenderAlert.Show();
            Reg.DML = "A";
            if (Reg.IsActive == 0)
            {
