...
public partial class FrmGiftMaster : System.Web.UI.Page
{
    public int Flag = 0, index = 0, sno = 1;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["User_Type"] == null)
            Response.Redirect("../Info/Login.aspx?Page=FrmGiftMaster.aspx");
        else
        {
    ...
    protected void GrdVw_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("AddGift.aspx?id=" + e.CommandArgument.ToString());  
