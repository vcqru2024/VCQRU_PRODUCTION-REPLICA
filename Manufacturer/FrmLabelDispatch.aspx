<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true"
    Title="Label Receive" CodeFile="FrmLabelDispatch.aspx.cs" Inherits="FrmLabelDispatch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function CheckScrap(lblCourierIdValue) {
            ...
            // alert($('#=LabelCalText.ClientID%>').val());//
        ...
        function Checkdelete() {
         ...
         //   $('#<%=MyRadio.ClientID%>').css("display","block");
            $('#smallModal123').modal(); return false;
        }
    </script>
         ...
         <div class="container-fluid xyz">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Label Receive</h4>
                            </header>
                ...
                <p>
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                           <%-- <label>Dealer Name</label>--%>
                             <asp:TextBox ID="txtProName" runat="server" CssClass="form-control form-control-sm" placeholder="Courier Name"></asp:TextBox>
                        </div>
                        <div class="form-group col-lg-6">
                          <asp:ImageButton ID="BtnSearch" runat="server" CssClass="btn btn-primary" ImageUrl="~/Content/images/search_rec.png"
                                    ...
                                    <asp:ImageButton ID="BtnRefesh" runat="server" CssClass="btn btn-success refreses_field" ImageUrl="~/Content/images/reset.png" OnClick="BtnRefesh_Click"
                                        ToolTip="Refresh" />
                        </div>
                    </div>
                 ...
                 <asp:GridView ID="GrdCourierDispatch" runat="server" AutoGenerateColumns="False"
                        DataKeyNames="Flag" CssClass="table table-striped table-bordered Frm_Scrap" EmptyDataText="Record Not Found" 
