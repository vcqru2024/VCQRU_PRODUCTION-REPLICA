<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true"
    Title="Production Unit Master" CodeFile="FrmProductionUnit.aspx.cs" Inherits="FrmProductionUnit" %>
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
            ...
            <div class="col-lg-12 card card-admin form-wizard profile">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o">Production Unit Master<asp:HiddenField ID="hdncmphdn" runat="server" /></i></h4>
                            </header>
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                           <%-- <label>Dealer Name</label>--%>
                             <asp:TextBox ID="txtSearchName" runat="server" CssClass="form-control form-control-sm" placeholder="Name"></asp:TextBox>
                      ...
                      <div class="form-row" style="float: right;">
                           <div class="form-group col-lg-12">
                                   <asp:Button ID="imgNew" ToolTip="Add Production Unit" OnClick="imgNew_Click1"
            ...
            <asp:GridView ID="GrdCustomer" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("ProductionUnitID") %>'
                                    CommandName="EditCustomer" ToolTip="Edit Plan" />&nbsp;
                               
                                <asp:ImageButton ID="ImgbtnDel" runat="server" ImageUrl="~/Content/images/delete.png"
                                        CommandName="DeleteRow" CommandArgument='<%# Bind("ProductionUnitID") %>' ToolTip="Delete"
