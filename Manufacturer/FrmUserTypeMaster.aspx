<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" Title="UserType Master"
    CodeFile="FrmUserTypeMaster.aspx.cs" Inherits="FrmUserTypeMaster" %>
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
            ...
            <div class="col-lg-12 card card-admin form-wizard profile">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o">UserType Master</i></h4>
                            </header>
           ...
           <div class="card-body card-body-nopadding">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                           <%-- <label>Dealer Name</label>--%>
                             <asp:TextBox ID="txtSearchName" runat="server" CssClass="form-control form-control-sm" placeholder="UserType"></asp:TextBox>
                  ...
                  <div class="col-lg-12 card card-admin form-wizard medias">
                     <div class="row pb-2 pt-2 background-section-form">
                      ...
                      <asp:GridView ID="GrdVw" runat="server" AutoGenerateColumns="False" CssClass="table table-striped" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Type">
                                <ItemTemplate>
                                    <asp:Label ID="lblCourierName" runat="server" Text='<%# Bind("Type") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImgbtnEditCourier" runat="server" ImageUrl="~/Content/images/edit.png"
                                        CommandName="EditRow" CommandArgument='<%# Bind("TTUserTypeid") %>' ToolTip="Edit"
                                        CausesValidation="false" />&nbsp;
                                    
                                        <asp:ImageButton ID="ImgbtnDel" runat="server" ImageUrl="~/Content/images/delete.png"
                                        CommandName="DeleteRow" CommandArgument='<%# Bind("TTUserTypeid") %>' ToolTip="Delete"
