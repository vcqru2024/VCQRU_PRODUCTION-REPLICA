<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true"
    Title="Warehouse" CodeFile="FrmWarehouse.aspx.cs" Inherits="FrmWarehouse" %>
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
            ...
            <div class="col-lg-12 card card-admin form-wizard profile">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o">Warehouse Master<asp:HiddenField ID="hdncmphdn" runat="server" /></i></h4>
                            </header>
            ...
            <asp:GridView ID="GrdCustomer" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("ChannelsID") %>'
                                    CommandName="EditCustomer" ToolTip="Edit Plan" />&nbsp;
                               
                                <asp:ImageButton ID="ImgbtnDel" runat="server" ImageUrl="~/Content/images/delete.png"
                                        CommandName="DeleteRow" CommandArgument='<%# Bind("ChannelsID") %>' ToolTip="Delete"
