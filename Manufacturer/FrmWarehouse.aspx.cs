...
public partial class FrmWarehouse : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["edit"] != null)
            {
               ...
               // @"setTimeout(function(){document.getElementById('" + NewMsgpop.ClientID + "').style.display='none';},5000);";
    ...
    private void FillGrdVwDealerMaster(string productionOrWarehouse)
    {
        ...
        }
        {
           ...
           // if (productionOrWarehouse == "production")
                dt = SQL_DB.ExecuteDataTable("select * from Channels where compid='" + ProjectSession.strCompanyid + "'" + strVal);
    ...
    protected void GrdCustomer_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("AddWarehouse.aspx?id=" + e.CommandArgument.ToString());
        ...
        else if (e.CommandName.ToString() == "DeleteRow")
        {
            try
            {
                SQL_DB.ExecuteNonQuery("Delete from Channels where Channelsid = " + lbleditlabelid.Text);
    ...
    {
        FillGrdVwDealerMaster("channels");
        newMsg.Visible = false;
    }
