...
public partial class Manufacturer_GetConsumersWallet_cashTransfer : System.Web.UI.Page
{
    ...
    public void Bindgrid(string datefrom, string dateto, string MobileNo)
    {
        try
        {
            ...
            DataTable dt = SQL_DB.ExecuteDataTable("exec USP_GetConsumersWallet_Basex '" + Session["CompanyId"].ToString() + "', '"+ datefrom + "', '" + dateto + "', '" + MobileNo + "'");
    ...
    protected void btn_download_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                wb.Worksheets.Add(dt, "ConsumersWalletCashTransfer");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=ConsumersWalletCashTransfer.xlsx");
