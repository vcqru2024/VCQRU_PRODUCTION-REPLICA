<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="GiftDetails.aspx.cs" Inherits="Admin_GiftDetails" %>

<%@ Register Src="~/UserControl/UC_AwardDetailsVendor.ascx" TagPrefix="uc1" TagName="UC_AwardDetailsVendor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:UC_AwardDetailsVendor runat="server" ID="UC_AwardDetailsVendor" />
