...
public partial class Manufacturer_Multipletimecodescan : System.Web.UI.Page
{
    ...
    public void Bindgrid(string datefrom, string dateto)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("USP_GetMultipletimecodescan_HPL", con);
    ...
    protected void btn_download_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                wb.Worksheets.Add(dt, "MultiTimeCodeCheckRepoer");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=MultiTimeCodeCheckRepoer.xlsx");
