<%@Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="MyProfile.aspx.cs" Inherits="Manufacturer_MyProfile" %>
            ...
            <div class="card-body card-body-nopadding">
                ...
                <div class="form-row">
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <br />
                           <asp:Label ID="Label1" Text="250 charecters." ForeColor="Red" Font-Size="10px" runat="server"></asp:Label>
                      </div>
                     <div class="form-group col-lg-6">
             ...
             <%--   <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-3">
                        <asp:Button ID="btnUpDate" OnClick="btnUpDate_Click" ValidationGroup="chk94" class="btn btn-primary float-right mb-0"
                            runat="server" Text="Update" />
                    </div>
                    <div class="form-group col-lg-3">
                        <asp:Button ID="btnNextDoc" OnClick="btnNextDoc_Click" class="btn btn-primary float-left mb-0"
