<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" EnableEventValidation="true"
    Title="Product Details" AutoEventWireup="true" CodeFile="ProductDetails.aspx.cs"
               ...
               <div class="col-lg-12">
                        <div class="card card-admin form-wizard profile box_card">
                            <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Product Details</h4>
                            </header>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-12">
                                        <asp:Button ID="imgNew" ToolTip="Add New Product" OnClick="imgNew_Click1"
                                            CausesValidation="false" runat="server" Text="Add Product Details" class="btn btn-primary mb-0" />
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <%--<asp:TextBox ID="TextBox1"  class= placeholder="Product Name" runat="server" Text=""
                                ></asp:TextBox>
                            <asp:TextBox ID="TextBox2" runat="server" Text="" CssClass="reg_txt" Visible="false"></asp:TextBox>
                            <asp:TextBox ID="TextBox3" runat="server" Text="" CssClass="reg_txt" Visible="false"></asp:TextBox>--%>
                                    </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Exp_Date">
                                         ...
                                         <asp:TemplateField HeaderText="Is Warranty" Visible="false">
                                            <ItemTemplate>
                                                <%--<asp:Label ID="lblactudate23411" runat="server" Text='<%# Bind("IsWarranty") %>'></asp:Label>--%>
                                            <%--    <asp:RadioButton Text="Yes" GroupName="yy" runat="server" id="warY"/>
                                                <asp:RadioButton Text="No" GroupName="yy" runat="server" id="warN"/>   --%>                                             
                                            </ItemTemplate>
                                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                        </asp:TemplateField>
