<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="ProductDetailsAssignCode.aspx.cs" Inherits="Manufacturer_ProductDetailsAssignCode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckAvilableCodes(vl) {
            var val = document.getElementById('<%=LblAvlCodes.ClientID %>').value;
            if (vl == "0") {
                document.getElementById("<%=Div1.ClientID %>").style.display = "block";
                document.getElementById("<%=Div1.ClientID %>").className = "";
                document.getElementById("<%=Label4.ClientID %>").innerHTML = "Please Enter Valid Value!";
                document.getElementById("<%=btnSave.ClientID %>").className = "button_all_Sec";
                return;
            }
            if (parseInt(vl) > parseInt(val)) {
                document.getElementById("<%=Div1.ClientID %>").style.display = "block";
                document.getElementById("<%=Div1.ClientID %>").className = "alert_boxes_pink big_msg";
                document.getElementById("<%=Label4.ClientID %>").innerHTML = "No. of codes must not exceed the available codes !";
                document.getElementById("<%=btnSave.ClientID %>").disabled = true;
                document.getElementById("<%=btnSave.ClientID %>").className = "button_all_Sec";
        ...
        function WriteProID(val) {
            document.getElementById('<%=HDF.ClientID %>').value = '-' + val;
            PageMethods.WriteProIDHelloCheck(val, WriteProIDHello)
        }
        function WriteProIDHello(Result) {
            var Arr = Result.toString().split('-');
            document.getElementById('<%=LblAvlCodes.ClientID %>').value = Arr[0];
            document.getElementById('<%=HdnAvlCodes.ClientID %>').value = Arr[0];
            document.getElementById('<%=txtSeries_Initial1.ClientID %>').value = Arr[1];
            document.getElementById('<%=HdnSeriesIni.ClientID %>').value = Arr[1];
            document.getElementById('<%=lblbatchsize.ClientID %>').innerHTML = Arr[2];
            document.getElementById('<%=HdnBatchSize.ClientID %>').value = Arr[2];
        }
        function InitialSeries(val, id) {
            if (val.length == 1)
        ...
        function ToatVal(val, id) {
            var val1 = document.getElementById("<%=txtSeriesFrom.ClientID %>").value;
            var val2 = document.getElementById("<%=lblbatchsize.ClientID %>").innerHTML;
            var val3 = "";
            if (parseFloat(val) >= parseFloat(val1)) {
                if (val1 != '') {
                    if (parseFloat(val1) == 0)
                        val3 = parseFloat(parseFloat(val) + 1);
                    else
                        val3 = parseFloat(parseFloat(parseFloat(val) - parseFloat(val1)) + 1);
                    if (val.length == 1)
                        document.getElementById(id).value = "000" + val;
                    else if (val.length == 2)
                        document.getElementById(id).value = "00" + val;
                ...
                //if (parseFloat(val3) > parseFloat(val2)) {
                //document.getElementById("<%=Div1.ClientID %>").style.display = "block";
                //document.getElementById("<%=Div1.ClientID %>").className = "alert_boxes_pink big_msg";
                //document.getElementById("<%=Label4.ClientID %>").innerHTML = "No. of codes must not exceed the Your Batch Size !";
                //document.getElementById("<%=btnSave.ClientID %>").disabled = true;
                //document.getElementById("<%=btnSave.ClientID %>").className = "button_all_Sec";
                //}
                //else {
                ...
                document.getElementById("<%=btnSave.ClientID %>").className = "button_all";
                //}
                document.getElementById("<%=LblCountQty.ClientID %>").value = val3;
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
         ...
         <div class="container-fluid xyz">
               ...
               <div class="col-lg-12">
                        <div class="card card-admin form-wizard profile box_card">
                          <%--  <header class="card-header">--%>
                                ...
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Generate codes</h4>
                            </header>
                            ...
                            <div class="card-body card-body-nopadding">
                                <div class="form-row">
                                    <div class="form-group col-lg-12">
                                        <asp:Button ID="imgNew" ToolTip="Add New Product" OnClick="imgNew_Click1"
                                            CausesValidation="false" runat="server" Text="Generate codes" class="btn btn-primary mb-0" />
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-lg-4">
                                        <asp:TextBox ID="txtProductName" runat="server" Text="" CssClass="form-control form-control-sm" placeholder="Product Name"></asp:TextBox>
                                       
                                    </div>
                                    <div class="form-group col-lg-3" runat="server" visible="false">
                                        <asp:TextBox ID="txtDateFrom" runat="server" CssClass="form-control form-control-sm"
                                            placeholder="Mfd Date From"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-lg-3" runat="server" visible="false">
                                        <asp:TextBox ID="txtDateTo" runat="server" CssClass="form-control form-control-sm" placeholder="Mfd Date To"></asp:TextBox></div>
                                    <div class="form-group col-lg-2">
                                        <asp:ImageButton ID="ImgSearch" runat="server" class="btn btn-primary search_field" ImageUrl="~/Content/images/search_rec.png"
                                            ToolTip="Search" OnClick="ImgSearch_Click" />
                                        <asp:ImageButton ID="ImgRefresh" runat="server" class="btn btn-success refreses_field" ImageUrl="~/Content/images/reset.png" ToolTip="Refresh"
                                ...
                                <div class="row pb-2 pt-2 background-section-form">
                                    ...
                                    <div class="col-lg-2">
                                        <asp:DropDownList ID="ddlRowProductCnt" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlRowsShow_SelectedIndexChanged">
                                ...
                                <asp:GridView ID="GrdProductMaster" runat="server" AutoGenerateColumns="False" CssClass="ProductDetailsAssignCode table table-striped table-bordered"
                                    EmptyDataText="Record Not Found"
                                    BorderColor="transparent" 
                                    OnRowCommand="GrdProductMaster_RowCommand" OnPageIndexChanging="GrdProductMaster_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Product Name">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate12" runat="server" Text='<%# Bind("Pro_Name") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Batch No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate123nEW" runat="server" Text='<%# Bind("Batch_No") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="No of Codes">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate1234" runat="server" Text='<%# Bind("NoofCodes") %>'></asp:Label>
                                            </ItemTemplate>
                                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="MRP">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate21" runat="server" Text='<%# Bind("MRP") %>'></asp:Label>
                                            </ItemTemplate>
                                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Mfd_Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate22" runat="server" Text='<%# Bind("Mfd_Date","{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Exp_Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate234" runat="server" Text='<%# Bind("Exp_Date","{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                        </asp:TemplateField>

                                         <asp:TemplateField HeaderText="Is Warranty" Visible="false">
                                            <ItemTemplate>                                            
                                            </ItemTemplate>
                                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Warranty Period (months)" Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Generated Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblpastede234" runat="server" Text='<%# Bind("Entry_Date","{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:TemplateField>
                                        <%--<asp:TemplateField HeaderText="Hindi">
                                            <ItemTemplate>
                                                <ul class="graphic">
                                                    <li><a href='<%# Eval("SoundPath_H") %>' class="sm2_link"></a></li>
                                                </ul>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="English" >
                                            <ItemTemplate>
                                                <ul class="graphic">
                                                    <li><a href='<%# Eval("SoundPath_E") %>' class="sm2_link"></a></li>
                                                </ul>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <%--Excel--%>
                                            <ItemTemplate>
                                                <%--<asp:ImageButton ID="btnChangeBatchInfo" runat="server" CausesValidation="false"
                                                    CommandArgument='<%#Bind("Row_ID") %>' CommandName="ChangeBatchInfo" ImageUrl="~/Content/images/edit.png"
                                                    ToolTip="Edit" />--%>
                                             <%--   <asp:ImageButton ID="imgdwnExcel" runat="server" CausesValidation="false" CommandArgument='<%#Bind("Row_ID") %>'
                                                    CommandName="DownLodExcel" ImageUrl="~/Content/images/download.png" ToolTip="Download Excel File" />--%>
                                                <asp:ImageButton ID="DownLodHplExcel" runat="server" CausesValidation="false" CommandArgument='<%#Bind("Row_ID") %>'
                                                    CommandName="DownLodHplExcel" ImageUrl="~/Content/images/download.png" ToolTip="Download Excel File" />
                                                 <asp:ImageButton ID="DownLodHplCSV" runat="server" CausesValidation="false" CommandArgument='<%#Bind("Row_ID") %>'
                                                    CommandName="DownLodHplCSV" ImageUrl="~/Content/images/download.png" ToolTip="Download CSV File" />
                                                 <asp:ImageButton ID="DownLodHplPDF" runat="server" CausesValidation="false" CommandArgument='<%#Bind("Row_ID") %>'
                                                    CommandName="DownLodHplPDF" ImageUrl="~/Content/images/download.png" ToolTip="Download PDF File" />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Action" Visible="false">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgBtnEdit" runat="server" CausesValidation="false" CommandArgument='<%#Bind("Row_ID") %>'
                                                    CommandName="EditRow" ImageUrl="~/Content/images/edit.png" ToolTip="Edit" />
                                                <%
                                                    if (Session["Comp_type"].ToString() == "L")
                                                    {
                                                %>
                                                <asp:ImageButton ID="imgBtnSecDelete" Visible="false" runat="server" CausesValidation="false"
                                                    CommandArgument='<%#Bind("Row_ID") %>' CommandName="DeleteRow" OnClientClick="return confirm('Are you sure?')"
            ...
            <div>
              ...
              <%--  <h4>
                                ...
                                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                                                ...
                                                <table width="98%" cellpadding="0" cellspacing="2">
                                                    <tr>
                                                        <td align="right">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="--Select--"
                                                                ForeColor="Red" ValidationGroup="PRO" ControlToValidate="ddlProduct"></asp:RequiredFieldValidator>
                                                            <strong><span class="astrics">*</span> Product Name :</strong>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlProduct" runat="server" CssClass="drp" Width="95%" Style="text-transform: capitalize;"
                                                                AutoPostBack="true" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged">
                                                                <%-- onchange="WriteProID(this.value)" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged" AutoPostBack="true"--%>
                                                            </asp:DropDownList>
                                                            <%--<cc1:ListSearchExtender ID="ListSearchExtendertrade1" PromptCssClass="drp" TargetControlID="ddlProduct"
                                                                runat="server" PromptPosition="Top">
                                                        ...
                                                        <td align="right">
                                                            ...
                                                            <strong><span class="astrics">*</span> No. Of Available Codes :</strong>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="LblAvlCodes" MaxLength="50" Width="91%" Enabled="false" ForeColor="Red"
                                                                CssClass="textbox_pop" Height="17px" runat="server"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red"
                                                                ValidationGroup="PRO" ControlToValidate="txtBatchNo"></asp:RequiredFieldValidator>
                                                            <strong><span id="btn" runat="server" class="astrics">*</span> Batch No :</strong>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtBatchNo" MaxLength="10" Width="91%" CssClass="textbox_pop" runat="server"
                                                        ...
                                                        <td align="right">
                                                            ...
                                                            <strong><span id="mrp" runat="server" class="astrics">*</span> MRP :</strong>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtMRP" Width="91%" CssClass="textbox_pop" runat="server" MaxLength="7"
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                            ...
                                                            <strong><span id="mfd" runat="server" class="astrics">*</span> Mfd_Date :</strong>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtMfd_Date" MaxLength="50" Width="91%" CssClass="textbox_pop" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtExp_Date" MaxLength="50" Width="91%" onchange="checkproduct(this.value);"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" colspan="2">
                                                            <asp:CompareValidator ID="CompareValidator2" runat="server" ValidationGroup="PRO"
                                                                ...
                                                                Type="Date" Operator="GreaterThan" Text="Exp. Date is greater than Mfd. Date."></asp:CompareValidator>
                                                        </td>
                                                    </tr>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Action">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="Imgeditprodetails" runat="server" CommandName="EditProDetails"
                                                                                    ImageUrl="~/Content/images/edit.png" CommandArgument='<%#Container.DataItemIndex %>' />
                                    ...
                                    <tr>
                                        <td align="right" style="padding-right: 10px;">
                                            <div style="float: left; width: 70%; text-align: left; padding-left: 18px;">
                                            ...
                                            <div style="float: right; width: 26%;">
                                                ...
                                                <asp:Button ID="btnSave" OnClick="btnSave_Click" ValidationGroup="PRO" CssClass="button_all"
                ...
                <cc1:ModalPopupExtender ID="ProductDetailsPopUp" runat="server" PopupControlID="PanelProductDetails"
                    TargetControlID="Label1" BackgroundCssClass="NewmodalBackground" CancelControlID="Button1">
                ...
                <cc1:ModalPopupExtender ID="ModalPopupExtenderAlert" runat="server" BackgroundCssClass="NewmodalBackground"
                    CancelControlID="btnPasswordPnlClose" PopupControlID="PanelShowPassword" OkControlID="btnYesActivation"
       ...
       <%-- </ContentTemplate>
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="GrdProductMaster" />
        </Triggers>
    </asp:UpdatePanel>--%>
    </div>
</asp:Content>
