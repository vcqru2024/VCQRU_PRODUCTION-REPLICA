<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="Redeem.aspx.cs" Inherits="Manufacturer_Redeem" %>

<%@ Register Src="~/UserControl/RedeemHistory.ascx" TagPrefix="uc1" TagName="RedeemHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:RedeemHistory runat="server" ID="RedeemHistory" />
