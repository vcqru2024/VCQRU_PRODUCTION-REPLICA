<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="ReportofWellverse.aspx.cs" Inherits="Manufacturer_ReportofWellverse" %>
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Reported Data</h4>
                        </header>
                        <div class="card-body card-body-nopadding">
                            ...
                            <div class="form-wizard medias">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        <asp:TextBox ID="txtmobile" runat="server" MaxLength="12" placeholder="Mobile NO" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-lg-3">
                                  ...
                                  <asp:GridView ID="grd1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped tblSorting table-bordered"
                                        ...
                                        <Columns>
                                             <asp:TemplateField HeaderText="Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblConsumerName" runat="server" Text='<%# Eval("ConsumerName") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Purchased From">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpurchasedfrom" runat="server" Text='<%# Bind("Purchasedfrom") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                           ...
                                           <%-- <asp:TemplateField HeaderText="Country">
                                             ...
                                             <asp:TemplateField HeaderText="Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDateofreport" runat="server" Text='<%# Bind("Dateofreport") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Image">
                                                <ItemTemplate>
                                                    <a href='<%#Eval("Imgpath") %>' target="_blank">
                                                        <asp:Image ImageUrl='<%#Eval("Imgpath") %>' style="height:70px;width:100px;object-fit:contain;" runat="server" />
                                                    </a>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
