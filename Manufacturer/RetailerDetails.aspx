<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="RetailerDetails.aspx.cs" Inherits="Manufacturer_RetailerDetails" %>
                                ...
                                <div class="col-md-12" style="overflow: scroll;">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped tblSorting table-bordered"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblM_Consumerid" runat="server" Text='<%# Bind("M_Consumerid") %>'></asp:Label>
                                        </ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblPermanentAddress" runat="server" Text='<%# Bind("permanent_Address") %>'></asp:Label>
                                        </ItemTemplate>
                                       
                                        <ItemStyle HorizontalAlign="left" Width="7%" />
                                    </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Id Proof No">
                                        <ItemTemplate>
                                            
                                            <asp:Label ID="lblIdProofNo" runat="server" Text='<%# Bind("[Id Proof No]") %>'></asp:Label>
                                        </ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblEntry_Date" runat="server" Text='<%# Bind("Entry_Date") %>'></asp:Label>
                                        </ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a href="#" runat="server" id="btn" class="btnUpload">Edit / Delete</a>
                                            <asp:HiddenField ID="key" runat="server" Value='<%# Bind("M_Consumerid") %>' />
                                            <asp:HiddenField ID="gmobileno" runat="server" Value='<%#Eval("MobileNo") %>' />
                                            <asp:HiddenField ID="gName" runat="server" Value='<%#Eval("[Name]") %>' />
