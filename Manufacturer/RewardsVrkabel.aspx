<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="RewardsVrkabel.aspx.cs" Inherits="Manufacturer_RewardsVrkabel" %>
               ...
               <div class="col-lg-12">
                <div class="card card-admin form-wizard profile box_card">
                    <header class="card-header">
                        <h4 class="card-title"><i class="fa fa-plus-square-o"></i><asp:Label ID="lblheading" runat="server" Text="Add Reward" Font-Bold="true"></asp:Label></h4>
                    </header>
                    ...
                    <div  class="card-body card-body-nopadding"> <div id="newmsg" runat="server"> <p><br />
                        <a href="uploadrewardsvrkabel.aspx" class="btn btn-primary">Add Reward</a></p>
                    </div>
                    <h6> Reward Info</h6>
                        <div class="col-lg-12">
                         <div class="row">
