<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true"  EnableEventValidation="false"
    CodeFile="ServiceSettings.aspx.cs" Inherits="ServiceSettings" Title="Services Setting" %>
               ...
               <div class="col-lg-12">
                        <div class="card card-admin form-wizard profile box_card">
                            <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Service Setting Master</h4> 
                            </header>
                            ...
                            <div class="card-body card-body-nopadding">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-3">
                                        <asp:DropDownList ID="ddlsearchSrervice" CssClass="form-control form-control-sm" runat="server">
                                         ...
                                         <asp:TextBox ID="txtDateFrom" runat="server" CssClass="form-control form-control-sm" Visible="false"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-lg-3">
                              ...
                              <div class="row pb-2 pt-2 background-section-form">
                                    ...
                                    <div class="col-lg-2">
                                       <asp:DropDownList ID="ddlRowProductCnt" Visible="false" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlRowsShow_SelectedIndexChanged">
                                ...
                                <div class="form-row" style="float: right;">
                                    <div class="form-group col-lg-12">
                                        <asp:Button ID="imgNew" ToolTip="Add New Product" OnClick="imgNew_Click1"
                                            CausesValidation="false" runat="server" Text="Add/Service Setting" class="btn btn-primary float-right mb-0" />
                                    </div>
                                </div>
                                </div>
                    ...
                    DataKeyNames="IsActive,Sound" EmptyDataText="Record Not Found" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Product Name">
                            <ItemTemplate>
                                <asp:Label ID="lblproname" runat="server" Text='<%# Bind("Pro_Name") %>'></asp:Label>&nbsp;[<asp:Label ID="lbladdsrvname" runat="server" Text='<%# Bind("ServiceName") %>'></asp:Label>][<asp:Label
                                    ID="lblrange" runat="server" Text='<%# Bind("servicerange") %>'></asp:Label>]
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Points">
                            <ItemTemplate>
                                <asp:Label ID="lblptgains" runat="server" Text='<%# Convert.ToInt32(Eval("Points")) == 0 ? "No" : Eval("Points")  %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                        ...
                        <asp:TemplateField HeaderText="Cash">
                            <ItemTemplate>
                                <asp:Label ID="lbliScASHcONVERT" runat="server" Text='<%# Convert.ToInt32(Eval("IsCashConvert")) == 0 ? "Yes" : "No"  %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                        ...
                        <asp:TemplateField HeaderText="Frequency">
                            <ItemTemplate>
                                <asp:Label ID="lblfrequency" runat="server" Text='<%# Convert.ToInt32(Eval("Frequency")) == 0 ? "No" : Eval("Frequency")  %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                        ...
                        <asp:TemplateField HeaderText="Comments">
                            <ItemTemplate>
                                <asp:Label ID="lblComments" runat="server" Text='<%# Convert.ToString(Eval("Comments")) == "" ? "No" : Eval("Comments")  %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />--%>
                        ...
                        <asp:TemplateField HeaderText="Hindi">
                            <ItemTemplate>
                                ...
                                %>
                                <ul class="graphic">
                                    <li style="padding-left: 10px;"><a href='<%# Eval("SoundPath") %>' class="sm2_link">
                                    </a></li>
                                </ul>
                                <%}
                                    else
                        ...
                        <asp:TemplateField HeaderText="English">
                            <ItemTemplate>
                                ...
                                %>
                                <ul class="graphic">
                                    <li style="padding-left: 10px;"><a href='<%# Eval("SoundPath1") %>' class="sm2_link">
                                    </a></li>
                                </ul>
                                <%}
                                    else
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <%
                                    ...
                                    {
                                %>
                                <asp:ImageButton ID="ImgBtnLoyalty" runat="server" CausesValidation="false" CommandArgument='<%#Bind("SST_Id") %>'
                                    CommandName="EditRows" ImageUrl="~/Content/images/edit.png" ToolTip="Add / Update Loyalty" />&nbsp;
                                <%if (IsActive == 0)
                                  {%>
                                <asp:ImageButton ID="ImgIsActiveDelete" runat="server" CausesValidation="false" CommandArgument='<%#Bind("SST_Id") %>'
                                    CommandName="IsActive" ImageUrl="~/Content/images/check_gr.png" ToolTip="Click for Activated Service Settings."
                                ...
                                <asp:ImageButton ID="ImgIsActiveDeletes" runat="server" CausesValidation="false"
                                    CommandArgument='<%#Bind("SST_Id") %>' CommandName="IsActive" ImageUrl="~/Content/images/check_act.png"
                                    ToolTip="Click for De-Activated Service Settings." OnClientClick="return confirm('Are you sure to De-Activate.')" />
                                <%} %>
                                &nbsp;<asp:ImageButton ID="imgBtnSecDelete" runat="server" CommandArgument='<%#Bind("SST_Id") %>'
                                OnCommand="imgBtnSecDelete_Command" CommandName="DeleteRow"   ImageUrl="~/Content/images/delete.png" ToolTip="Delete" 
                                    OnClientClick="return confirm('Are you sure to you want to delete?')" />
                                <%}
                                    else
                                    { %>
                                <asp:Label ID="lblsrvst" runat="server" ForeColor="Red" Font-Size="8pt" Text="Expired"></asp:Label>
                                <%} %>
                                <%index++;%>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed bord_left" HorizontalAlign="Center" />--%>
                            ...
                            <div class="regis_popup" style="line-height: 25px;overflow : auto ; height: 700px;">
                                ...
                                <table cellpadding="0px" cellspacing="10px" width="100%" class="grid" style="line-height: 25px;overflow : auto ; height: 500px;">
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td style="padding-left: 15px; width: 50%;">
                                                        <strong>Product : </strong><span class="astrics">*</span>&nbsp;&nbsp;<br />
                                                        <asp:DropDownList ID="ddlProduct" CssClass="drp" runat="server" Width="65%" onchange="javascript:GetSubscription()">
                                                        </asp:DropDownList>
                                                    ...
                                                    <td>
                                                        <strong>Date Range : <span class="astrics">*</span></strong>&nbsp;&nbsp;<br />
                                                        ...
                                                        <asp:TextBox ID="txtloyaltydtto" Width="120px" CssClass="reg_txt" runat="server"
                                                            onchange="javascript:CheckDateExistNew(this.value);" placeholder="Date To.."></asp:TextBox><br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ValidationGroup="LOY"
                                                            ...
                                                            Type="Date" Operator="GreaterThanEqual" Text="Date To is Less Than Date From"></asp:CompareValidator>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td style="padding-left: 15px; width: 100%;">
                                                     ...
                                                     <%--   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ValidationGroup="gg"
                                                        ...
                                                        <%--<asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="">
                                                                    <HeaderTemplate>
                                                                        <asp:CheckBox Text="All" runat="server" ID="chkmaster" class="ckhmaster" onchange="checkAll(this);" />
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox Text="" runat="server" name="chkStatus" ID="childchk2" CssClass="childchk" />
                                                                        <asp:Label ID="lblBLoyalty_PointEarnedID" runat="server" Text='<%# Bind("BLoyalty_PointEarnedID") %>' Visible="false"></asp:Label>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Cash(Rs) 4points=1Rs">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblCash" runat="server" Text='<%# Bind("Cash1") %>'></asp:Label><br />
                                                                        (<asp:Label ID="Label3" runat="server" Text='<%# Bind("points1") %>'></asp:Label>points)
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Consumer">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblsizeMobileNo" runat="server" Text='<%# Bind("MobileNo") %>'></asp:Label>
                                                                ...
                                                                <asp:TemplateField HeaderText="Bank">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblsizeBank_Name" runat="server" Text='<%# Bind("Bank_Name") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="RTGSCode">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblRTGS_Code" runat="server" Text='<%# Bind("RTGS_Code") %>'></asp:Label>
                                                                    </ItemTemplate>
                                        ...
                                        <td colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:RadioButton ID="rdIsRefCash" runat="server" Text="&nbsp;Cash&nbsp;&nbsp;" GroupName="REF"
                                                            AutoPostBack="false" OnCheckedChanged="rdReferral_CheckedChanged"  Visible="false" />&nbsp;
                                                        <asp:RadioButton ID="rdIsRefPoints" runat="server" Text="&nbsp;Points&nbsp;&nbsp;"
                                                            GroupName="REF" AutoPostBack="false" OnCheckedChanged="rdReferral_CheckedChanged"  Visible="false" />&nbsp;
                                                        <asp:RadioButton ID="rdIsRefGift" runat="server" Text="&nbsp;Gift&nbsp;&nbsp;" GroupName="REF"
                                                            AutoPostBack="false" OnCheckedChanged="rdReferral_CheckedChanged"   Visible="false"/>
                                                    </td>
                                                </tr>
                                                <tr id="divpoinscash" runat="server">
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp;<asp:TextBox ID="txtreffrom" Width="120px" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                                        ...
                                                        <asp:RequiredFieldValidator
                                                                ID="Reqrefto" runat="server" ForeColor="Red" ValidationGroup="NN" ControlToValidate="txtrefto">
                                                            </asp:RequiredFieldValidator>
                                                ...
                                                <tr id="divrefGift" runat="server">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlrefGiftFrom" Width="130px" CssClass="reg_txt" runat="server"
                                                            ToolTip="Seelct Gift to win Referals" onchange="javascript:CheckZero(this.value);">
                                                        </asp:DropDownList>
                                                        &nbsp;&nbsp;<asp:DropDownList ID="ddlrefGiftTo" Width="130px" CssClass="reg_txt"
                                    ...
                                    <tr id="divtxtReferralLimit" runat="server" visible="false">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtReferralLimit" Width="120px" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                                MaxLength="5"
                                    ...
                                    <tr id="divisfrequency" runat="server">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtfrequency" Width="120px" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                    ...
                                    <tr id="diviscash" runat="server">
                                        <td style="width: 30%; text-align: right; vertical-align: top;">
                                            <strong>Cash : </strong>&nbsp;&nbsp;
                                            <asp:RequiredFieldValidator ID="RFVIsCash" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                ControlToValidate="txtcashamt">
                                            </asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtcashamt" Width="120px" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                                runat="server" onkeyDown="return checkTextAreaMaxLength(this,event,'2');" ToolTip="Enter Frequency to win alternet rewards points"
                                                onchange="javascript:CheckZero(this.value);"></asp:TextBox>
                                        </td>
                                    </tr>
                                                ...
                                                <table width="100%" cellpadding="2px" cellspacing="2px">
                                                    <tr>
                                                        <td colspan="2" width="50%">
                                                            <fieldset class="Newfield" style="border: 1px solid #D9E0E6;">
                                                                <legend>Service Type</legend>
                                                                <div class="SingleCheckbox" style="padding-left: 25px;">
                                                                    <div style="float: left; width: 25%; margin-top: 5px;">
                                                                        <asp:RadioButton ID="rdInstant" runat="server" GroupName="TP" Checked="true" AutoPostBack="true"
                                                                            OnCheckedChanged="rdInstant_CheckedChanged" />
                                                                        <asp:Label ID="Label1" AssociatedControlID="rdInstant" runat="server" Text="Instant"
                                                                            CssClass="CheckBoxLabel"></asp:Label></div>
                                                                    <div style="float: left; margin-top: 5px;">
                                                                        ...
                                                                        <asp:TextBox ID="txtDueDate" Width="120px" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                                        ...
                                                        <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtendertxtDueDate" runat="server" TargetControlID="txtDueDate"
                                                            WatermarkText="Lucky draw date">
                                                                        ...
                                                                        <%--<asp:RequiredFieldValidator
                                                                ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ValidationGroup="NN" ControlToValidate="txtDueDate">
                                                            </asp:RequiredFieldValidator>--%>
                                                                    </div>
                                                                </div>
                                                            </fieldset>
                                                            ...
                                                            <fieldset class="Newfield" style="border: 1px solid #D9E0E6;">
                                                                ...
                                                                <div class="SingleCheckbox" style="padding-left: 25px;">
                                                                    <div style="float: left; width: 27%; margin-top: 5px;">
                                                                        <asp:RadioButton ID="rdRandomDistri" runat="server" GroupName="RD" Checked="true"  AutoPostBack="true" OnCheckedChanged="rdRandomDistri_CheckedChanged" />
                                                                        <asp:Label ID="Label9" AssociatedControlID="rdRandomDistri" runat="server" Text="Randon&nbsp;"
                                                                            CssClass="CheckBoxLabel"></asp:Label></div>
                                                                    &nbsp;&nbsp;
                                                                    <div style="float: left; margin-top: 5px;">
                                                                        <asp:RadioButton ID="rdSequenceDistri" runat="server" GroupName="RD" AutoPostBack="true" OnCheckedChanged="rdRandomDistri_CheckedChanged" />
                                                        ...
                                                        <td colspan="5">
                                                            <fieldset class="Newfield" style="border: 1px solid #D9E0E6;">
                                                                ...
                                                                <table width="100%" style="padding-left: 25px;">
                                                                    <tr>
                                                                        <td>
                                                                            <asp:RadioButton ID="rdFirstnth" runat="server" GroupName="RL" Checked="true" AutoPostBack="true"
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txttcodes" Width="100px" runat="server" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                                                                AutoPostBack="true" OnTextChanged="GetWinners_TextChanged"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqtcodes" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtnth" runat="server" CssClass="reg_txt" ReadOnly="false" Width="100px"
                                                                                onkeypress="return isNumberKey(this, event);" Style="display: none;"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqnth" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                                ControlToValidate="txtnth"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:RadioButton ID="rdFirstRandomnth" runat="server" GroupName="RL" Checked="true"
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txteverynth" Width="100px" runat="server" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                                                                AutoPostBack="true" OnTextChanged="GetWinners1_TextChanged"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqeverynth" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txteverywin" runat="server" CssClass="reg_txt" Width="100px" onkeypress="return isNumberKey(this, event);"
                                                                                AutoPostBack="true" OnTextChanged="GetWinners1_TextChanged"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqeverywin" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                                ControlToValidate="txteverywin"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txttcodesrand" Width="100px" runat="server" CssClass="reg_txt" onkeypress="return isNumberKey(this, event);"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="reqtcodesrand" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                                ControlToValidate="txttcodesrand"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                        <td>
                                                                            <%--<b>Random Winners</b>&nbsp;--%>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtrand" runat="server" CssClass="reg_txt" Width="100px" onkeypress="return isNumberKey(this, event);"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="reqrand" runat="server" ForeColor="Red" ValidationGroup="NN2324"
                                                                                ControlToValidate="txtrand"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:RadioButton ID="rdAllParticipant" runat="server" GroupName="RL" AutoPostBack="true"
                                                                                OnCheckedChanged="rdAllParticipant_CheckedChanged" />
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <td colspan="5">
                                                            <fieldset class="Newfield" style="border: 1px solid #D9E0E6;">
                                                                ...
                                                                <table width="100%" style="padding-left: 25px;">
                                                                    <tr>
                                                                        <td width="3%">
                                                                            <asp:RadioButton ID="rdAlltonthrand" runat="server" GroupName="DL" AutoPostBack="true"
                                                                                OnCheckedChanged="rdAlltoAll_CheckedChanged" />
                                                                        </td>
                                                                        <td width="60%">
                                                                            <b>First 'n' from all participants</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox
                                                                                AutoPostBack="true" OnTextChanged="GetWinner_TextChanged" ID="txtalltonth" Width="120px"
                                                                                runat="server" CssClass="reg_txt" placeholder="Random 'n' Winners" onkeypress="return isNumberKey(this, event);"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqalltonth" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                                ControlToValidate="txtalltonth"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                        <td>
                                                                            <b>Every n<sup>th</sup></b>&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtrandfreq"
                                                                                AutoPostBack="true" OnTextChanged="GetWinner_TextChanged" Width="120px" runat="server"
                                                                                CssClass="reg_txt" placeholder="Participants" onkeypress="return isNumberKey(this, event);"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqrandfreq" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <b>Random 'n' from all participants</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox
                                                                                AutoPostBack="true" OnTextChanged="GetWinner1_TextChanged" ID="txtalltonCustomer"
                                                                                Width="120px" runat="server" CssClass="reg_txt" placeholder="Random 'n' Winners"
                                                                                onkeypress="return isNumberKey(this, event);"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqalltonCustomer" runat="server" ForeColor="Red"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <b>First 'n' from all participants</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                            <asp:TextBox ID="txtallpFirstn" runat="server" Width="120px" CssClass="reg_txt" placeholder="First 'n' Participants"
                                                                                onkeypress="return isNumberKey(this, event);" AutoPostBack="true" OnTextChanged="GetWinner2_TextChanged"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="reqallpFirstn" runat="server" ForeColor="Red" ValidationGroup="NN"
                                                                                ControlToValidate="txtallpFirstn"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                        <td>
                                                                            <b>Winners</b>&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtallpFirstnton" runat="server"
                                                                                AutoPostBack="true" OnTextChanged="GetWinner2_TextChanged" Width="120px" CssClass="reg_txt"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:DropDownList runat="server" ID="ddlAddGift" CssClass="drp" Width="98%" onchange="FillAvailable(this.value);">
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="ReqvalAddGidt" runat="server" ControlToValidate="ddlAddGift"
                                                                ValidationGroup="ADG" InitialValue="--Select--"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td align="center">
                                                            <asp:Label ID="lbltotqty" runat="server"></asp:Label>
                                                        </td>
                                                        <td width="10%">
                                                            <asp:TextBox ID="txtGiftQty" CssClass="reg_txt" MaxLength="10" runat="server" onkeypress="return isNumberKey(this, event);"></asp:TextBox>
                                                        </td>
                                                        <td width="15%">
                                                        ...
                                                        <td width="15%">
                                                            <asp:Button ID="btnGSave" runat="server" Text="Save" ValidationGroup="ADG" CssClass="button_all"
                                                                Style="min-width: 45px; padding: 5px 5px;" OnClick="btnGSave_Click" />&nbsp;<asp:Button
                                                                    ID="btnGReset" CausesValidation="false" runat="server" Text="Reset" CssClass="button_all"
                                                                    OnClick="btnGReset_Click" Style="min-width: 45px; padding: 5px 5px;" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
                                                            <div style="overflow: auto; height: 150px;">
                                                                <asp:GridView ID="GrdVwGift" runat="server" AutoGenerateColumns="False" CssClass="grid"
                        ...
                        <div class="pop_log_bg">
                            ...
                            <div class="regis_popup">
                                <table width="100%" cellpadding="0px" cellspacing="5px">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="chkIsCustome" runat="server" Text="  IsCustom" onchange="javascript:IsCustom();" />
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                        ...
                                        <td colspan="2">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPlanAmount" runat="server" CssClass="reg_txt" ReadOnly="true"
                                                            onkeypress="return isNumberKey(this, event);" onchange="javascript:WritrVal();"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtPlanDiscount" runat="server" CssClass="reg_txt" ReadOnly="true"
                                                ...
                                                <tr>
                                                    <td>Master Period : </td>
                                                    <td>
                                                        <asp:TextBox ID="txtmPeriod" runat="server" CssClass="reg_txt" onchange="javascript:WritrVal();" onkeypress="return isNumberKey(this, event);" ReadOnly="true" Width="50px"></asp:TextBox>
                                                    </td>
                                                    <td>Sale Period : </td>
                                                    <td>
                                                        <asp:TextBox ID="txtsPeriod" runat="server" CssClass="reg_txt" onchange="javascript:WritrVal1();" onkeypress="return isNumberKey(this, event);" ReadOnly="true" Width="50px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <asp:Button ID="btnAmcRenewal" runat="server" Text="Submit" OnClick="Submit_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
