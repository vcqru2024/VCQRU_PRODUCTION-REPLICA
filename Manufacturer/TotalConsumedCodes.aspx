<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="TotalConsumedCodes.aspx.cs" Inherits="Manufacturer_TotalConsumedCodes" %>
                    ...
                    <div class="card card-admin form-wizard profile box_card">
                        <%--<header class="card-header">--%>
                         <header class="<%= Session["card-header"] %>">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i> Total Consumed Codes Report</h4>
                        </header>
