...
public partial class Manufacturer_TotalConsumedCodes : System.Web.UI.Page
{
    ...
    public void Bindgrid()
    {
        try
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("USP_GetTotalConsumedCodes_HPL", con);
        ...
        */
        if (Page.IsValid)
        {
            try
            {
                ...
                wb.Worksheets.Add(dt, "TotalConsumedCodes");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=TotalConsumedCodes.xlsx");
