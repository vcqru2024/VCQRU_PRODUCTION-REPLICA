...
if(Session["Comp_id"].ToString() == "Comp-1434")
    ...
    {
        if(Session["Comp_id"].ToString() == "Comp-1400" || Session["Comp_id"].ToString() == "Comp-1531" || Session["Comp_id"].ToString() == "Comp-1532" || Session["Comp_id"].ToString() == "Comp-1548")
        {
            paytm.Visible = false;
...
#region // For claim process By Bipin Ji
            ...
            dt = SQL_DB.ExecuteDataTable("select top 1 [user_id],M_Consumerid from m_consumer where M_Consumerid=" + Session["M_ConsumeriD"].ToString());
            ...
            {
                if (dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1278" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1285" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1375"  || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1434" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1550"  || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1350" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1466")
                {
                    paytm.Visible = false;


                    if (dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1285" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1375"  || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1434" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1550"  || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1350" || dtcp1.Rows[0]["Comp_ID"].ToString() == "Comp-1466")
                    {
                ...
                {
                     if (dtcp1.Rows[0]["Comp_ID"].ToString() != "Comp-1321")
                    {
                        paytm.Visible = true;
                    }
                    else
...
// Remove paytm claim option for all
    ...
    //        }
    //        //DataTable dt = SQL_DB.ExecuteDataTable("select distinct cr.Comp_Name from dbo.[M_consumer] mc inner join dbo.pro_enq pe on pe.mobileno = mc.mobileno inner join dbo.M_code mcod on pe.Received_Code1 = mcod.code1 and pe.Received_Code2 = mcod.code2 inner join dbo.pro_reg pr on mcod.pro_ID = pr.Pro_ID inner join dbo.comp_reg cr on pr.Comp_ID = cr.Comp_ID where cr.Comp_ID = 'Comp-1230' and mc.[User_ID]='" + Session["USRID"].ToString() + "'");
    //        dtcp = SQL_DB.ExecuteDataTable("select mss.Comp_ID,sum(isnull(bl.points, 0)) point,cl.p_cash from dbo.[BLoyaltyPointsEarned] bl inner join[dbo].[M_ServiceSubscriptionTrans] ms on bl.sst_id = ms.sst_id inner join[dbo].M_ServiceSubscription mss on mss.Subscribe_Id = ms.Subscribe_Id inner join dbo.claimredeem cl on cl.compid=mss.Comp_ID where mss.Comp_ID='Comp-1203' and bl.M_consumerid = (select M_consumerid from dbo.m_consumer where user_id = '" + Session["USRID"].ToString() + "') group by mss.Comp_ID,cl.p_cash");
    //        if (dtcp.Rows.Count > 0)
    //        {
    //            //int totalpoint = Convert.ToInt32(SQL_DB.ExecuteScalar("SELECT case when Sum([Points]) is null then 0 else Sum([Points]) end as point FROM [BLoyaltyPointsEarned] bl inner join [M_consumer] mc on mc.[M_Consumerid]=bl.[M_Consumerid] where mc.[User_ID]='" + Session["USRID"].ToString() + "'"));
    ...
    //            else
    //            {
    //                //btnbheadp.Visible = true;
    //                //lblbhmsg.Text = "";
    //                //lblbhmsg.Visible = false;
    //            }


    //            //if (tp < Convert.ToInt32(lblbheadp.Text))
    //            //{
    //            //    btnbheadp.Visible = false;
    //            //    lblbhmsg.Text = "You are not eligible for this item kindly try with another.";
    //            //    lblbhmsg.Visible = true;
    //            //}
    //            //else
    //            //{
    //            //    btnbheadp.Visible = true;
    ...
    //            //if (tp < Convert.ToInt32(lblcgshockp.Text))
    //            //{
    //            //    btncgshockp.Visible = false;
    //            //    lblcgshock.Text = "You are not eligible for this item kindly try with another.";
    //            //    lblcgshock.Visible = true;
    //            //}
    //            //else
    //            //{
    //            //    btncgshockp.Visible = true;
    //            //    lblcgshock.Text = "";
    //            //    lblcgshock.Visible = false;
    //            //}

    //            //if (tp < Convert.ToInt32(lbljbhp.Text))
    //            //{
    //            //    btnjbhp.Visible = false;
    //            //    lbljbhm.Text = "You are not eligible for this item kindly try with another.";
    //            //    lbljbhm.Visible = true;
    //            //}
    //            //else
    //            //{
    //            //    btnjbhp.Visible = true;
    //            //    lbljbhm.Text = "";
    //            //    lbljbhm.Visible = false;
    //            //}

    //            //if (tp < Convert.ToInt32(lbljbsp.Text))
    //            //{
    //            //    btnjbsp.Visible = false;
    //            //    lbljbsm.Text = "You are not eligible for this item kindly try with another.";
    //            //    lbljbsm.Visible = true;
    //            //}
    //            //else
    //            //{
    //            //    btnjbsp.Visible = true;
    //            //    lbljbsm.Text = "";
    //            //    lbljbsm.Visible = false;
    //            //}

    //            //if (tp < Convert.ToInt32(lblppp.Text))
    //            //{
    //            //    btnppp.Visible = false;
    //            //    lblppm.Text = "You are not eligible for this item kindly try with another.";
    //            //    lblppm.Visible = true;
    //            //}
    //            //else
    //            //{
    ...
    //            //{
    //            //btnbheadp.Visible = false;
    //            //lblbhmsg.Text = "You are not eligible for claim.";
    //            //lblbhmsg.Visible = true;
    //            ////}
    //            ////else
    //            ////{
    ...
    //            ////{
    //            //btncgshockp.Visible = false;
    //            //lblcgshock.Text = "You are not eligible for claim.";
    //            //lblcgshock.Visible = true;
    //            ////}
    //            ////else
    //            ////{
    ...
    //            ////{
    //            //btnjbhp.Visible = false;
    //            //lbljbhm.Text = "You are not eligible for claim.";
    //            //lbljbhm.Visible = true;
    //            ////}
    //            ////else
    //            ////{
    ...
    //            ////{
    //            //btnjbsp.Visible = false;
    //            //lbljbsm.Text = "You are not eligible for claim.";
    //            //lbljbsm.Visible = true;
    //            ////}
    //            ////else
    //            ////{
    ...
    //            ////{
    //            //btnppp.Visible = false;
    //            //lblppm.Text = "You are not eligible for claim.";
    //            //lblppm.Visible = true;
    //            //}
    //            //else
    //            //{
    ...
    protected void btnptmp_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dtconsumer.Rows[0][0].ToString() != "0" || hcc.Value == "Comp-1227" || hcc.Value == "Comp-1350" || hcc.Value == "Comp-1412"  || hcc.Value == "Comp-1434" || hcc.Value == "Comp-1483" || hcc.Value == "Comp-1466") 
            {
                ...
                if (ptforrd >= Convert.ToInt32(dtcondition.Rows[0]["codition_point"].ToString()))
                {
                    ...
                    if (cn == "COATS BATH FITTINGS" || cn == "R.S Industries" || cn == "Jupiter Aqua Lines Ltd")
                    {
...
DataTable dtgift = SQL_DB.ExecuteDataTable("select Gifts from Claim_gift where CompID='" + hcc.Value + "' and Gift_value='" + ptforrd + "' ");
        ...
        //    }
            ...
            string msg = "";
            DataTable dtconsumer = SQL_DB.ExecuteDataTable("select count(*) from m_consumer where m_consumerid='" + Session["M_ConsumeriD"] + "' and aadharfile is not null and aadharback is not null");
            if (dtconsumer.Rows[0][0].ToString() != "0" || hcc.Value == "Comp-1227" || hcc.Value == "Comp-1550"  || hcc.Value == "Comp-1434"   || hcc.Value == "Comp-1350" || hcc.Value == "Comp-1466")
            {
                DataTable dtcondition = SQL_DB.ExecuteDataTable("select top 1 codition_point,condition_match from point_redeem_condition where comp_id='" + hcc.Value + "' and isactive=1 and selection_id=case when (select count(*) from paytmtransaction where m_consumerid='" + Session["M_ConsumeriD"] + "' and pstatus='SUCCESS' and comp_id='Comp-1283')>0 then 2 else 1 end ");
                if (ptforrd >= Convert.ToInt32(dtcondition.Rows[0]["codition_point"].ToString()))
                {
                    ...
                    if (cn == "COATS BATH FITTINGS" || cn == "R.S Industries" || cn == "BAGHLA SANITARYWARE" || cn == "Jupiter Aqua Lines Ltd"  || cn == "Inox Decor Pvt Ltd"  || cn == "Veena Polymers" || cn == "OCI Wires and Cables")
                    {
