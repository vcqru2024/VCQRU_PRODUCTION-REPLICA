<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="UPIPaymentDetails.aspx.cs" Inherits="Manufacturer_UPIPaymentDetails" %>
         ...
         <div class="container-fluid xyz">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>UPI Payout Report</h4>
                            </header>
           ...
           <%-- akash --%>
            ...
            <%-- end --%>
                    <div class="form-row">
                        ...
                        <%-- <div class="form-group col-lg-2">
                            <asp:TextBox ID="txtupi" runat="server" placeholder="Enter valid UPI ID" CssClass="form-control form-control-sm"></asp:TextBox>
                        </div>--%>
           ...
           <div class="table-responsive table_large">
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered Frm_Scrap"
                   ...
                   <Columns>
                        ...
                        <asp:TemplateField HeaderText="Code1" Visible="true">
                            <ItemTemplate>
                                <asp:Label ID="lblRec_code1" runat="server" Text='<%# Bind("Code1") %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />--%>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Code2" Visible="true">
                            <ItemTemplate>
                                <asp:Label ID="lblRec_code2" runat="server" Text='<%# Bind("Code2") %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />--%>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="UPI Id" Visible="true">
                            <ItemTemplate>
                                <asp:Label ID="lblAccountNo" runat="server" Text='<%# Bind("UPI_Id") %>'></asp:Label><br />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                       
                        <asp:TemplateField HeaderText="Old Bal." Visible="true">
                            <ItemTemplate>
                       ...
                       <asp:TemplateField HeaderText="Service Charge" Visible="true">
                            <ItemTemplate>
                                <asp:Label ID="lblAmount" runat="server" Text='<%# Bind("ChargedAmount") %>'></asp:Label><br />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                       ...
                       <asp:TemplateField HeaderText="GST Amount" Visible="true">
                        ...
                        <asp:TemplateField HeaderText="New Bal." Visible="true">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Bank status" Visible="true">
                            <ItemTemplate>
                                <asp:Label ID="lblpstatus" runat="server" Text='<%# Bind("BankStatus") %>'></asp:Label><br />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Bank Remarks" Visible="true">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Final Remarks" Visible="true">
                            <ItemTemplate>
                                <asp:Label ID="lblInqComment" runat="server" Text='<%# Bind("FinalRemark") %>'></asp:Label><br />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Date & time" Visible="true">
                            <ItemTemplate>
