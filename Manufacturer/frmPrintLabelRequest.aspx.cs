...
public partial class frmPrintLabelRequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["CompanyId"] == null)
            Response.Redirect("../Info/Login.aspx?Page=frmManufactureBill.aspx");
        else
        {
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            txtNoofLabel.Text = "";
            // ModalPopupExtenderRequest.Show();
            Response.Redirect("AddLabelRequest.aspx");
        }
        else
        {
            DataSet ds1 = function9420.FetchRequestProductList(obj);
