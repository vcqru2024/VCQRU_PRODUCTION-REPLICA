<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="frm_Cashrpt.aspx.cs" Inherits="Manufacturer_frm_Cashrpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>User Wise Cash Report</h4>
                        </header>
                        <div class="card-body card-body-nopadding">
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <asp:Label ID="lblMsg1" CssClass="font-weight-semibold" ForeColor="Red"  runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="form-wizard medias">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-3">
                                             <asp:TextBox ID="txtMobile" runat="server" placeholder="Enter Mobile No for Search" MaxLength="12" CssClass="form-control form-control-sm" ></asp:TextBox>
    ...
    ErrorMessage="Please enter valid phone no" ControlToValidate="txtMobile"   ForeColor="Red" style="font-size: small" ValidationExpression="^[7-9][0-9]{9}$" ></asp:RegularExpressionValidator>--%>
                                    <%--        <asp:RegularExpressionValidator runat="server" ErrorMessage="Please enter Valid MobileNo" ControlToValidate="txtMobile" ForeColor="Red" style="font-size: small" ValidationExpression="^[7-9][0-9]{9}$"--%>
