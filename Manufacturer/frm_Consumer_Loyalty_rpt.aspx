<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="frm_Consumer_Loyalty_rpt.aspx.cs" Inherits="Manufacturer_frm_Consumer_Loyalty_rpt" %>
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>User Loyalty Data</h4>
                        </header>
                            ...
                            <div class="form-wizard medias">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-3">
                                       ...
                                       <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"  ForeColor="Red" SetFocusOnError="true" ErrorMessage="Select date from. !" ControlToValidate="txtDateFrom"></asp:RequiredFieldValidator>  --%>
                                    ...
                                    <div class="form-group col-lg-3">
                                        <asp:TextBox ID="txtDateto" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                         <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ForeColor="Red" SetFocusOnError="true" ErrorMessage="Select date to. !" ControlToValidate="txtDateto"></asp:RequiredFieldValidator>  --%>
                                      ...
                                      <div class="col-md-3">
                                        <asp:TextBox ID="txtSearch" placeholder="Search Mobile No" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-lg-3">
                               ...
                               <%-- <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <button class="btn btn-primary" runat="server" id="btnsrch" onserverclick="btnsrch_ServerClick" style="font-size: 18px">Search <i class="fa fa-search"></i></button>
                                    </div>
                                </div>--%>
                              
                                <div class="table-responsive table_large">
                                    <asp:GridView ID="grd1" runat="server" CssClass="table table-striped tblSorting table-bordered" EmptyDataText="Record Not Found" BorderColor="#CCCCCC" AllowPaging="True" OnPageIndexChanging="grd1_PageIndexChanging" PageSize="5" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="3">
