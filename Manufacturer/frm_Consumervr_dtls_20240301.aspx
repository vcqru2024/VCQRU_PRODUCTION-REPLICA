            ...
            $(".btnDeleteAccount").click(function () {
                ...
                if ($(this).closest('tr').find('span[id*="lblactudateMobile"]').text().length >= 10) {
                    ...
                    if (mobile_val.length >= 10) {
                        $.ajax({
                            type: "Post",
                            url: "https://www.vcqru.com/Info/MasterHandler.ashx?method=DeleteAccountVRkabelWEb&mobileno=" + mobile_val + "&mode=Website",
                    ...
                    <div class="card card-admin form-wizard profile box_card">
                        ...
                        <div class="card-body card-body-nopadding">
                            ...
                            <div class="form-wizard medias">
                                ...
                                <br />
                                   <div class="col-lg-3">
                                  <a href="DeleteUserVrkable.aspx" class="btn btn-primary">View Deleted Users</a></p>
                              </div>
                                ...
                                <div class="table-responsive table_large">
                                    <asp:GridView ID="grd1"  runat="server" AutoGenerateColumns="False" CssClass="table table-striped tblSorting table-bordered" 
                                        ...
                                        BorderColor="transparent"
                                         allowpaging="false"
                                         OnPageIndexChanged="grd1_PageIndexChanged"   ClientIDMode="Static">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            ...
                                            <ItemTemplate>
                                              <%--<asp:ImageButton ID="btnChangeBatchInfo" runat="server" CausesValidation="false"
                                                    CommandArgument='2222' CommandName="ChangeBatchInfo" ImageUrl="~/Content/images/edit.png"
                                                    ToolTip="Edit" />--%>
                                         ...
                                         <%-- <asp:TemplateField HeaderText="Delete" >
                                          <ItemTemplate> 
                                              <a href="javascript:void(0)"  runat="server" id="btn1" class="btnDeleteAccount" ><img src="../Content/images/Erase.png"></a>
                                           </ItemTemplate>
                                        </asp:TemplateField>--%>
                                        </Columns>
