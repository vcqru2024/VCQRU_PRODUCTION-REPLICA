<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="frm_KYC.aspx.cs" Inherits="Manufacturer_frm_KYC" %>
                        ...
                        <div class="card-body card-body-nopadding">
                            ...
                            <div class="form-wizard medias">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        <asp:TextBox ID="txtmobile" runat="server" CssClass="form-control" placeholder="Mobile Number" MaxLength="12" minlength="10"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <asp:DropDownList ID="userType" Visible="false" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                        ...
                                        <asp:GridView ID="grd1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped tblSorting table-bordered"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Mobile">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblactudate12" runat="server" Text='<%# Bind("MobileNumber") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Justify" CssClass="grd_pad" Width="25%" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <a href='ViewKycDetails.aspx?mid=<%# Eval("M_Consumerid") %>'>
