<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="frm_RetailerDetails.aspx.cs" Inherits="Manufacturer_frm_RetailerDetails" %>
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Retailer Details</h4>
                        </header>
                                    ...
                                    <asp:GridView ID="grd1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped tblSorting table-bordered"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Request Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcompname" runat="server" Text='<%# Eval("ReqDate") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblproductname" runat="server" Text='<%# Bind("ConsumerName") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Mobile No">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBalnoCodes" runat="server" Text='<%# Bind("ConsumerMobileNumber") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Retailer ID">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcdoBalnoCodes" runat="server" Text='<%# Bind("RetailerId") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Shop Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblstatussucc" runat="server" Text='<%# Bind("ShopName") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Pin Code">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblstatussucc" runat="server" Text='<%# Bind("Pincode") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="City">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblstatussucc" runat="server" Text='<%# Bind("City") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="State">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblstatussucc" runat="server" Text='<%# Bind("State") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Dealer Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblstatussucc" runat="server" Text='<%# Bind("DealerName") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Dealer Code">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblstatussucc" runat="server" Text='<%# Bind("DealerCode") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Status">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblstatussucc" runat="server" Text='<%# Bind("Status") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="10%" />
                                            </asp:TemplateField>
