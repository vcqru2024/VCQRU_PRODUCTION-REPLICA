<%@ Page Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true"
    CodeFile="graphicalReport.aspx.cs" Inherits="frmManfEnquiry" Title="Graphical Report" %>
               ...
               <div class="col-lg-12">
                <div class="card card-admin form-wizard profile box_card">
                    <header class="card-header">
                        <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Code Analytical Report</h4>
                    </header>
                    ...
                    <div class="card-body card-body-nopadding">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                ...
                                <asp:RegularExpressionValidator runat="server" ControlToValidate="txtDateFrom" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$"
                                    ErrorMessage="Please enter valid date." ValidationGroup="servss" Display="Dynamic" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDateFrom" ErrorMessage="Please enter valid date." ValidationGroup="servss" Display="Dynamic" />
                            </div>
                            <div class="form-group col-lg-6">
                                <asp:TextBox ID="txtDateTo" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                <asp:RegularExpressionValidator runat="server" ControlToValidate="txtDateTo" Display="Dynamic" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$"
                                    ErrorMessage="Please enter valid date." ValidationGroup="servss" />
                                  <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDateTo" Display="Dynamic" ErrorMessage="Please enter valid date." ValidationGroup="servss" />
                            </div>
                        </div>
                         <div class="form-row">
                            <div class="form-group col-lg-6">
                               ...
                               <asp:Label ID="lblerror" runat="server" ForeColor="Red" Text="No Record Found!" Visible="false" />
                            </div>
                            <div class="form-group col-lg-6" style="text-align-last:end">
                                
                               <asp:Button ID="btnDownloadExcel" runat="server" Text="View Report" CausesValidation="false" OnClick="btnDownloadExcel_Click" ValidationGroup="false" CssClass="btn btn-primary"/>
                            </div>
                        </div>
                         <div class="form-row">
                            <div class="form-group col-lg-6">
                                                       
                               <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="No Record Found!" Visible="false" />
                            </div>
                        ...
                        <%--<div class="form-row">
                            ...
                            <div class="form-group col-lg-6" style="display:block!important; overflow:visible!important; position:static!important">
                        ...
                        <div class="grid_container">
                            ...
                            <div class="form-group col-lg-6" style="display:none" >
                                ...
                                <%--<asp:ListBox ID="ListBox1" runat="server" CssClass="form-control form-control-sm" SelectionMode="Multiple"  />--%>
                                <asp:DropDownList ID="ddlchart1" runat="server" Enabled="false" AutoPostBack="true" CssClass="form-control form-control-sm" OnSelectedIndexChanged="ddlchart1_SelectedIndexChanged">
                           ...
                           <div class="form-group col-lg-6">
                                <%--<label>State</label>--%>
                                <%--<asp:ListBox ID="ListBox2" runat="server" CssClass="form-control form-control-sm" SelectionMode="Multiple" />--%>
                                <asp:DropDownList ID="ddlchart2" runat="server" AutoPostBack="true" Enabled="false" CssClass="form-control form-control-sm" OnSelectedIndexChanged="ddlchart2_SelectedIndexChanged">
                                    <asp:ListItem>Code check</asp:ListItem>
                                    <asp:ListItem>Amount won</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                           
                                <div class="form-row" id="graphs" runat="server"><div class="form-group col-lg-11">
                                    

                                                      </div ></div>
                            <%--<div class="form-row">
                            <div class="form-group col-lg-11">
                            <asp:Chart ID="Report_chart" runat="server" Width="735px">
                                ...
                                <div class="form-group col-lg-1">
                                    <%--<asp:ImageButton runat="server" OnClick="Unnamed_Click" style="width:10px; height:10px" ImageUrl="~/img/download.png" />
                                    </div>
                        </div>--%>
                            <%--<div class="form-row">
                            <div class="form-group col-lg-11">
                            <asp:Chart ID="Chart1" runat="server" BorderlineWidth="0" Width="700px">
                               
                                <Series>
                                   
                                </Series>
                               <%-- <Legends>
                                    <asp:Legend Title="Codes Scanned" />
                                </Legends>--%>
                           <%--     <Titles>
                                    <asp:Title Docking="Bottom" Text="Product Vs Code Scanned Result" />
                                </Titles>
                                <ChartAreas>
                                    <asp:ChartArea Name="ChartArea1"></asp:ChartArea>
