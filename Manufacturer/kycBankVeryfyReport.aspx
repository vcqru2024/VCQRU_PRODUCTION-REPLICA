<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="kycBankVeryfyReport.aspx.cs" Inherits="Manufacturer_kycBankVeryfyReport" %>
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Bank KYC User Data</h4>
                        </header>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Name">
                                          ...
                                          <asp:TemplateField HeaderText="Account No.">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate12" runat="server" Text='<%# Bind("AccountNo") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Justify" CssClass="grd_pad" Width="25%" />
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="KYS Status">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate12" runat="server" Text='<%# Bind("IsBankAccountVerify") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Justify" CssClass="grd_pad" Width="25%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Bank Remark">
                                          ...
                                          <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate12" runat="server" Text='<%# Bind("created_at") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Justify" CssClass="grd_pad" Width="25%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action">                                         
                                            <ItemTemplate>                                            
                                                <a href='KycBankDetails.aspx?mid=<%# Eval("M_Consumerid") %>'><img src="../Content/images/edit.png" ></a>
                                            </ItemTemplate>
