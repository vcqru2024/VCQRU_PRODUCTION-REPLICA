<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="kycPancardReport.aspx.cs" Inherits="Manufacturer_kycPancardReport" %>
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Pan KYC User Data</h4>
                        </header>
                                ...
                                <div class="table-responsive table_large">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Name">
                                          ...
                                          <asp:TemplateField HeaderText="KYS Status">
                                            <ItemTemplate>
                                                <asp:Label ID="lblactudate12" runat="server" Text='<%# Bind("IspanVerify") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Justify" CssClass="grd_pad" Width="25%" />
                                        </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <a href='KycPanDetails.aspx?mid=<%# Eval("M_Consumerid") %>'><img src="../Content/images/edit.png" ></a>
