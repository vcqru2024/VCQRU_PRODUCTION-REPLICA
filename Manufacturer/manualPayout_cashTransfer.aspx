<%@ Page Title="" Language="C#" MasterPageFile="~/Manufacturer/VendorMaster.master" AutoEventWireup="true" CodeFile="manualPayout_cashTransfer.aspx.cs" Inherits="Manufacturer_manualPayout_cashTransfer" %>
                ...
                <div class="col-lg-12">
                    <div class="card card-admin form-wizard profile box_card">
                        <header class="card-header">
                            <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Manual Payout Cash Transfer Report</h4>
                        </header>
                                ...
                                <div class="form-row">
                                   ...
                                   <%--  <asp:RegularExpressionValidator runat="server" ControlToValidate="txtDateto" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$"
                                    ...
                                    <div class="form-group col-lg-3">
                                        <asp:TextBox ID="Mobile" runat="server" CssClass="form-control form-control-sm" MaxLength="12" minlength="10" placeholder="Enter 10 digit mobile number"  />
                                    </div>
                                    <%-- <div class="form-group col-lg-2">
