               ...
               // checkInternetConnection();
                ...
                if (mobileno.length == 10) {
                   ...
                   // $('#imgloaddersendotp').show();
                    ...
                    $.ajax({
                        type: "Post",
                        url: baseurl+'Info/MasterHandler.ashx?method=GetCodeCountbyMobile&MobileNo= ' + $("#mobile").val() + "&CompName=Cosmo Tech Expo",
                        success: function (data) {
            ...
            $('#btnsubmitotp').on('click', function () {
               // checkInternetConnection();
                ...
                $.ajax({
                    ...
                    url: baseurl+'Info/MasterHandler.ashx?method=Validateotp&verifycode=' + $('#otp').val() + '&mobile=' + $('#mobile').val(),
                    success: function (data) {
                        $('#overlay').hide();
                        //alert(data);
                        if (data == "Success") {
            ...
            $('#btnsubmit').on('click', function () {
              ...
              //  checkInternetConnection();
                ...
                $.ajax({
                    ...
                    url: baseurl+'Info/MasterHandler.ashx?method=InsertUpdateExibition&Mobile_no=' + $('#mobile').val() + '&Name=' + $('#Name').val() + '&Email=' + $('#Email').val() + '&CompName=' + $('#Companyname').val() + '&Designation=' + $('#Designation').val() + '&Intrest=' + $("#radioDiv input[type='radio']:checked").val(),
                    success: function (data) {
                ...
                if (code != "") {
                    ...
                    $.ajax({
                        ...
                        url: baseurl+'Info/MasterHandler.ashx?method=verifyotp&mobile=' + $('#mobile').val() + "&vCode=" + $('#codeone').val() + '&name=' + $('#Name').val() + '&EmailAddrs=' + $('#Email').val() + '&Comp_ID=' + $('#Companyname').val() + '&Other_Role=' + $('#Designation').val() + '&SellerName=' + $("#radioDiv input[type='radio']:checked").val() + '&comp=Cosmo Tech Expo',
                        success: function (data) {
