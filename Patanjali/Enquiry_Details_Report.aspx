                                ...
                                <tbody>
                                    <%
                                        ...
                                        if (dt != null && dt.Rows.Count > 0)
                                        {
                                            ...
                                            {
                                                Response.Write("<tr>");
                                                string formattedDate = ((DateTime)row["Enquiry Date"]).ToString("yyyy-MM-dd HH:MM:ss.fff");
                                                Response.Write("<td data-order='" + ((DateTime)row["Enquiry Date"]).ToString("yyyy-MM-dd HH:MM:ss.fff") + "'>" + formattedDate + "</td>");
