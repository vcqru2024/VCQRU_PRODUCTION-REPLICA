                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="../Patanjali/dashboard.aspx">Dashboard</a>
                                        </li>
                            ...
                            <div class="row g-0">
                                <div class="col-lg-2">
                                    <asp:Button ID="btnAvailable" runat="server"
                                        ...
                                        OnClick="btnAvailable_Click" ToolTip="Click For Filter" />Labels Available
                                </div>
                                <div class="col-lg-2">
                                    <asp:Button ID="btnUsed" runat="server"
                                        ...
                                        OnClick="btnUsed_Click" ToolTip="Click For Filter" />Pasted Labels
                                </div>
                                <div class="col-lg-3">
                                    <asp:Button ID="btnCourierRescrap" runat="server"
                                        ...
                                        OnClick="btnCourierRescrap_Click" ToolTip="Click For Filter" />Scrap Durung
                                    Courier Receipt
                                </div>
                                <div class="col-lg-3">
                                    <asp:Button ID="btnScrap" runat="server"
                                        ...
                                        OnClick="btnScrap_Click" ToolTip="Click For Filter" />Scrap at Pasting Time
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="app-table mt-2">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="Grdscrap" runat="server" AutoGenerateColumns="False"
                                        CssClass="table table-striped table-hover" DataKeyNames="ScrapeFlag,ff"
