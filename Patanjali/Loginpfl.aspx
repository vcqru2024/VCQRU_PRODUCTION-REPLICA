                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="patanjaliayurved">
                                    <img src="assets/img/logo.svg" alt="logo" class="patanjali-logo" />
                                </div>
                                <h5 class="card-title">Hey, welcome to Patanjali Ayurved!</h5>
                                <p class="card-text">
                                    Welcome to the official page of the Patanjali Product Authenticity
                                    Login Portal.
                                </p>
                                <div class="login-tab">
                                    <form runat="server" class="needs-validation" novalidate>
                                        <div
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="card-text mb-0 mt-1 fs-12" style="display:none;">
