<%@ Page Title="" Language="C#" MasterPageFile="~/Patanjali/pfl.master" AutoEventWireup="true" CodeFile="NewBatchAssignedDetails.aspx.cs" Inherits="Patanjali_NewBatchAssignedDetails" %>
     ...
     <div class="home-section">
        <div class="app-breadcrumb">
            <div class="row row-cols-xxl-2 row-cols-xl-2 row-cols-lg-2 row-cols-md-2 row-cols-1 g-3">
                <div class="col">
                    <h5>New Assigned Codes Details</h5>
                </div>
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.aspx">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">New Assigned Codes Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <ul class="action-button-global">
                                 <li>
                                        <a href="SearchCodeDetails.aspx" class="btn btn-sm btn-primary"><i class='bx bx-plus'></i>Assign New Codes</a>
                                    </li>
                                <li>
