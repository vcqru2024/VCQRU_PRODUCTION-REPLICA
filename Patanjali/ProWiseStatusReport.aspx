<%@ Page Title="" Language="C#" MasterPageFile="~/Patanjali/pfl.master" AutoEventWireup="true" CodeFile="ProWiseStatusReport.aspx.cs" Inherits="Patanjali_ProWiseStatusReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="home-section">
        <div class="app-breadcrumb">
            <div class="row">
                <div class="col">
                    <h5>Product Wise Status Count Report</h5>
                </div>
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../Patanjali/dashboard.aspx">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Product Wise Status Count</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="app-table">
                        <%
                            ...
                            if (dt != null && dt.Rows.Count > 0)
                            {
                                ...
                                Response.Write("<thead><tr><th>Product Name</th><th>Success</th><th>Repeater</th><th>Counterfeit</th><th>Grand Total</th></tr></thead>");
            ...
            <div class="row g-4">
                ...
                <div class="col">
                        ...
                        <%--<div class="col col-md-4 mb-3">
                            <asp:Button ID="Button1" runat="server" style="margin-top: 30px;" CssClass="btn btn-primary" Text="Button" OnClick="Button1_Click" />
                        </div>--%>
                      <%--  <div class="mb-3">
