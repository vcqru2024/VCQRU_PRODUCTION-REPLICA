                            ...
                            <div class="app-table">
                                <div class="table-responsive">
                                    <asp:GridView ID="GrdProductMaster" runat="server" AutoGenerateColumns="False"
                                        CssClass="table table-striped table-hover mb-0" EmptyDataText="Record Not Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Manufacture Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpastede234" runat="server"
                                                        Text='<%# Bind("Manufactured_date","{0:dd/MM/yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                                <ItemStyle />
                                            </asp:TemplateField>
                                              ...
                                              <asp:TemplateField HeaderText="Expiry Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpastede234" runat="server"
                                                        Text='<%# Bind("Expiry_date","{0:dd/MM/yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Center" />--%>
                                                <ItemStyle />
                                            </asp:TemplateField>
