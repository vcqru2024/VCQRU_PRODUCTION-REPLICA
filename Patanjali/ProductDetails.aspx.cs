...
using System.Text;
using DataProvider;
public partial class Patanjali_ProductDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["CompanyId"] == null)
            Response.Redirect("../patanjali/loginpfl.aspx?Page=ProductDetails.aspx");
        else
        {
    ...
    private void filldata()
    {
            ...
            ds = function9420.FillGridDetails_PFL(Reg);
    ...
    protected void GrdProductMaster_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("AddProductDetails.aspx?id=" + e.CommandArgument.ToString());
    ...
    {
        if (txtProductName.Text != "" || txtDateFrom.Text != "" || txtDateTo.Text != "")
        {
            BigpopMsg.Visible = false;
            filldata();
        }
        ...
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "Invalid", "showAlert('Error', 'Please provide some inputs to search the data !', 'error');", true);
            return;
        }
