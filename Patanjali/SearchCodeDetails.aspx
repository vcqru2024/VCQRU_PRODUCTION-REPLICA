<%@ Page Title="" Language="C#" MasterPageFile="~/Patanjali/pfl.master" AutoEventWireup="true" CodeFile="SearchCodeDetails.aspx.cs" Inherits="Patanjali_SearchCodeDetails" %>
                ...
                <div class="user-role-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col" style="display: none;">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ValidationGroup="abc"
                                        ...
                                        ViewStateMode="Enabled" ValidationExpression="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]">
                                ...
                                <div class="col">
                                    ...
                                    <asp:DropDownList ID="ddlproductFrom" runat="server" class="form-select"></asp:DropDownList>

                                </div>

                                <div class="col">
                                    <label for="Product Description" class="form-label">From Serial Code</label>

                                    <asp:TextBox ID="txtscrapfrom" CssClass="form-control" MaxLength="18" runat="server"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationGroup="abc"
                                        ControlToValidate="txtscrapfrom" ErrorMessage="ex: AA06-00-0001" Display="None"
                                        ViewStateMode="Enabled" ValidationExpression="[A-Z][A-Z][0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]">
                                    </asp:RegularExpressionValidator>
                                ...
                                <div class="col">
                                    <label for="Product Description" class="form-label">Batch Size</label>

                                    <asp:TextBox ID="txtbatchsize" MaxLength="5" CssClass="form-control" runat="server"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ValidationGroup="abc"
                                        ControlToValidate="txtbatchsize" ErrorMessage="ex: 123456" Display="None"
                                        ViewStateMode="Enabled" ValidationExpression="[0-9][0-9][0-9][0-9][0-9][0-9]">
                                    </asp:RegularExpressionValidator>

                                </div>

                                <div class="col">
                                    <label for="Product Description" class="form-label">Batch No.</label>

                                    <asp:TextBox ID="txtbatchnumber" MaxLength="7" CssClass="form-control" ValidationGroup="abc" runat="server"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ValidationGroup="abc"
                                        ControlToValidate="txtbatchnumber" ErrorMessage="ex: 1234567" Display="None"
                                        ViewStateMode="Enabled" ValidationExpression="[0-9][0-9][0-9][0-9][0-9][0-9][0-9]">
                                    </asp:RegularExpressionValidator>
                                ...
                                <div class="col" style="display: none;">
                                    ...
                                    <asp:TextBox ID="txtscrapto" OnTextChanged="txtscrapto_TextChanged" AutoPostBack="true" ReadOnly="true" CssClass="form-control" runat="server"></asp:TextBox>
                              ...
                              <div class="row">
                             <div class="col-md-3">
                                <label for="Dispatch Location" class="form-label">Manufacturing Date</label>
                                <asp:TextBox ID="txtDateFrom" placeholder="DD/MM/YYYY" runat="server" Text="" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="col-md-3">
                                <label for="Batch Size" class="form-label">Expiry Date</label>
                                <asp:TextBox ID="txtDateTo" placeholder="DD/MM/YYYY" runat="server" Text="" CssClass="form-control"></asp:TextBox>
                            ...
                            <!--  -->
                            <br />
                            <h4 class="mb-0">Total Available Code :<span>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-2">
                                    <asp:Button ID="btnSave" OnClick="btnSave_Click" ValidationGroup="chk94" class="btn btn-primary btn-sm"
                                        runat="server" Text="Request To Assign Codes" />
                                </div>
                            </div>
                            ...
                            <div class="app-table mt-2">
                                ...
                                <asp:TemplateField HeaderText="Exp. Date">
                                    ...
                                    <ItemStyle HorizontalAlign="Center" Width="6%" />
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                <headertemplate>
                                                    <input id="chkselecth" checked name="chkselecth" type="checkbox" onchange="checkAll(this.form,this.checked)" />
                                                </headertemplate>
                                                <itemtemplate>


                                                    <input id="chkselect" checked name="chkselect" type="checkbox" value='<%# Eval("SerialCode") %>' />
                              ...
                              <div class="app-table mt-2">
                             <div class="table-responsive">
                                    <asp:GridView ID="newgrd" runat="server" CssClass="table table-striped table-hover" EmptyDataText="Record Not Found"></asp:GridView>
                                </div>
                             </div>
            ...
            <asp:Panel ID="PanelForScrap" CssClass="shadow rounded-3 border border-2" runat="server" Width="30%" style="display: none; background-color: white; border: 1px solid grey; padding: 1rem;">
                <div class="popupContent" style="width: 100%;">
                    <div class="pop_log_bg">
                        <div class="text-end">
                            <asp:Button ID="btnCloseScrap" Text="Close" CssClass="popupClose btn btn-danger btn-sm" runat="server" CausesValidation="false" />
                        </div>
                            ...
                            <div class="row" style="gap: 1rem;">
                                <div class="col-12">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                        ValidationGroup="CHKSCR" InitialValue="--Select--" ControlToValidate="ddlProduct">
                                    ...
                                    <asp:HiddenField runat="server" ID="hdnbatchnumber" />
                                    <div>

                                        <p style="text-align: right; font-size: x-small;"><b>
                                            <asp:Label ID="lblseriesdetails" runat="server"></asp:Label>
                                        </b></p>
                                ...
                                <div class="col-12" style="display: none;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red"
                                        ValidationGroup="CHKSCR" InitialValue="--Select--" ControlToValidate="ddlbachno">
                                    </asp:RequiredFieldValidator>
