...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
     <script type="text/javascript">
         $(document).ready(function () {
             $('#username').on('keypress', validateForm);
             $('#userEmail').on('keypress', validateForm);
             $('#userMobile').on('keypress', validateForm);
         });
        function validateForm() {
            var username = document.getElementById('<%=username.ClientID %>').value;
            var userEmail = document.getElementById('<%=userEmail.ClientID %>').value;
            var userMobile = document.getElementById('<%=userMobile.ClientID %>').value;
            ...
            // Validate userEmail
            if (!whitespaceRegex.test(userEmail)) {
                alert("Email cannot contain whitespace.");
                return false;
            }

            // Validate userMobile
            if (!whitespaceRegex.test(userMobile)) {
                alert("Mobile number cannot contain whitespace.");
                return false;
            }
                ...
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../Patanjali/newuser.aspx">Our user</a></li>
                ...
                <div class="card-body">
                    <div class="row row-cols-xxl-3 row-cols-xl-3 row-cols-lg-3 row-cols-md-2 row-cols-1 g-3">
                        ...
                        <div class="col">
                            ...
                            <asp:TextBox runat="server" ID="userEmail" CssClass="form-control" TextMode="Email" MaxLength="50"
                        ...
                        <div class="col ms-auto text-end">
                            <a href="../Patanjali/newuser.aspx" class="btn btn-light px-3 border">Cancel</a>
