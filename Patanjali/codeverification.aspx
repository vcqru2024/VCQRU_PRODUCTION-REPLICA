<%@ Page Title="" Language="C#" MasterPageFile="~/Patanjali/pfl.master" AutoEventWireup="true" CodeFile="codeverification.aspx.cs" Inherits="Patanjali_codeverification" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-3">
                            <ul class="action-button-global">
                               ...
                               <%-- <li>
                                    <a href="../Patanjali/adduser.aspx" class="btn btn-sm btn-primary"><i class='bx bx-plus'></i>add</a>
                                </li>--%>
                            </ul>
                        </div>
                    </div>
