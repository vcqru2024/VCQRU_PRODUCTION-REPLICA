...
public partial class Patanjali_dashboard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                Bindcard(FromDate, ToDate);
                Bindchart(FromDate, ToDate);
                BindChart2(FromDate, ToDate);
                BindChart3(FromDate, ToDate);
                Bindchart4(FromDate, ToDate);
            }
            catch (Exception ex)
            {
    ...
    public void Bindcard(string FromDate, string ToDate)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("sp_getdataforchart_pfl", con);
    ...
    private void Bindchart(string FromDate, string ToDate)
    
    {

        DateTime Fdatetime = Convert.ToDateTime(FromDate);
        FromDate = Fdatetime.ToString("yyyy-MM-dd 00:00:00.000");
        DateTime Todatetime = Convert.ToDateTime(ToDate);
        ToDate = Todatetime.ToString("yyyy-MM-dd 23:59:59.000");

        SqlConnection con = new SqlConnection(SQL_DB.ConnectionString);
        try
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("GetSaleData_pfl", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Comp_id", Session["CompanyId"].ToString());
    ...
    private void BindChart2(string FromDate, string ToDate)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("sp_statewisecodecheck_pfl", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Comp_id", Session["CompanyId"].ToString());
            cmd.Parameters.AddWithValue("@fromdate", FromDate);
            cmd.Parameters.AddWithValue("@todate", ToDate);
    ...
    private void BindChart3(string FromDate, string ToDate)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("sp_getusercitywise_pfl", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Comp_id", Session["CompanyId"].ToString());
            cmd.Parameters.AddWithValue("@fromdate", FromDate);
            cmd.Parameters.AddWithValue("@todate", ToDate);
    ...
    private void Bindchart4(string FromDate, string ToDate)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("sp_Codedetails_productwise_pfl", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@comp_id", Session["CompanyId"].ToString());
            cmd.Parameters.AddWithValue("@fromdate", FromDate);
            cmd.Parameters.AddWithValue("@todate", ToDate);
    ...
    protected void btn_download_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                wb.Worksheets.Add(dt, "CheckedCodeUncheckedCode");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=CheckedCodeUncheckedCode.xlsx");
    ...
    protected void btnStatewiseCodeCheck_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(SQL_DB.ConnectionString);
                con.Open();
                SqlCommand cmd = new SqlCommand("USP_GetStateWiseStatusCount_PFL", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@companyid", Session["CompanyId"].ToString());
                cmd.Parameters.AddWithValue("@start_date", FromDate);
                cmd.Parameters.AddWithValue("@enq_date", ToDate);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                con.Close();
                XLWorkbook wb = new XLWorkbook();
                wb.Worksheets.Add(dt, "StatewiseCodecheckStatistics");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=StatewiseCodecheckStatistics.xlsx");
                Response.BinaryWrite(stream.ToArray());
                Response.End();
            }
            catch (Exception ex)
    ...
    protected void btnStatewise_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                con.Close();
                XLWorkbook wb = new XLWorkbook();
                wb.Worksheets.Add(dt, "StatewiseUsersStatistics");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=StatewiseUsersStatistics.xlsx");
                Response.BinaryWrite(stream.ToArray());
                Response.End();
            }
            catch (Exception ex)
    ...
    protected void btnCodecheckStatics_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(SQL_DB.ConnectionString);
                con.Open();
                SqlCommand cmd = new SqlCommand("sp_getConsumerdetails_PFL", con);
                cmd.CommandType = CommandType.StoredProcedure;
               ...
               // cmd.Parameters.AddWithValue("@todate", ToDate);
                ...
                con.Close();
                XLWorkbook wb = new XLWorkbook();
                wb.Worksheets.Add(dt, "CodeCheckProductSpecific");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=CodeCheckSProductSpecific.xlsx");
                Response.BinaryWrite(stream.ToArray());
                Response.End();
            }
            catch (Exception ex)
    ...
    protected void btnFilersChart_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(SQL_DB.ConnectionString);
                con.Open();
                SqlCommand cmd = new SqlCommand("USP_GetProductStatusCount_PFL", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@companyid", Session["CompanyId"].ToString());
                cmd.Parameters.AddWithValue("@start_date", FromDate);
                cmd.Parameters.AddWithValue("@enq_date", ToDate);
                ...
                con.Close();
                XLWorkbook wb = new XLWorkbook();
                wb.Worksheets.Add(dt, "CodeDetailsproductwise");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=CodeDetailsproductwise.xlsx");
                Response.BinaryWrite(stream.ToArray());
                Response.End();
            }
            catch (Exception ex)
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                con.Close();
                XLWorkbook wb = new XLWorkbook();
                wb.Worksheets.Add(dt, "CodeCheckHeatmap");
                MemoryStream stream = new MemoryStream();
                wb.SaveAs(stream);
                Response.Clear();
                Response.ContentType = "application/force-download";
                Response.AddHeader("content-disposition", "attachment;    filename=CodeCheckHeatmap.xlsx");
                Response.BinaryWrite(stream.ToArray());
                Response.End();
            }
            catch (Exception ex)
