...
public partial class Patanjali_frmPrintLabelRequest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../patanjali/loginpfl.aspx?Page=frmPrintLabelRequest.aspx");
        else
        {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                db.ExceptionLogs("Visited on Print Lable Request", Session["UserName"].ToString(), "R");
            }
            else
            {
                db.ExceptionLogs("Visited on Print Lable Request", Session["Comp_Name"].ToString(), "R");
            }
            #endregion
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        ...
        if (LabelCalText.Text == "RequestCancel")
        {
            ...
            if (Session["UserName"] != null)
            {
                db.ExceptionLogs("Canceled Lable Request by", Session["UserName"].ToString(), "U");
            }
            else
            {
                db.ExceptionLogs("Canceled Lable Request by", Session["Comp_Name"].ToString(), "U");
            }
            #endregion
        }
    }
