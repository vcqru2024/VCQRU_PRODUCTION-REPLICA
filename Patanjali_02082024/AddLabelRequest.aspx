<%@ Page Title="" Language="C#" MasterPageFile="~/Patanjali/pfl.master" AutoEventWireup="true" CodeFile="AddLabelRequest.aspx.cs" Inherits="Patanjali_AddLabelRequest" %>
                        ...
                        <form action="" novalidate class="needs-validation">
                            <div class="row row-cols-xxl-2 row-cols-xl-2 row-cols-lg-2 row-cols-md-2 row-cols-1 g-3">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldproductListValidator1" runat="server"
                                    InitialValue="--Select--" ErrorMessage="Please select a product" ForeColor="Red" ValidationGroup="reqlbl" ControlToValidate="ddlprotype"></asp:RequiredFieldValidator>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFdfvgieldValidator3" ErrorMessage="Please enter no. of label" runat="server" ValidationGroup="reqlbl"
