                                ...
                                <%
                                    ...
                                    if (dt != null && dt.Rows.Count > 0)
                                    {
                                        foreach (DataRow row in dt.Rows)
                                        {
                                            ...
                                            string formattedDate = ((DateTime)row["enquiry_date"]).ToString("yyyy-MM-dd HH:MM:ss");
                                            Response.Write("<td data-order='" + ((DateTime)row["enquiry_date"]).ToString("yyyy-MM-dd HH:MM:ss") + "'>" + formattedDate + "</td>");
