<%@ Page Title="" Language="C#" MasterPageFile="~/Patanjali/pfl.master" AutoEventWireup="true" CodeFile="statewisestatusreport.aspx.cs" Inherits="Patanjali_statewisestatusreport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="home-section">
        <div class="app-breadcrumb">
            <div class="row">
                <div class="col">
                    <h5>State Wise Status Count Report</h5>
                </div>
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../Patanjali/dashboard.aspx">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">State Wise Status Count</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="app-table">
                        <%
                            ...
                            if (dt != null && dt.Rows.Count > 0)
                            {
                                ...
                                Response.Write("<thead><tr><th>State</th><th>Success</th><th>Repeated</th><th>Counterfeit</th><th>Grand Total</th></tr></thead>");
