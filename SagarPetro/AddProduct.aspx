<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="Patanjali_AddProduct" %>
                ...
                <div class="card-body">
                    <form action="" novalidate class="needs-validation">
                        <div class="row row-cols-xxl-4 row-cols-xl-4 row-cols-lg-4 row-cols-md-2 row-cols-1 g-3">
                            ...
                            <div class="col">
                                <label for="Product Description" class="form-label">Product Description<span>*</span></label>
