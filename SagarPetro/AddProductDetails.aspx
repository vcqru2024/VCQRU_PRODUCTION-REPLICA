<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true"
    CodeFile="AddProductDetails.aspx.cs" Inherits="Patanjali_AddProductDetails" %>
            ...
            <div class="home-section">
                <div class="app-breadcrumb">
                    <div class="row row-cols-xxl-2 row-cols-xl-2 row-cols-lg-2 row-cols-md-2 row-cols-1 g-3">
                        <div class="col">
                            <h5>Add/Edit Product Details</h5>
                        </div>
                        <div class="col">
                            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.aspx">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="ProductDetails.aspx">Product Details</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add/Edit Product Details</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" novalidate class="needs-validation">
                                ...
                                <asp:Label ID="lblCompPassText" runat="server" Text="" Font-Size="12px" ForeColor="Red">
                                </asp:Label>

                                <div
                                    class="row row-cols-xxl-3 row-cols-xl-3 row-cols-lg-3 row-cols-md-2 row-cols-1">
                                    <div class="col">
                                        <label for="Select Service" class="form-label">Product
                                    ...
                                    <div class="col">
                                        <label for="" class="form-label">No. Of Available Codes<span>*</span></label>
                                    ...
                                    <div class="col">
                                        <label for="" class="form-label">Batch No<span>*</span></label>
                                        <asp:TextBox ID="txtBatchNo" MaxLength="10" CssClass="form-control "
                                            runat="server" onchange="CheckBatch_NoVal(this.value)"></asp:TextBox>
                                    ...
                                    <div class="col">
                                        <label for="" class="form-label">MRP<span>*</span></label>
                                        <asp:TextBox ID="txtMRP" CssClass="form-control " runat="server" MaxLength="7"
                                    ...
                                    <div class="col">
                                        <label for="" class="form-label">Mfd Date<span>*</span></label>
                                        <asp:TextBox ID="txtMfd_Date" MaxLength="50" CssClass="form-control "
                                    ...
                                    <div class="col">
                                        <label for="" class="form-label">Exp Date<span>*</span></label>
                                        <asp:TextBox ID="txtExp_Date" MaxLength="50"
                                            onchange="checkproduct(this.value);" CssClass="form-control "
                                            runat="server"></asp:TextBox>
                                        <asp:CompareValidator ID="CompareValidator2" runat="server"
                                            ValidationGroup="PRO" ControlToCompare="txtMfd_Date"
                                            ControlToValidate="txtExp_Date" ForeColor="Red" Type="Date"
                                            Operator="GreaterThan" ErrorMessage="Exp Date is greater than Mfd Date.">
                                        </asp:CompareValidator>
                                        <div class="invalid-feedback">Enter valid email.</div>
                                    </div>
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-12">
                                        <label for="" class="form-label">Your Batch Size<span>*</span>[<asp:Label ID="lblbatchsize" runat="server"
                                        ...
                                        <div class="form-row" style="display:none;">
                                            <div class="form-group col-lg-3">
                                                ...
                                                <asp:TextBox runat="server"
                                                    onkeypress="return isNumberKey(this, event);" MaxLength="2"
                                                    ID="txtWarr" CssClass="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-row" style="display:none;">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6"
                                                    ...
                                                    ControlToValidate="txtNoOfCodes"></asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <asp:TextBox ID="txtNoOfCodes" MaxLength="6" Width="91%"
                                                        ...
                                                        CssClass="textbox_pop" runat="server" ReadOnly="true">
                                                    </asp:TextBox>

                                                    <asp:CompareValidator ID="CompareValidator1" runat="server"
                                                        ValidationGroup="PRO" ForeColor="Red"
                                                        ControlToCompare="txtMfd_Date" ControlToValidate="txtExp_Date"
                                                        Operator="GreaterThanEqual" Type="Date"
                                                        Text="Exp date must be Greater.."></asp:CompareValidator>
...
<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12">
    <p class="mb-0 text-danger">Please paste Labels batch wise at a time in sequence
        of series
        no.</p>
</div>
<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12 text-end">
    ...
    <asp:Button ID="btnReset" OnClick="btnReset_Click"
        class="btn btn-light border" runat="server" Text="Cancel" />
