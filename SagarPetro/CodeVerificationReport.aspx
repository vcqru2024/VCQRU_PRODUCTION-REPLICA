<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true" CodeFile="CodeVerificationReport.aspx.cs" Inherits="Patanjali_CodeVerificationReport" %>
                    ...
                    <div class="row">
                        <%-- <div class="col-12 col-md-4 mb-3">
                          ...
                          <div class="col col-md-3 mb-2">
                            ...
                            <div class="col col-md-3 mb-2">
                                  <button runat="server" onclick="downloadGridData('CodeVerificationReport')"
                                ...
                                <%
                                    ...
                                    if (dt != null && dt.Rows.Count > 0)
                                    {
                                        foreach (DataRow row in dt.Rows)
                                        {
                                            ...
                                            string formattedDate = ((DateTime)row["enq_date"]).ToString("yyyy-MM-dd HH:MM:ss");
                                            Response.Write("<td data-order='" + ((DateTime)row["enq_date"]).ToString("yyyy-MM-dd HH:MM:ss") + "'>" + formattedDate + "</td>");
                                            Response.Write("<td>" + row["Pro_name"] + "</td>");
                                            Response.Write("<td>" + row["Completecode"] + "</td>");
                                            Response.Write("<td>" + row["Status"] + "</td>");
                                            Response.Write("<td>" + row["MobileNo"] + "</td>");
                                            Response.Write("<td>" + row["modeofenq"] + "</td>");
                                            Response.Write("<td>" + row["Amount_Won"] + "</td>");
                                            Response.Write("<td>" + row["Bank_Name"] + "</td>");
                                            Response.Write("<td>" + row["Account_HolderNm"] + "</td>");
                                            Response.Write("<td>" + row["Account_No"] + "</td>");
                                            Response.Write("<td>" + row["Branch"] + "</td>");
