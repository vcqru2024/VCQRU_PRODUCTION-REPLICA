<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true" CodeFile="FrmLabelDispatch.aspx.cs" Inherits="Patanjali_FrmLabelDispatch" %>
            ...
            <div class="user-role-card">
                ...
                <p>
                    <asp:Label ID="lblmsgHeader" runat="server"></asp:Label><asp:HiddenField ID="hdCompanyNm"
                        ...
                        <div class="row">
                            	<div class="col-lg-8">
													<h5 >Record's Found :<span> <asp:Label ID="lblcount" runat="server"></asp:Label></span></h5>
												</div>
                                                <div class="col-lg-2">
                        ...
                        DataKeyNames="Flag" CssClass="table table-hover table-bordered" EmptyDataText="Record Not Found" 
                                        ...
                                        <td colspan="90%" >
                                            <div id="div<%# Eval("Courier_Disp_ID") %>" style="display: none; position: relative;
                                                ...
                                                <fieldset class="Newfield Newfield_width2">
                                                    <legend class="fs-5">Product Wise Label information</legend>
                                                    <div style="padding-left: 5px; width: 98.5%;">
                                                        <asp:GridView ID="GrdLablelDet" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
