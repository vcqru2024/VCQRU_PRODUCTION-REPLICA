...
public partial class SagarPetro_Instantpayout : System.Web.UI.Page
{
    public int str = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        txtmob.Attributes.Add("onkeydown", "return (event.keyCode!=13);");
        txtDateFrom.Attributes.Add("onkeydown", "return (event.keyCode!=13);");
        txtDateto.Attributes.Add("onkeydown", "return (event.keyCode!=13);");
    ...
    private void FillGrdDetails()
    {
        ...
        DataSet ds = SQL_DB.ExecuteDataSet("exec GetInstantpayoutrpt '" + Session["CompanyId"].ToString() + "','" + mob + "','" + datefrom + "','" + dateTo + "'");
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                SuccessCode = Convert.ToInt32(dt.Compute("Count(ConsumerName)", "BankStatus ='ACCEPTED' or FinalStatus='SUCCESS'"));
                ...
                if (SuccessCode > 0)
                    SuccessAmount = Convert.ToDecimal(dt.Compute("SUM(Amount)", "BankStatus ='ACCEPTED' or FinalStatus='SUCCESS'"));
                if (FailureCode > 0)
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = SQL_DB.ExecuteDataSet("exec GetInstantpayoutrpt '" + Session["CompanyId"].ToString() + "','" + mob + "','" + dtfrom.ToString() + "','" + dtTo.ToString() + "'");
