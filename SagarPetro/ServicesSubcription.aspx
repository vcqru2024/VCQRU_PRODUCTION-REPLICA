<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true"
    CodeFile="ServicesSubcription.aspx.cs" Inherits="Partner_ServicesSubcription" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="home-section">
                <div class="app-breadcrumb">
                    <div class="row">
                        <div class="col">
                            <h5>Master Service Subscription</h5>
                        </div>
                        <div class="col">
                            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../SagarPetro/dashboard.aspx">Dashboard</a></li>
                                    <%--<li class="breadcrumb-item"><a href="#">Services setting</a></li>--%>
                                        <li class="breadcrumb-item active" aria-current="page">Master Service
                                            Subscription</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="row" id="NewMsgpop" runat="server">
                        <p>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col col-md-4 mb-3">
                                    <div class="global-search">
                                        <div class="form-group ">
                                            <input type="search" onkeyup="performSearch(this.value)"
                                ...
                                <div class="col mb-3">
                                    <ul class="action-button-global">
                                        ...
                                        <li>
                                            <a href="AddServiceSubscription.aspx" class="btn btn-sm btn-primary"><i
                                                    class='bx bx-plus'></i>Add/Subscribe Service</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <asp:TextBox ID="txtDateTo" runat="server" Text="" CssClass="reg_txt"
                                        Visible="false"></asp:TextBox>
                                    <asp:TextBox ID="txtDateFrom" runat="server" Text="" CssClass="reg_txt"
                                        Visible="false"></asp:TextBox>
                                ...
                                <div class="col">
                                    <asp:Button ID="btnSearch" style="margin-top:9%;" OnClick="btnSearch_Click"
                                        ValidationGroup="chk94" class="btn btn-primary" runat="server" Text="Search" />

                                    <asp:Button ID="btnRefresh" style="margin-top:9%;" OnClick="btnRefresh_Click"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <h5>Record's Found :<asp:Label ID="lblcount" runat="server"></asp:Label></h5>
                                </div>
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-2">
                                    <asp:DropDownList ID="ddlRowProductCnt" runat="server" Visible="false"
                            ...
                            <div class="app-table mt-2">
                                <div class="table-responsive">
                                    <asp:GridView ID="GrdProductMaster" runat="server" AutoGenerateColumns="False"
                                        ...
                                        EmptyDataText="Record Not Found" DataKeyNames="IsAdminVerify"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Product Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpronamesrv" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="Service Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbladdsrvnamesrv" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="Plan Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblsrvplanname" runat="server"
                                            ...
                                            <asp:TemplateField HeaderText="Date From">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldtfrmsrv" runat="server"
                                                        Text='<%# Bind("DateFrom","{0:ddd, MMM d, yyyy}") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />--%>
                                                <ItemStyle />
                                            ...
                                            <asp:TemplateField HeaderText="Date To">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbldtttosrv" runat="server"
                                                        Text='<%# Bind("DateTo","{0:ddd, MMM d, yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />--%>
                                                <ItemStyle />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Status">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblsrvstst" runat="server"
                                                        Text='<%# Convert.ToInt32(Eval("IsAdminVerify")) == 0 ? "Pending" : Convert.ToInt32(Eval("IsActive")) == 1 ? "Activated" : "De-Activated"  %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />--%>
                                                <ItemStyle  />
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgBtnLoyalty" runat="server"
                                                        ...
                                                        CommandArgument='<%#Bind("Subscribe_Id") %>'
                                                        CommandName="ServiceEdit" ImageUrl="~/Content/images/edit.png"
                ...
                <%-- <h4>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="bord_right">
                                Record(s) found <span class="small_font">(<asp:Label ID="" runat="server"></asp:Label>
                                    )</span>
                            </td>
                                    ...
                                    <table cellpadding="0px" cellspacing="10px" width="100%" class="grid"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <asp:RequiredFieldValidator ID="RFVPro" runat="server" ForeColor="Red"
                                                    ValidationGroup="SRVS" InitialValue="--Select--"
                                        ...
                                        <tr id="divispoints" runat="server">
                                            <td style="width: 30%; text-align: right;">
                                                ...
                                                <asp:RequiredFieldValidator ID="RFVIsPoints" runat="server"
                                        ...
                                        <tr id="divisdaterange" runat="server">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtloyaltydtfrom" Width="120px" CssClass="reg_txt"
                                                    runat="server" placeholder="Date From.."
                                                    onchange="javascript:CheckDate(this.value);"></asp:TextBox>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td align="right" style="width: 27%;">
                                                                <asp:RequiredFieldValidator ID="RFVIsMessage"
                                                                    runat="server" ForeColor="Red" ValidationGroup="NN"
                                                        ...
                                                        <tr>
                                                            <td style="width: 23%; text-align: right;">
                                                                <asp:RequiredFieldValidator ID="RFVIsSoundH"
                                                                    runat="server" ForeColor="Red" ValidationGroup="NN"
                                                        ...
                                                        <tr>
                                                            <td align="right" style="width: 10%">
                                                                <asp:RequiredFieldValidator ID="RFVIsSoundE"
                                                                    runat="server" ForeColor="Red" ValidationGroup="NN"
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                ...
                                                                <asp:Label ID="Label11"
                                                                    Style="font-family: Arial; font-size: 12px; color: red;"
                                                                    runat="server" Text="File Type ---- .wav">
                                                                </asp:Label>
                                                                <br />
                                        ...
                                        <tr>
                                            <td align="center" colspan="4">
                                                <asp:Button ID="btnSave" runat="server" CssClass="button_all"
                                                    OnClick="btnAddServices_Click" ValidationGroup="SRVS" Text="OK" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    <cc1:ModalPopupExtender ID="ModalPopupLoyalty" runat="server"
                        BackgroundCssClass="NewmodalBackground" PopupControlID="AddLoyaltyPanel"
                        TargetControlID="LblTargetLoyalty" CancelControlID="btncloseloyalty">
                    ...
                    <cc1:ModalPopupExtender ID="ModalPopupExtenderAlert" runat="server"
                        ...
                        TargetControlID="lbltestcontrol" CancelControlID="btnclosealerttest">
                    </cc1:ModalPopupExtender>
                        ...
                        <div class="popupContent" style="width: 100%;">
                            <div class="pop_log_bg">
                                ...
                                <div class="service_head_p">
                                    <p>
                                        <span class="left">
                                            <asp:Label ID="lblplgrw" runat="server" Font-Bold="true"
                                                Text="Plan Details"></asp:Label>
                                        </span>
                                    </p>
                                </div>
                                <div class="regis_popup">
                                    ...
                                    <table width="100%" cellpadding="0px" cellspacing="5px">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:GridView ID="PlanGridViewDetails" runat="server"
                                                    ...
                                                    BorderWidth="0" BorderColor="transparent" AllowPaging="True"
                                                        ...
                                                        <asp:TemplateField HeaderText="Action">
                                                            <ItemTemplate>
                                                                <%try {
                                                                    ...
                                                                    (Session["Plan_ID"].ToString()==PlanID) { Disp=1; if
                                                                    (Disp==0) { %>
                                                            ...
                                                            <%--<asp:TemplateField HeaderText="Action">
                                                                <ItemTemplate>
                                                                    <asp:Button ID="ImgbtnRedeem" runat="server"
                                                                        ...
                                                                        CausesValidation="false"
                                                                        CommandName="BuyService" ToolTip="Redeem Awards"
                                                                        Text="Buy Now" CssClass="redeem" />&nbsp;
                                                                </ItemTemplate>
                                                                <HeaderStyle CssClass="tr_haed"
                                                                    HorizontalAlign="Justify" />
                                                                <ItemStyle HorizontalAlign="Justify" CssClass="grd_pad"
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:CheckBox ID="chkterms" runat="server" Text="Terms & Conditions "
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:Button ID="btnAmcRenewal" ValidationGroup="SSP" runat="server"
                                                    Text="Submit" OnClick="Submit_Click" CssClass="button_all_Sec" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    <cc1:ModalPopupExtender ID="ModalPopupExtenderGridView" runat="server"
                        BackgroundCssClass="NewmodalBackground" PopupControlID="PlanGridView"
                        TargetControlID="lblctrlplgrw" CancelControlID="btnplgrw">
                    </cc1:ModalPopupExtender>
