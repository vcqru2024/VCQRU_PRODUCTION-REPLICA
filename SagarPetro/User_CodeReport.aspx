<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true" CodeFile="User_CodeReport.aspx.cs" Inherits="Patanjali_User_CodeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
         <div class="home-section">
            <div class="app-breadcrumb">
                <div class="row">
                    <div class="col">
                        <h5>User and Code Overview Report</h5>
                    </div>
                    <div class="col">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                               <li class="breadcrumb-item"><a href="../SagarPetro/dashboard.aspx">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">User and Code Overview Report</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="app-table">
                            <%
                                ...
                                if (dt != null && dt.Rows.Count > 0)
                                {
                                    ...
                                    Response.Write("<thead><tr><th>Month Name</th><th>Number of Code Checked</th><th>Number of Users</th></tr></thead>");
                                    ...
                                    foreach (DataRow row in dt.Rows)
                                    {
                                        ...
                                        Response.Write("<td>" + row["Month Name"] + "</td>");
                                        Response.Write("<td>" + row["Number of Code Checked"] + "</td>");
                                        Response.Write("<td>" + row["Number of Users"] + "</td>");
                                        //Response.Write("<td>" + row["Code1"] + "</td>");
                                        //Response.Write("<td>" + row["Code2"] + "</td>");
