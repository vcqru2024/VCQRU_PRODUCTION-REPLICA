...
public partial class Patanjali_adduser : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["CompanyId"] == null)
            Response.Redirect("../SagarPetro/Loginpfl.aspx?From=adduser");
        if (!IsPostBack)
        {
            #region User Log 
    ...
    public void BindReport(int roleId)
    {
        ...
        BindMenuItems(roleId, "4", ChkReport);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (btnSubmit.Text == "Update")
        {
            ...
            DataTable dtget = SQL_DB.ExecuteDataTable("Select MenuId,Status from tbl_pflUsercontrol where UserRole_Id = @UserRoleID", new SqlParameter("@UserRoleID", UserRoleID));
        ...
        else // Registration Process for Patanjali Users
        {
            ...
            {
                Response.Redirect("../SagarPetro/newuser.aspx?msg=Success");
            }
            else
            {
