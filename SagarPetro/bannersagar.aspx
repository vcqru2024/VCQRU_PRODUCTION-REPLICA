<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true" CodeFile="bannersagar.aspx.cs" Inherits="SagarPetro_bannersagar" %>
            ...
            <div class="col-lg-12">
                <div class="card card-admin form-wizard profile box_card">
                    <header class="card-header">
                        <h4 class="card-title"><i class="fa fa-plus-square-o"></i>
                            <asp:Label ID="lblheading" runat="server" Text="Add Banner" Font-Bold="true"></asp:Label></h4>
                    </header>
                    ...
                    <div class="card-body card-body-nopadding">
                        <div id="newmsg" runat="server">
                            <p>
                                <br />
                                <a href="uploadbanner.aspx" class="btn btn-primary">Add Banner</a>
                            </p>
                        </div>
                        <h6>Banner Info</h6>
                        <div class="col-lg-12">
