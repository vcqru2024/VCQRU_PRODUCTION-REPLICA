<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true" CodeFile="codestatus.aspx.cs" Inherits="Patanjali_codestatus" %>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card bg-info divtgcc" id="divtgc" style="height: 114px; background-color:#00bcfe !important;">
                <div class="card-body text-center">
                    <asp:Lablel runat="server">Generated Codes</asp:Lablel><br />
