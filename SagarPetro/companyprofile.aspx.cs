...
public partial class Patanjali_companyprofile : System.Web.UI.Page
{
    ...
    protected void btnVerifyOTP_Click(object sender, EventArgs e)
    {
        ...
        string str = String.Format("https://api2.vcqru.com/api/ValidateAadharOTPForVendor");
    ...
    protected void Imageaadharverify_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string str = String.Format("https://api2.vcqru.com/api/SendAadharOTPForVendor");
        WebRequest request = WebRequest.Create(str);
        request.Method = "POST";
    ...
    protected void Imgpanverify_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string str = String.Format("https://api2.vcqru.com/api/VendorPancardVerificatioin");
        WebRequest request = WebRequest.Create(str);
        request.Method = "POST";
    ...
    protected void lnkgstverify_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string str = String.Format("https://api2.vcqru.com/api/VendorGSTVerification");
        WebRequest request = WebRequest.Create(str);
        request.Method = "POST";
