...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="../SagarPetro/assets/css/css.css">
    <link rel="stylesheet" href="../SagarPetro/assets/css/reponsive.css">
    <!-- font family -->
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == "Password Send On Registered Email Id") {
                        showAlert('Success', data, 'success',"../SagarPetro/Loginpfl.aspx");
                    }
                    else {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="patanjaliayurved">
                                <img src="../SagarPetro/assets/img/logo.svg" alt="logo" class="patanjali-logo">
                            </div>
