<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true" CodeFile="statewisestatusreport.aspx.cs" Inherits="Patanjali_statewisestatusreport" %>
                    ...
                    <div class="app-table">
                        <%
                            ...
                            if (dt != null && dt.Rows.Count > 0)
                            {
                                ...
                                Response.Write("<thead><tr><th>State</th><th>Success</th><th>Unsuccess</th><th>Grand Total</th></tr></thead>");
                                ...
                                foreach (DataRow row in dt.Rows)
                                {
                                    ...
                                    Response.Write("<td>" + row["Total"] + "</td>");
