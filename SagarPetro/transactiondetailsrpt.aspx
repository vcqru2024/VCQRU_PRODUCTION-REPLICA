<%@ Page Title="" Language="C#" MasterPageFile="~/SagarPetro/pfl.master" AutoEventWireup="true"
    CodeFile="transactiondetailsrpt.aspx.cs" Inherits="SagarPetro_transactiondetailsrpt" %>
                        ...
                        <div class="col">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Transaction Summry Report
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row row-cols-xxl-5 row-cols-xxl-5 row-cols-lg-5 row-cols-md-3 row-cols-1 g-3">
                                ...
                                <div class="col">
                                    ...
                                    <button onclick="downloadGridData('Transaction Summary')" class="btn btn-primary">
                                        <i class="fas fa-file-csv"></i>
                                    </button>
                                </div>
                                <!-- <div class="col" runat="server">
                                    <button onclick="downloadGridData()" class="btn btn-primary">
                                        <i class="fas fa-file-csv"></i>
                                    </button>
                                </div> -->
                            </div>
                                            ...
                                            <asp:Repeater runat="server" ID="rptData">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%# Eval("Total Transactions Amount") %>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
