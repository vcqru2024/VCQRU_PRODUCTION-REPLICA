<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BrandLoyaltyAwards.ascx.cs" Inherits="UserControl_BrandLoyaltyAwards" %>
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
            ...
            <asp:UpdateProgress ID="UpdateProgress1"  runat="server"
                ...
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o">Awards Master</i></h4>
