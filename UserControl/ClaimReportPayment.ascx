<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ClaimReportPayment.ascx.cs" Inherits="UserControl_ClaimReportPayment" %>
       ...
       <%-- if ($('#<%=ddlStatus .ClientID %> option:selected').val() == "1") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var updatstStr = "";
                    if (data == "1") {
                        updatstStr = "Claim Approved succesfully!";
                    } else if (data == "2") {
                        updatstStr = "Claim Rejected succesfully!";
                    } else {
                        updatstStr = data;
                    }
                    alert(updatstStr);
