<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ClaimReportVendor.ascx.cs" Inherits="UserControl_Wrv" %>
     ...
     <asp:HiddenField ID="key" runat="server" Value='<%#Eval("ID") %>' />
                                ...
                                <asp:TemplateField HeaderText=" Mobile No">
                                 ...
                                 <asp:TemplateField HeaderText="Points">
                                    <ItemTemplate>
                                       <asp:Label ID="points" runat="server" Text='<%# Bind("Points_Redeemed") %>'></asp:Label>
                                    </ItemTemplate>
                                    <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />--%>
                                    <ItemStyle HorizontalAlign="Justify" Width="10%" />
                                </asp:TemplateField>
				                ...
				                <asp:TemplateField HeaderText="Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lblpnamepoints" runat="server" Text='<%# Bind("Amount") %>'></asp:Label>
                                    </ItemTemplate>
                                    <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />--%>
                                    <ItemStyle HorizontalAlign="Justify" Width="10%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Gifts">
                                    <ItemTemplate>
                                        <asp:Label ID="lblgifts" runat="server" Text='<%# Bind("Gifts_Redeemed") %>'></asp:Label>
                                    </ItemTemplate>
                                    <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Justify" />--%>
                                    <ItemStyle HorizontalAlign="Justify" Width="10%" />
                                </asp:TemplateField>
