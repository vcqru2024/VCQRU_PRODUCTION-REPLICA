...
public partial class UserControl_Wrv : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       if (Session["CompanyId"] == null)
            Response.Redirect("index.html?Page=ClaimReportVendor.aspx");
        else
        {
    ...
    private void FillGrdLoyaltyAwards(string email)
    {
        ...
        if (Session["CompanyId"].ToString() == "Comp-1709" || Session["CompanyId"].ToString() == "Comp-1466" || Session["CompanyId"].ToString() == "Comp-1597" || Session["CompanyId"].ToString() == "Comp-1483" || Session["CompanyId"].ToString() == "Comp-1548")
        {
             GrdAwards.Columns[4].Visible = false;
        }

		
		if (Session["CompanyId"].ToString() != "Comp-1400")
        {
            // GrdAwards.Columns[6].Visible = false;
			 //GrdAwards.Columns[7].Visible = false;
			 //GrdAwards.Columns[8].Visible = false;

            GrdAwards.Columns[8].Visible = false;
            GrdAwards.Columns[11].Visible = false;
            GrdAwards.Columns[12].Visible = false;
            GrdAwards.Columns[13].Visible = false;
            GrdAwards.Columns[14].Visible = false;
            GrdAwards.Columns[15].Visible = false;
            GrdAwards.Columns[16].Visible = false;
            GrdAwards.Columns[17].Visible = false;
            GrdAwards.Columns[18].Visible = false;
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        try
        {
            DataSet ds = Warranty.GetClaimDetailVendor_download(Session["CompanyId"].ToString());
