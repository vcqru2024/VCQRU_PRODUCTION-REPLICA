<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ClaimTransactionrpt.ascx.cs" Inherits="UserControl_ClaimTransactionrpt" %>
         ...
         <div class="container-fluid xyz">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Point Claim Report</h4>
                            </header>
