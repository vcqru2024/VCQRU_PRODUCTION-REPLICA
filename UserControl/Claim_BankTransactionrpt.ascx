<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Claim_BankTransactionrpt.ascx.cs" Inherits="UserControl_Claim_BankTransactionrpt" %>
         ...
         <div class="container-fluid xyz">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Bank Transaction Report</h4>
                            </header>
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Date">
                            <ItemTemplate>
                                <asp:Label ID="lblentrydate" runat="server" Text='<%# Bind("TxnDate") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Sum Of Amount">
                            <ItemTemplate>
                                <asp:Label ID="lblSumOfAmount" runat="server" Text='<%# Bind("SumOfAmount") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Txn ID">
                            <ItemTemplate>
                                <asp:Label ID="lblSumOfAmount" runat="server" Text='<%# Bind("TxnID") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <asp:Label ID="lblsize2" runat="server" Text='<%# Bind("PaymentStatus") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
