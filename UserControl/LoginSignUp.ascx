<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LoginSignUp.ascx.cs" Inherits="UserControl_LoginSignUp" %>
...
<section class="login-content">
    <div class="logo">
<br/>
        <h1 style="font-family: Publica Sans Medium, sans-serif;">Welcome User</h1>
    </div>
    <div class="row w-100">
        <div class="col-sm-6">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="../NewContent/img-home/anti-counterfeit.jpg" alt="First slide">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../NewContent/img-home/build loyalty.jpg" alt="Second slide">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../NewContent/img-home/E-warranty.jpg" alt="Third slide">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../NewContent/img-home/cash-transfer2.jpg" alt="Third slide">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../NewContent/img-home/Patent pending technology.jpg" alt="Third slide">
                        <p>Innovation on Peak - VCQRU is a Patents Pending Company, Changing the Game with Our Groundbreaking Technology.</p>
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../NewContent/img-home/Digital-marketing.jpg" alt="Third slide">
                        <p>Digital Marketing - VCQRU is one of the leading digital marketing company in PAN India, we provide the best digital marketing services to clients and helps them to get their ROI.</p>
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../NewContent/img-home/web-design-development.jpg" alt="Third slide">
                        <p>Web Design and Development - VCQRU is a leading web design and development company in India. We have a team of professionals who are working on innovative, creative, and effective websites.</p>
                    </div>
