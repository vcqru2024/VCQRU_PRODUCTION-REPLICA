<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RedeemHistory.ascx.cs" Inherits="UserControl_UC_RedeemHistory" %>
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Cash Details</h4>
                            </header>
            <div id="newMsg" runat="server" style="width: 91%;">
                ...
                <div class="card-body card-body-nopadding">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-lg-6">
                            <asp:Button ID="btnTransferCash"  CssClass="btn btn-primary float-right mb-0" runat="server" Text="Yes"  OnClientClick="return confirm('Are you sure about cash is trnsfered for selected item.');"   OnClick="btnTransferCash_Click" />
                             </div>
                        </div>
                      </div>
