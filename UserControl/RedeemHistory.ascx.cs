...
public partial class UserControl_UC_RedeemHistory : System.Web.UI.UserControl
{
    ...
    private void FillGrdPointsDetails()
    {
        ...
        DataSet ds = ExecuteNonQueryAndDatatable.FillGrdForRedeem(ddlProduct.SelectedValue, ddlCompany.SelectedValue, dtfrom,
            dtTo, "", 0, "cashtransfer", "referral", "cash",1);
