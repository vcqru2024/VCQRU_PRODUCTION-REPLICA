<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RedeemHistoryBill.ascx.cs" Inherits="UserControl_UC_RedeemHistoryBill" %>
...
<style>
 ...
 <script type="text/javascript">
        ...
        <%--function CheckScrap1(ItemIndex) {
             
            <%# GrdLabel.Rows[iterindex].Cells[0]%>
            $('#smallModalA').modal();
            return false;
        }--%>
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Adjust In Next Billing (Referral Service)</h4>
                            </header>
            <div id="newMsg" runat="server" style="width: 91%;">
                ...
                <div class="card-body card-body-nopadding">
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-3">
                         ...
                         <div class="form-group col-lg-3">
                            <asp:TextBox runat="server" ID="txtTranid" CssClass="form-control form-control-sm" placeholder="Transaction Id"/>
                        </div>
                        <div class="form-group col-lg-3">
                            <asp:TextBox runat="server" ID="txtMobileno1" CssClass="form-control form-control-sm" placeholder="Mobile No"/>
                        </div>
                        <div class="form-group col-lg-3">
                    ...
                    <div class="form-row">
                     ...
                     <div class="form-row">
                        <div class="form-group col-lg-12">
                            <span style="color:green;" ><b>Note :  Billing amount should be greater than claiming amount</b></span>
                            </div>
                         </div>
                    ...
                    <div class="card-admin form-wizard medias">
                     <div class="row pb-2 pt-2 background-section-form">
                                                ...
                                                <div class="col-lg-4">
                                                      <asp:Label ID="lblToatalCashPoints" runat="server" Visible="false"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label
                                    ID="lblToatalPoints" runat="server" Visible="false"></asp:Label>
                                                    <asp:Button Text="Give bank details to transfer cash" ID="btnRedem" CssClass="button_all"  runat="server" OnClick="btnRedem_Click" Visible="false"  />
                                                    <asp:Label Text="" runat="server"  ID="lblAvailablePoints" style="font-size: 13px; font-weight: bold;"  Visible="false" />
                                                </div>
												<div class="col-lg-2">
                                                     <asp:ImageButton ID="ImageButton1" Visible="false" OnClick="btnSave_Click" ImageUrl="~/Content/images/SaveNew.png"
             ...
             <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                   EmptyDataText="Record Not Found"  DataKeyNames="PointAdjustStatus"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="S.No.">
                         ...
                         <asp:TemplateField HeaderText="TranId/ UniqueId">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblBLoyalty_PointEarnedID" runat="server" Text='<%# "TRAN"+Eval("Transsctionid") %>' Visible="true"></asp:Label>
                               
                                </ItemTemplate>
                              
                                <ItemStyle HorizontalAlign="Justify" CssClass="grd_pad" Width="1%" />
                            </asp:TemplateField>
                        <asp:TemplateField HeaderText="User">
                            <ItemTemplate>
                                <asp:Label ID="lblentrydate" runat="server" Text='<%# Bind("ConsumMobile") %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />--%>
                            <ItemStyle HorizontalAlign="Left" Width="10%" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="1Rs=4Points (TotalPoints)">
                            <ItemTemplate>
                              Rs<asp:Label ID="lblCash" runat="server" Text='<%# Eval("CashInRs") %>'></asp:Label><br />
                                (<asp:Label ID="lblname" runat="server" Text='<%# Eval("RedeemPoints") %>'></asp:Label> Points)
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />--%>
                        ...
                        <%--<asp:TemplateField>
                            ...
                            <HeaderTemplate>                                
                                <asp:Label Text="4Points=1Rs" runat="server" ID="PoininRs" />
                            </HeaderTemplate>
                        ...
                        <asp:TemplateField HeaderText="Company">
                            <ItemTemplate>
                                 <a href='PointDetails_Product.aspx?Cid=<%# Eval("Comp_ID")%>' title="view in details earned points" target="_blank">
                                    <asp:Label ID="lblsize2" runat="server" Text='<%# Eval("Comp_Name") %>'></asp:Label></a>
                                <%--<asp:LinkButton ID="" runat="server" target="_blank" Text='<%# Bind("Comp_Name") %>'></asp:LinkButton>--%>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />--%>
                            <ItemStyle HorizontalAlign="Left" Width="5%" />                           
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Next BillNo/13 digitcode">
                            <ItemTemplate>
                                  <%
                                      try
                                      {

                                           vl = Convert.ToInt32(GrdLabel.DataKeys[str-1].Values["PointAdjustStatus"].ToString());
                                          if (vl==0)
                                          {  %>
                                                <asp:TextBox ID="lblsizeMobileNo" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                          <% }
                                          else
                                          {  %>
                                <asp:Label Text='<%#Eval("NextBillNo") %>' ID="lblNextBillNo" runat="server" />
                                           <%}
                                      }
                                      catch
                                      {
                         ...
                         <asp:TemplateField HeaderText="Next Bill Amount(Rs)">
                            <ItemTemplate>
                                 <%
                                      try
                                      {
                                          ...
                                          if (vl==0)
                                          {  %>
                                                 <asp:TextBox ID="lblNextBillingAmount" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                          <% }
                                          else
                                          {  %>
                                <asp:Label Text='<%#Eval("NextBillingAmount") %>' ID="lblNextBillingAmount1" runat="server" />
                                           <%}
                                      }
                                      catch
                                      {
                            ...
                            <ItemTemplate>
                                <%
                                      try
                                      {
                                          ...
                                          if (vl==0)
                                          {  %>
                                                 <asp:Button ID="lblsizeBank_Name" runat="server" Text="Submit" CommandName="BillSave" CssClass="btn btn-primary float-right mb-0"
                                   OnClientClick="return confirm('Are you sure you want to adjust redeem points?');"
                                    CommandArgument='<%# Eval("BPointsTransactionid") +","+ Container.DataItemIndex.ToString() %>'></asp:Button>
                                          <% }
                                          else
                                          {  %>
                                <%--<asp:Label Text='<%#Eval("NextBillNo") %>' ID="lblNextBillNo" runat="server" />--%>
                         ...
                         <%-- <asp:TemplateField HeaderText="Acc Holder">
                            <ItemTemplate>
                                <asp:Label ID="lblsizeAccount_HolderNm" runat="server" Text='<%# Bind("Account_HolderNm") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="10%" />                           
                        </asp:TemplateField>--%>
                        ...
                        <%-- <asp:TemplateField HeaderText="IFSCCode">
                            <ItemTemplate>
                                <asp:Label ID="lblsizeBank_Name" runat="server" Text='<%# Bind("IFSC_Code") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="10%" />                           
                        </asp:TemplateField>--%>
                ...
                <asp:Label ID="lbleditlabelid" runat="server" Text="" Visible="false"></asp:Label>
                 ...
                 <%-- <div class="card-body card-body-nopadding">
                    <div class="form-row">
                        <div class="form-group col-lg-6">
                            Select below item and confirm cash transfered  -
                        </div> 
                      <div class="form-group col-lg-6">
                            <asp:Button ID="btnTransferCash"  CssClass="btn btn-primary float-right mb-0" runat="server" Text="Yes"  OnClientClick="return confirm('Are you sure you want to adjust in Next Billing (points) for selected item.');"   OnClick="btnTransferCash_Click" />
                             </div>
                        </div>
                      </div>--%>
                </div>
            ...
            <div class="grid_container">
                ...
                <table  width="100%" cellpadding="0" cellspacing="0" >
                    <tr>
                        <td align="right" style="padding-right: 20px;padding-top: 20px;padding-bottom: 20px;">
                          </td>
                    </tr>
                </table>
                <!-- ******************* Popup Start *********************-->
