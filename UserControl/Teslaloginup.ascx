<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Teslaloginup.ascx.cs" Inherits="UserControl_Teslaloginup" %>
        ...
        <div class="row">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg p-0">
                        <a class="navbar-brand logo h3" href="https://teslapowerusa.com/">
                            <img src="https://teslapowerusa.com/assets/images/tesla-logo-1.png" width="160px" alt="">
...
<br/>
        <h1 style="font-family: Publica Sans Medium, sans-serif;">Welcome  Tesla </h1>
    </div>
    <div class="row w-100">
        <div class="col-sm-6">
                 <video width="100%" height="100%" autoplay muted loop>
    <source src="https://teslapowerusa.com/assets/video/Tesla-Website-27-7-22-2.mp4" type="video/mp4">
        ...
        <div class="Login_layout">
            ...
            <%--    <h3>Welcome User</h3>--%>
                ...
                <span class="checkmark"></span>
                    ...
                    <div class="container1 form-group ">
                      <input type="checkbox" id="chkadmin" class="form-check-input" onclick="return chkforEmp('vendor');" /> Tesla 
                <span class="checkmark"></span>
                    </div>
