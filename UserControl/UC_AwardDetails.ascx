<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_AwardDetails.ascx.cs" Inherits="UserControl_UC_AwardDetails" %>
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Earned Award">
                            <ItemTemplate>
