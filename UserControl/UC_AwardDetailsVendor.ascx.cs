...
public partial class UserControl_UC_AwardDetailsVendor : System.Web.UI.UserControl
{
    ...
    //    DataProvider.MyUtilities.FillDDLInsertZeroIndexStringWithEmpty(ds, "Comp_ID", "Comp_Name", ddlCompany, "--Company Name--");
    //    ddlCompany.SelectedIndex = 0;
    //    ddlProduct.Items.Clear();
    //    ddlProduct.Items.Insert(0, "--Product Name--");
    //    ddlProduct.SelectedIndex = 0;
    ...
    {
        ExecuteNonQueryAndDatatable.FillProduct(ddlCompany.SelectedValue, ddlProduct, "'SRV1001','SRV1020'");
        //Loyalty_Points Reg = new Loyalty_Points();
        //Reg.User_ID = Session["USRID"].ToString();
        ...
        //DataProvider.MyUtilities.FillDDLInsertZeroIndexStringWithEmpty(ds, "Pro_ID", "Pro_Name", ddlProduct, "--Product Name--");
        //ddlProduct.SelectedIndex = 0;
    }
    ...
    private void FillGrdPointsDetails()
    {
        ...
        //DataSet ds = ExecuteNonQueryAndDatatable.FillGrdForPoints(ddlProduct.SelectedValue, ddlCompany.SelectedValue, dtfrom, dtTo, "", 0, "referralAward", "", "gift");
        DataSet ds = ExecuteNonQueryAndDatatable.GetWalletListByBuildLoyaltyAwards(ddlProduct.SelectedValue, ddlCompany.SelectedValue, dtfrom, dtTo, "", ProjectSession.intM_ConsumeriD, "referralAward", "", "gift");
