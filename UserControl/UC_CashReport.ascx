<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_CashReport.ascx.cs" Inherits="UserControl_UC_CashReport" %>
         ...
         <div class="container-fluid xyz">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Cash Report</h4>
                            </header>
