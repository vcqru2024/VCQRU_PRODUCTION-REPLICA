<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_EmployeeMaster.ascx.cs" Inherits="UserControl_UC_EmployeeMaster" %>
        ...
        <ContentTemplate>
                        ...
                        <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                            <tr>
                                ...
                                <td align="center" width="20%">
                                      <asp:TextBox ID="txtName" runat="server" CssClass="reg_txt" ></asp:TextBox>
                                ...
                                <td width="20%">
                                       <asp:TextBox ID="txtEmail" runat="server" CssClass="reg_txt" ></asp:TextBox>
                                   
                                </td>
                                
                               <%-- <td width="20%">
                                    <asp:TextBox ID="txtcode1search" runat="server" CssClass="reg_txt" placeholder="Code1.."
                                        MaxLength="5" OnKeyPress="return isNumberKey(this, event);" Style="text-align: center;
                                        width: 50px;" Visible="false"></asp:TextBox>
                                    <asp:TextBox ID="txtcode2search" runat="server" CssClass="reg_txt" placeholder="Code2.."
                                        MaxLength="8" OnKeyPress="return isNumberKey(this, event);" Style="text-align: center;
                                        width: 65px;" Visible="false"></asp:TextBox>
                                </td>--%>
                             <%--   <td align="right" width="10%">
                                    <strong><%--Earn Type :</strong>
                                </td>--%>
                               <%-- <td width="1%">
                                    <asp:DropDownList ID="ddlEarntype" runat="server" CssClass="textbox_pop" Visible="false">
                                        <asp:ListItem Value="0">--Select--</asp:ListItem>
                                        <asp:ListItem Value="Earn">Earn</asp:ListItem>
                                        <asp:ListItem Value="Redeem">Redeem</asp:ListItem>
                                    </asp:DropDownList>
                                </td>   --%>
                                <td align="justify" style="width: 2%;">
                                    <asp:TextBox ID="txtDateFrom" runat="server" CssClass="reg_txt" Visible="false"></asp:TextBox>
                                </td>
                                <td align="justify" style="width: 2%;">
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    DataKeyNames="dalete,active" EmptyDataText="Record Not Found" EmptyDataRowStyle-HorizontalAlign="Center"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="name">
                            <ItemTemplate>
                                <asp:Label ID="lblentrydate" runat="server" Text='<%# Bind("name") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Email">
                            <ItemTemplate>
                                <asp:Label ID="lblname" runat="server" Text='<%# Bind("Email") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                        ...
                        <asp:TemplateField HeaderText="Mobile">
                            <ItemTemplate>
                                <asp:Label ID="lblsize" runat="server" Text='<%# Bind("mobileno") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Emp_type">
                            <ItemTemplate>
                                <asp:Label ID="lblsize2" runat="server" Text='<%# Bind("Emp_type1") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="">
                            <%--<ItemTemplate>
                                ...
                                <asp:ImageButton ID="imgshowlbl" runat="server" ImageUrl="~/Content/images/delete.png"
                                    CausesValidation="false" ToolTip='<%# Bind("IsDeleteMsg") %>' CommandArgument='<%# Bind("EmployeeID") %>'
                                    CommandName="IsDelete" Height="10px" Width="10px"  OnClientClick="confirm('Sure want to delete?') return;" />
                            </ItemTemplate>--%>
                             <ItemTemplate>
                                <%
                                    try
                                    {
                                        dflag = Convert.ToBoolean(GrdLabel.DataKeys[index].Values["dalete"].ToString());
                                        aflag = Convert.ToBoolean(GrdLabel.DataKeys[index].Values["active"].ToString());
                                    }
                                    catch(Exception ex) { }

                                   if (!dflag)
                                    { %>
                                        <%--<asp:ImageButton ID="ImgbtnEdit" runat="server" ImageUrl="~/Content/images/edit.png" CommandArgument='<%# Bind("EmployeeID") %>'
                                   ...
                                   <asp:ImageButton ID="imgawrddeactive" runat="server" ImageUrl="~/Content/images/check_gr.png"
                                        CausesValidation="false" ToolTip="Activate" CommandArgument='<%# Bind("EmployeeID") %>'
                                        CommandName="IsActive" Height="12px" Width="12px" OnClientClick="confirm('Sure want to Activate') return;" />&nbsp;
                                    <%}
                                      else
                                      {%>
                                  
                                    <asp:ImageButton ID="imgawrdactive" runat="server" ImageUrl="~/Content/images/check_act.png"
                                        CausesValidation="false" ToolTip='DeActivate' CommandArgument='<%# Bind("EmployeeID") %>'
                                        CommandName="DeActivate" Height="12px" Width="12px" OnClientClick="confirm('Sure want to De-Activate') return;" />&nbsp;
                                    <%}                                     
                                    %> 
                                    <asp:ImageButton ID="imgshowlbl" runat="server" ImageUrl="~/Content/images/delete.png"
                                    CausesValidation="false" ToolTip="Delete" CommandArgument='<%# Bind("EmployeeID") %>'
                                    CommandName="IsDelete" Height="10px" Width="10px"  OnClientClick="confirm('Sure want to delete') return;" />&nbsp;
