<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_PointReport.ascx.cs" Inherits="UserControl_UC_PointReport" %>
         ...
         <div class="container-fluid xyz">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Points Report</h4>
                            </header>
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered"
                   ...
                   <Columns>
                        ...
                        <asp:TemplateField HeaderText="Enq Date">
                            <ItemTemplate>
                                <asp:Label ID="lblentrydate" runat="server" Text='<%# Bind("enq_Date") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Complete Code">
                            <ItemTemplate>
                                <asp:Label ID="lblsize2" runat="server" Text='<%# Bind("CompleteCode") %>'></asp:Label>
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />--%>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Product Name">
                            <ItemTemplate>
                                <asp:Label ID="lblsize3" runat="server" Text='<%# Bind("pro_name") %>'></asp:Label><br />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
