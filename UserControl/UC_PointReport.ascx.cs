...
public partial class UserControl_UC_PointReport :  System.Web.UI.UserControl
{
    public int str = 0;
    ...
    private void FillGrdPointsDetails()
    {
        ...
        DataSet ds = ExecuteNonQueryAndDatatable.FillGrdForPointsrpt(Session["CompanyId"].ToString(), dtfrom, dtTo, stt, mob,true);
    ...
    protected void btnDownloadExcel_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = ExecuteNonQueryAndDatatable.FillGrdForPointsrpt(Session["CompanyId"].ToString(), dtfrom, dtTo, stt, mob, false);
        XLWorkbook wb = new XLWorkbook();
        wb.Worksheets.Add(ds.Tables[0], "Point_Report");
        ...
        Response.AddHeader("content-disposition", "attachment;    filename=Point_Report.xlsx");
