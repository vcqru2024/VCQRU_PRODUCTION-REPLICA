<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_PointsDetails.ascx.cs" Inherits="UserControl_UC_PointsDetails" %>
                ...
                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                    ...
                    <tr>
                        <td><asp:Label Text="" runat="server"  ID="lblAvailablePoints" style="font-size: 13px; font-weight: bold;" /></td> <td>
                            <asp:Button Text="Redeem Your Points" ID="btnRedem" CssClass="button_all" Visible="false" runat="server" /></td>
                    </tr>
                </table>
            </fieldset>
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Earned Points">
                            <ItemTemplate>
                                <asp:Label ID="lblsize" runat="server" Text='<%# Bind("Points1") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
