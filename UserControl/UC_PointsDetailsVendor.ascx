<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_PointsDetailsVendor.ascx.cs" Inherits="UserControl_UC_PointsDetails" %>
        ...
        <div class="sort-destination-loader sort-destination-loader-showing">
            ...
            <div class="card card-admin form-wizard profile box_card">
                <header class="card-header">
                                <h4 class="card-title"><i class="fa fa-pencil-square-o"></i>Points Transaction</h4>
                            </header>
            ...
            <div id="newMsg" runat="server" style="width: 91%;">
                ...
                <div class="card-body card-body-nopadding">
                        ...
                        <div class="form-group col-lg-6">
                              <asp:ImageButton ID="ImgSearch" runat="server" ImageUrl="~/Content/images/search_rec.png"  ValidationGroup="servss" 
                                    ...
                                    <asp:ImageButton ID="ImgRefresh" runat="server" ImageUrl="~/Content/images/reset.png" OnClick="ImgRefresh_Click"
                                        ToolTip="Reset" />
                            <asp:Label Text="" runat="server"  Visible="false"  ID="lblAvailablePoints" style="font-size: 13px; font-weight: bold;"></asp:Label>
                            <asp:Button Text="Redeem Your Points" ID="btnRedem" CssClass="button_all" Visible="false" runat="server" />
                        </div>
                            <div class="form-group col-lg-6">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="User (Points)">
                            <ItemTemplate>
                                 <asp:Label ID="Label6" runat="server" Text='<%# Bind("MobileNo") %>'></asp:Label>
                                (<asp:Label ID="lblsize" runat="server" Text='<%# Bind("Points1") %>'></asp:Label> points )
                            </ItemTemplate>
                            <%--<HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />--%>
                            <ItemStyle HorizontalAlign="Left" Width="15%" />                           
                        </asp:TemplateField>
