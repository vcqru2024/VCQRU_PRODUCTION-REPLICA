<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_WebsiteHitHistory.ascx.cs" Inherits="UserControl_UC_WebsiteHitHistory" %>
        ...
        <ContentTemplate>
                    ...
                    <asp:Panel ID="DefaultButtonPanel" DefaultButton="ImgSearch" runat="server">
                        <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                            <tr>
                                ...
                                <td width="20%">
                                        <%--<strong>Product Name :</strong>--%><asp:DropDownList ID="ddlProduct" runat="server" AutoPostBack="false"
                                        OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged"
                                        CssClass="textbox_pop" Visible="false">
                                    </asp:DropDownList>
            ...
            <fieldset class="field_profile" style="display:none;">
                ...
                <table width="98%" cellpadding="0" cellspacing="2" class="tab_regis">
                    ...
                    <tr>
                        <td><asp:Label Text="fghfhgffghfgh" runat="server"  ID="lblAvailablePoints" style="font-size: 13px; font-weight: bold;" /></td> <td>
            ...
            <div class="grid_container">
                ...
                <asp:GridView ID="GrdLabel" runat="server" AutoGenerateColumns="False" CssClass="grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Dial Mode">
                            <ItemTemplate>
                                <asp:Label ID="lblentrydate" runat="server" Text='<%# Bind("Dial_Mode") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Date">
                            <ItemTemplate>
                                <asp:Label ID="lblname" runat="server" Text='<%# string.Format("{0:dd-MMM-yyyy hh:mm}", Eval("LoginDate")) %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
                        ...
                        <asp:TemplateField HeaderText="Mode">
                            <ItemTemplate>
                                <asp:Label ID="lblsize" runat="server" Text='<%# Bind("Login_browser") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr_haed" HorizontalAlign="Left" />
