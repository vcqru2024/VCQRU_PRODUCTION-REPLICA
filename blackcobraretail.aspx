<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blackcobraretail.aspx.cs" Inherits="blackcobraretail" %>
                ...
                $("#btnnxt").on('click', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#btnnxt').show();
                            $('#btnloadnxt').hide();
                            if (data.split('&')[1] == "YAMUNA INTERIORS PRIVATE LIMITED" || data.split('&')[1] == "" || data.split('&')[1] == undefined) {
                                var mobileNumberCookie = getCookie("mobileNumber");
                                if (mobileNumberCookie !== "" && mobileNumberCookie !== null) {
                                    finnalsubmit();
                                } else {
            ...
            function finnalsubmit() {
                ...
                if (code != "") {
                    ...
                    $.ajax({
                        ...
                        contentType: false,
                        processData: false,
                        url: BaseURL + 'Info/MasterHandler.ashx?method=verifyotp&mobile=' + $('#mobile').val() + "&vCode=" + $('#example13-digit-number').val() + '&PinCode=' + $('#pincode').val() + '&EmailAddrs=' + $('#txtemail').val() + '&city=' + $('#city').val() + '&state=' + $('#state').val() + '&SellerName=' + $('#dealer').val() + '&Shopname=' + $('#productname').val() + '&Comp_ID=Comp-1714' + '&comp=YAMUNA INTERIORS PRIVATE LIMITED',
                        success: function (data) {
                            $('#overlay').hide();
                            $('#btnsubmit').show();
                            $('#btnloadsubmit').hide();
                    ...
                    <div class="col d-flex order-lg-2 order-1">
                        <div class="card-left">
                            <div class="logo">
                                ...
                                <p class="mb-0">Retail Grade Only (Govt Project Grade Offered Separately)</p>
                            </div>
