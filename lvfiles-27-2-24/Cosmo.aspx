...
<body>
            ...
            $("#btnsendotp").on('click', function () {
                ...
                if (mobileno.length == 10) {
                    ...
                    $.ajax({
                        ...
                        /*url: '../Info/MasterHandler.ashx?method=GetCodeCountbyMobile&MobileNo= ' + $("#mobile").val() + "&CompName=Cosmo",*/
               ...
               /* $('#imgloaddersubmit').show();*/
                ...
                if (code != "") {
                    ...
                    $.ajax({
                        ...
                        /*url: '../Info/MasterHandler.ashx?method=verifyotp&mobile=' + $('#mobile').val() + "&vCode=" + $('#codeone').val() + '&name=' + $('#Name').val() + '&EmailAddrs=' + $('#Email').val() + '&Comp_ID=' + $('#Companyname').val() + '&Other_Role=' + $('#Designation').val() + '&SellerName=' + $("#radioDiv input[type='radio']:checked").val() + '&comp=Cosmo',*/
                        success: function (data) {
    ...
    <section class="banner-cosmetic mobile">
        <div class="container">
            <div class="row pt-4">
                            ...
                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">E-Warranty</span></h1>
                                        </p>
                                    </div>
                                    <div class="carousel-item">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">Cash Transfer</span></h1>
                                        </p>
                                    </div>
                                    <div class="carousel-item">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">Build Loyalty</span></h1>
                                        </p>
                                    </div>

                                    <div class="carousel-item">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">Digital Marketing</span></h1>
                                        </p>
                                    </div>

                                    <div class="carousel-item">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">Referral Services</span></h1>
                                        </p>
                                    </div>

                                    <div class="carousel-item">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">Track & Trace</span></h1>
                                        </p>
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">Gift Coupon</span></h1>
                                        </p>
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        <p>
                                            <h1 class="heading-maine text-white  py-4">Powering the Future of <span style="color: #18beb7;">Smart Packaging</span></h1>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-7 col-sm-12">
                    <form runat="server">
                        ...
                        <div class="rows">
                            <div class="HEADING">
                                <h1 class="heading-pack-plus text-white text-center py-4">Explore Our Services <%--And Win --%>
                                </h1>
                            </div>
                        </div>
                        <div id="ChkCode">
                        ...
                        <div id="mobilefield" style="display: none">
                            ...
                            <div>
                                <center>
                                    <button type="button" id="btnsendotp" class="btn btn-primary">Submit</button>
                                   
                               <div id="imgloaddersendotp" style="display:none" class="loader"></div>
                                    </center>
                            </div>
                        </div>
            ...
            <h3>To Know more about our services</h3>
            <div class="col-sm-12">
