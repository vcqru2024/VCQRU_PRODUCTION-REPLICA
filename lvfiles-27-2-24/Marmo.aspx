                ...
                if (validate) {
                    ...
                    if (code != "") {
                        $.ajax({
                            ...
                            url: '<%=ProjectSession.absoluteSiteBrowseUrl%>Info/MasterHandler.ashx?method=verifyotp&mobile=' + $('#mobilenumber').val() + "&vCode=" + $('#codeone').val() + '&SellerName=' + $('#retailername').val() + '&name=' + $('#Name').val() + '&city=' + $('#city').val() + '&Comp_ID=Comp-1266',
                            success: function (data) {
                                debugger;
