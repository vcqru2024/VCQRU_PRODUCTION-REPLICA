...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link rel="canonical" href="https://www.vcqru.com/news-event.aspx"/>
</asp:Content>
            ...
            <div class="row g-4">
                <div class="col d-flex">
                    <div class="card">
                        <div class="row">
                            <div class="col-lg-4">
                                <img src="../NewContent/front-assets/img/news-events/IHFF_event.jpg" alt="Event Post" class="card-img-top h-100">
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body">
                            <h5 class="card-title">VCQRU Participating In IHFF Expo 2024</h5>
                            ...
                            <p class="card-text">Pragati Maidan, Delhi, India</p>
                            <p class="card-text">
                                Be a part of the premier IHFF (International Health & Fitness Festival) expo and visit us at Booth No. 64 in Delhi.  Discover over 500+ top global healthcare brands and service providers, all gathered to showcase wide range of segments in all types of health, wellness, sports and fitness products or services. Don’t miss this unparalleled opportunity to connect, innovate, and elevate your healthcare solutions.
                            </p>
                            <a href="../event/ihff-event.aspx?eventname=IHFF-EXPO"
                                class="btn btn-outline-primary btn-sm px-3 stretched-link">View More <i
    ...
    <section class="news-events">
        <div class="container">
            ...
            <div class="row row-cols-xxl-3 row-cols-xl-3 row-cols-lg-2 row-cols-md-1 row-cols-1 g-4">
                <div class="col d-flex">
                    <div class="card">
                        <img src="../NewContent/front-assets/img/news-events/IHFF_event.jpg" alt="Event Post" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title">VCQRU Participating In IHFF Expo 2024</h5>
                            <ul class="events-date">
                                <li>
                            ...
                            <p class="card-text">VCQRU Participating In IHFF Expo 2024</p>
                            <p class="card-text">
                                Discover the forefront of healthcare innovation at the International Health & Fitness Festival (IHFF) in Delhi! We're excited to invite you to Booth No: 64, where you'll be a part of an expo that brings together over 500+ top global healthcare brands and service providers. This expo is your gateway to the latest advancements and trends in healthcare services and products.
                            </p>
                            <a href="../event/ihff-event.aspx?eventname=IHFF-EXPO"
                                class="btn btn-outline-primary btn-sm px-3 stretched-link">View More <i
                                    class="fa fa-arrow-right"></i></a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../event/cosmotech-event.aspx?eventname=COSMOTECH-EXPO"
                                class="btn btn-outline-primary btn-sm px-3 stretched-link">View More
