<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeFile="packplus-event.aspx.cs" Inherits="packplus_event" %>
                        ...
                        <div class="bg-banner-1">
                            <div class="text-bg-2 text-align-0">
                                <h1 class="text-white ">VCQRU
                                    <br />
                                    PARTICIPATING </br>
IN <span style="color: #6eb13e;">PACKPLUS</span>
                                    <br />
                                    EVENT</h1>
                                <h5 class="text-white mt-4">HURRY UP!</h5>
                                <p>Welcome to VCQRU, where we bridge the gap between IT technologies and label printing and packaging. As an organization, we provide a unique platform that caters to brands across diverse domains such as healthcare, automobile, paint and building materials, plywood, FMCG, and more.</p>
                    ...
                    <div class="col-lg-6 p-0">
                        <div class="bg-banner-2">
                            <div class="form-background-1">
                                <div id="Head">
                                <h5 class="mt-sm-5  text-white uppercase">Submit your details  to GET YOUR FREE PASSES of the PACKPLUS Events</h5>
                                 </div>
                                    <form method="post">
                                     <div id="eform">
                                    ...
                                    <input type="text" class="form-control height-form mb-3" id="evisitor" maxlength="5" placeholder="NO. OF VISITORS" required>
                                      <input type="hidden" id="hdnevent" name="custId" value="Pack Plus">
                                         <label id="elbl" style="color:red"></label>
                        ...
                        <div class="right-sidebar">
                            ...
                            <div class="tab-content border-0">
                                <div id="home1" class="container tab-pane active">
                                   ...
                                   <%-- <div class="maine-event-btn mt-sm-5"><a href="anti-counterfeit.aspx" class="event-btn mt-5">CLICK HERE TO BOOK YOUR DEMO</a></div>--%>
                                    <div class="maine-event-btn mt-sm-5">
                                        <a href="anti-counterfeit.aspx?id=anti" class="event-btn mt-5">CLICK HERE TO BOOK YOUR DEMO</a></div>
                                </div>
  ...
  <li class="nav-item">
    <a class="nav-link common-tab active text-center" data-bs-toggle="tab" href="#home">THURSDAY<br />10-August-2023</a>

     
  </li>
  <li class="nav-item">
    <a class="nav-link common-tab" data-bs-toggle="tab" href="#menu1">FRIDAY<br />11-August-2023</a>
  </li>
  <li class="nav-item">
    <a class="nav-link common-tab" data-bs-toggle="tab" href="#menu2">SATURDAY <br />12-August-2023</a>
  </li>
</ul>
...
<div class="tab-content">
  ...
  <div class="experience mt-5">
    ...
    <div class="item">
      ...
      <div>
        <ul class="fa-ul">
            <li><%--<i class="fa-li fa fa-hand-o-right"></i>--%>Join us at the Smart packaging and Anti-Counterfeit Event, a groundbreaking initiative aimed at raising awareness about the ever-growing threat of counterfeit products and fostering collaboration to combat this global menace. Our event schedule is designed to provide a comprehensive understanding of the counterfeit problem and explore innovative solutions to protect consumers and businesses alike.</li>
...
<div class="tab-pane container active" id="home"><div class="container">
  ...
  <div class="experience mt-5">
    ...
    <div class="item">
      ...
      <div>
        <ul class="fa-ul">
          <li><%--<i class="fa-li fa fa-hand-o-right"></i>--%> Explore cutting-edge technologies and groundbreaking solutions that can help detect, prevent, and combat counterfeiting. This day will showcase the latest advancements in authentication technologies, blockchain, AI-powered tools, track-and-trace systems, and other innovative approaches that can empower organizations to safeguard their products and supply chains.</li>
         <div class="accordian-maine">
           <%-- <button class="accordian-1">11:30 AM - 01:00 PM</button>
          <button class="accordian-2">11:30 AM - 01:00 PM</button>--%>
             </div>
